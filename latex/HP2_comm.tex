...
\begin{variants}
yathāśaktyā VM\vl~] yathāśakti VM
punaḥ VM\vl~] bhūyaḥ VM    
\end{variants}
...
The meaning of \emph{avirodhataḥ} (‘without harm/discomfort’) makes better sense in this context than \emph{anirodhataḥ} (‘without cessation’). One might try to construe \emph{anirodhataḥ} as ‘without stopping the breath,’ but verse 2.7 clearly states that the breath should be held as long as possible (\emph{yathāśakti}). According to the apparatus of the critical edition of the \emph{Haṭharatnāvalī}, \emph{aviro\teimute{\-}dhataḥ} is well-attested for the parallel line. In addition, \emph{avirodhataḥ} is found (and also \emph{virodhahīnam}) in a passage of the \emph{Haṭhatattvakaumudī} (36.6–9) that appears to have been loosely based on \emph{Haṭhapradīpikā} 2.7–9.%JM: do we need to quote this? I don't think so.
...
The second line of this verse has been rewritten to express the same idea (and simile) as that found in \emph{Viveka\teimute{\-}mārtaṇḍa} 101, but the author of the \emph{Viveka\teimute{\-}mārtaṇḍa} expresses it more clearly.
\end{philcomm}
%</cm15>
...
This verse has parallels in verses on the illnesses caused by incorrect breathing in earlier Śiva\teimute{\-}dharma works:
...
The idea that alternate nostril breathing is done to purify the channels can be found in early Śaiva tantras; see e.g.~the \emph{Nayasūtra} of the \emph{Niśvāsatattvasaṃhitā} (4.110) and the \emph{Svacchanda\teimute{\-}tantra} (7.294cd–7.295ab). The latter verse is as follows:
...
\dummy[The yogi] should slowly swallow a moistened cloth  four finger-breadths in width and then draw it out. This ejection [of it] from the mouth is the \emph{dhautī} technique.
\end{translation}
%</tr24>
...
The reading \emph{ukhālam} which we have adopted in the fourth \emph{pāda} is a vernacular term for vomiting which is found in the \textalpha \ recension but has been changed in some witnesses to more Sanskritic forms, such as \emph{udgāram} and \emph{pra\teimute{\-}kṣā\teimute{\-}lyam}.\lb
...
Many manuscripts, including several of those collated (i.e.~\etaTwo, \piTwo \ and \piOmega), and the \textit{Jyotsnā} (2.24), add two verse quarters stating that the length of the cloth is fifteen cubits (\emph{hastapañcadaśena tu}) and that the practice should be performed according to the guru’s teachings (\emph{gurūpadiṣṭa\teimute{\-}mārgeṇa}). These additions are absent from the \textalpha, \textgamma\ and \textzeta\ groups. Moreover, the compound \emph{hastapañcadaśena} does not fit the syntax of the sentence, while the \emph{pāda} referring to the guru's teaching is a cliché that was probably inserted as a verse filler when with the \emph{pāda} on the length of the cloth was added.
\end{philcomm}
%</cm24>
...
Raising the \emph{apāna} wind into the throat and ejecting the contents of the stomach from the oesophagus, which has been brought under control by cumulative practice, is called the elephant technique (\emph{gaja\teimute{\-}karaṇī}) by experts in Haṭha.
...
\dummy[The yogi] should insert a thread that has been stiffened for one handspan [in length] into the nasal passage and take it out through the mouth. This is called \emph{nīti} by the Siddhas.
\end{translation}
%</tr30>
...
\teimute{A video of Mahant Bālyogī Rām Bālak Dās performing \emph{laulī} at Dīrgheśvar Mahādev, U.P. is available in the digital edition.}%
\teionly{\medialink{Mahant Bālyogī Rām Bālak Dās performing \emph{laulī} at Dīrgheśvar Mahādev, U.P., in 2012.}{BabajiNauli.m4v}}\lb
...
Very rapid inhalation and exhalation like the bellows of a blacksmith is called \emph{kapāla\teimute{\-}bhāti}, the skull bellows. It dries up imbalances of phlegm.
\end{translation}
%</tr36>
...
The word \emph{bhāti} is derived from \emph{bhastrī} (\textsc{Turner} 1966: 537, entry 9424).\lb
...
The stem form \emph{brahma} is found in various compounds in the text. We understand it to refer to Brahman, the absolute, in all instances other than \emph{brahmagranthi}, where we take it to mean the deity Brahmā. See \textsc{Mallinson} 2007: 205 n.\,240.
\end{philcomm}
%</cm46>
...
%\emph{āsane sukhade} is supported by the [different but parallel] reading in the Gorakṣa\teimute{\-}śataka. (JB: I've put the GŚ verses in the source section)
...
\closer
\begin{quote}
\dummy[The yogi] who is constantly engaged [in practice] should repeat breath retentions again and again. Extreme heat burns as far as the tips of the hair and nails. 
\end{quote}
...
For the idea of \emph{doṣa}s being in \emph{dhātu}s see \emph{Tantrāloka} 28.283cd, where Abhinavagupta says that worldly concepts arise as a result (\emph{dhātudoṣāc ca saṃsārasaṃskārās te ...}). In the \emph{Īśvara\teimute{\-}pratyabhijñā\teimute{\-}vimarśinī} Abhinava\teimute{\-}gupta notes that they are also the source of physical disorders (2.15 \emph{dhātu\teimute{\-}doṣakṛtaṃ mūrcchā}).\lb
...
\dummy[The yogi] should continuously make \emph{sīt} sound in the mouth and flare his nostrils. By practising in this way he becomes a second god of love.
\end{translation} 
%</tr54>
...
\begin{versinnote}
\tl{cittan dadyāt tu vaktreṇa nāse dadyād vijṛmbhikām/\\+}
\tl{vācāsiddhir bhavaty eva kāmadevo'paraḥ priyaḥ//\\!}
\end{versinnote}

Cf.\,\emph{Jñānasāra} 2.12cd–13ab
...
The compound \emph{rasanātālumūlena} is difficult to understand. In his \emph{Haṭhasaṅketacandrikā} (f.\,79r–79v), Sundaradeva says that the external air strikes the root of the tongue and palate and the upper part of the uvula (\emph{atra muhū} (\emph{mūhū} codex) \emph{rasanātālumūlāhataṃ ghaṇṭikordhva\teimute{\-}bhāgāhataṃ bahiḥsthavāyuṃ vidhāya pibed ity arthaḥ}). More helpful are the remarks of the commentator of the \emph{Yogataraṅgiṇī} (2.39). He says that a hole or cavity (\emph{vivara}) is made by the root of the palate with the help of the tongue. The yogi breathes through it (\emph{evaṃ rasanātālumūlena rasanā jihvā tatsahāyabhūtatālumūlena kṛtaṃ yad vivaraṃ, tena kṛtvā yaḥ yogī prāṇam anilaṃ prāṇavāyuṃ pibet pūrayet, tasya yogino ’bdārdhena ṣaṇmāsena sarvarogāṇāṃ nāśaḥ kṣayo bhavet}/).\lb

The idea of breathing through a hole between the root of the palate and tongue might have been intended by the parallel reading of the \emph{Yogacintāmaṇi}: \emph{rasanā\teimute{\-}tālu\teimute{\-}yogena} (‘by joining the tongue and palate'). We have thus translated \emph{rasanā\teimute{\-}tālu\teimute{\-}mūlena} as ‘through the tongue and root of the palate’. It could also imply that the tongue is turned up and back to touch the root of the palate to make a hole that one breathes through (when the breath is taken in through the mouth). The \emph{Kumbhaka\teimute{\-}paddhati} (137ab) states this more clearly:
...
\closer
\begin{quote}
\dummy[The yogi] turns the tongue upwards and takes in the breath while making a \emph{sīt} sound.
\end{quote}
...
\dummy[\ldots] in such a way that the abdomen is filled by the breath, and hold the nose quickly [and] firmly without using the middle and index fingers.
\end{translation}
%</tr65>
...
At the end of inhalation [the yogi] should tightly apply the \emph{jālan\teimute{\-}dhara} [lock] and exhale slowly. This loss of consciousness, which is called \emph{mūrchanā}, gives pleasure.
\end{translation}
%</tr70>
...
Cf.\,\textsc{Marcinowska-Rosól \& \ Sellmer} 2021, p.\,102f.
...
On this verse, see \textsc{Marcinkowska-Rosół and Sellmer} 2020: 102–105.
\end{philcomm}
%</cm74>
