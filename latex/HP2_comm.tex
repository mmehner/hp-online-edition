...
%MD 2024-8: The most plausible reconstruction of the text, based on our manuscripts, is "cale vāte calet sarvaṃ niścale dṛḍhabandhanam" (When the wind moves, everything would move. When [the wind] is still, [everything] would have firm bond.) Would this work? Yes, with calaṃ ?? JM to rewrite note.
...
%The reading \emph{kāyasiddhi} in the final verse quarter is supported by manuscripts of the \textalpha, \textbeta, \textzeta\ and \texteta\ groups whereas other manuscripts have \emph{kāryasiddhi}. In the context of physical yoga, \emph{kāyasiddhi} makes better sense, as \emph{kāryasiddhi} can refer more generally to accomplishing anything.
...
\emph{Yogacintāmaṇi} 92v (attr.~to the \emph{Skandapurāṇa})
...
\emph{Dhauti, basti, nīti, trāṭaka, naulī} and \emph{kapālabhātī}. These are said to be the six [therapeutic] techniques.%JM: "therapeutic interventions" adds a lot to karmāṇi. I usually translate it with "[cleansing] techniques". We have techniques everywhere else.
...
% MD: Why don't we adopt the reading ukhāla? ukhāla seems to mean "vomiting" in Hindi, Marathi, Nepali etc. See also https://www.wisdomlib.org/definition/ukhala-pakhala. We have accepted pakhāla in 2.26. Apparently they belong together. ??JM to write note 
...
The reading \emph{pakhālaṃ} that we have adopted in the fourth \emph{pāda} is found in \alphaTwo\ and \betaOmega\ and is close to the reading of \alphaOne. %  not exactly: pākhālaṃ α1, paṣālaṃ α2
...
%?? MD: We have adopted the reading jayaty āśu satī nitiḥ. JM to rewrite the note.
\end{philcomm}
...
Very rapid inhalation and exhalation like the bellows of a blacksmith is called kapāla\-bhātī, the skull bellows. It dries up imbalances of phlegm.
\end{translation}
...
In the second verse quarter, the \textalpha\ manuscripts have \emph{susambhramau} (`great speed') instead of the reading we have adopted \emph{sasambhramau} (`fast'). The syntax requires \emph{sasambhramau} because it is an adjectival compound that must agree with \emph{recapūrau} (`the exhalation and inhalation'). %??JM to change note on why we have adopted susambhramau, which is rare (unique?) as an adjectival form whereas sasambhrama is very common.
\end{philcomm}
...
Both \emph{°doṣaham} and \emph{°doṣahṛt} are well attested and possible. We have favoured the former because the \textalpha\ reading (\emph{doṣajam}) appears to be a corruption of it, and °ha is from the same root as the verb in the source text (i.e., \textit{nihanti}).% MD: and also because the source text has nihanti.
\end{philcomm}
...
\tl{proktojjāyīti kumbhaḥ kaphagadadalano dīptikṛjjāṭharāgne ||\\+}  % dīptikṛj, not dīpti kṛj   JH
\end{versinnote}
\end{testimonia}
...
% ?? JB New Note on Brahmānanda's reading and interpretation: done!
%% 
...
%MD 2024-8: Is "making a sound" an important component here? α1 has śvasanaṃ "wind, breath" instead of sasvanaṃ. 
...
%?? JB write a note on śvasanaṃ (better for the syntax, but the idea of breathing with sound –as described in the GŚ– is lost). However, śvasana may (according to the dictionary) denote an audible breath, such as hissing, sighing and clearing the throat. done!
\end{philcomm}
...
Sāhib Kaula's \emph{Śyāmāpaddhati}: \emph{dakṣānāmākaniṣṭābhyāṃ vāmaṃ puṭaṃ ca niruddhya} (see Hanneder: forthcoming).   % JH addition
...
[\ldots and] pierces the three knots that have arisen from the three \emph{guṇa}s, it is particularly important to perform this retention called ‘the bellows’.
\end{translation}
...
\tl{bhaṅgīnādaṃ recakaṃ mandaṃ mandaṃ |\\+}  %  add  (recte bhṛṅgī-) ? unless it is a typo  JH
\tl{yogīdrāṇām evam abhyāsayogac \\+}         %  add (recte yogīndrāṇām) ? JH
...
\tl{\var{28a virecyāpūrya yaṃ ] recyavāpūrya yat \emph{la}, ārecyāpūrya yaḥ \emph{śa}}\\!}
\end{versinnote}
...
\tl{\var{[middle line not in mss. I, III, IV, VII, IX, X, XII, XIV--XVI]}\\+}
