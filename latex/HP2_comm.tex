...
\medialink{Mahant Bālyogī Rām Bālak Dās performing nauli at Dīrgheśvar Mahādev, U.P., in 2012.}{BabajiNauli.m4v}
...
\end{translation}
%name is given as mūrchanā but headings in alpha etc. are mūrchā. Some, including epsilon1 do have mūrchanā.
% adopt feminine in 2nd hemistich
% JB: the meaning of manomūrcchā is not conveyed by the current translation. Fainting of the mind is different to normal fainting where a person falls to the ground unconsciousness. It's unlikely that the person in mūrcchā kumbhaka was supposed to collapse.... bestows bliss, when the mind faints. 
...
% MD: Perhaps \emph{recakaḥ pūrakaḥ kāryaḥ} which is closer to the readings of N3 and V3?  Cf. also 2.74a \emph{recakaṃ pūrakaṃ muktvā}.
