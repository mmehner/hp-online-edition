...
\usepackage{fancyhdr}
	...
	\fancyhead[ER]{\small\texteng{Critical Edition}}
...
\fancypagestyle{firstpage}{%
	\fancyhead[OL]{}%\small\texteng{\thepage}}
	\fancyhead[OR]{\small\texteng{(\Today)}}
	\fancyhead[C]{}
	}
...
\fancypagestyle{HPed}{%
	\renewcommand{\headrulewidth}{0pt}
	\fancyhead[EL]{}%\small\texteng{\thepage}}
	\fancyhead[EC]{\small\textsc{\texteng{Critical Edition and Translation}}}
	\fancyhead[ER]{\small\texteng{[\rightmark\textendash}}
	\fancyhead[OL]{\small\texteng{\textendash\leftmark]}}
	\fancyhead[OR]{}%\small\texteng{\thepage}}
	\fancyhead[OC]{\small{\texteng{\textsc{Chapter} \hindsection}}}
	\fancyfoot[C]{}
	}
\pagestyle{HPed}
...
\fancypagestyle{Appendix}{%
	\renewcommand{\headrulewidth}{0pt}
	\fancyhead[EL,OR]{}
	\fancyhead[EC]{\small\textsc{\texteng{Appendix \apxnr}}}
	\fancyhead[ER]{\small\texteng{[\rightmark\textendash}}
	\fancyhead[OL]{\small\texteng{\textendash\leftmark]}}
	\fancyhead[OC]{\small\textsc{\texteng{\firstrightxmark}}}
	\fancyfoot[C]{}
	}
...
\usepackage[sanskrit,english]{babel}
\usepackage{babel-iast}
\babelprovide[typography/prehyphenchar = `-,transforms=transliteration.iast]{iast}
\babelfont[iast]{rm}[Renderer=Harfbuzz, Scale=1.1]{AdishilaSan}
\babelprovide[typography/prehyphenchar = `-]{sanskrit}
\babeltags{dev = iast}
\babeltags{eng = english}
\newcommand{\skt}[1]{\selectlanguage{sanskrit}\textit{#1}\selectlanguage{english}}
...
\newcommand{\vspaceinnote}{\vspace{2pt minus 1pt}}
\newcommand{\myvin}{\hspace*{2em}}% indent for verses cited in app. reg. 2
...
\newcommand{\anm}[1]{\myfn{#1}} % nicht mehr benutzt!!
\newcommand{\textapp}[1]{\texteng{\textit{#1}}}
...
\NewDocumentEnvironment{metre}{O{}}{%
	...
	\begin{description}[leftmargin=1em, 
		topsep=0pt, parsep=0pt, partopsep=0pt,
		listparindent=0pt, labelwidth=1em, labelsep=1em]
	\item[\ding{118}\ Metre]
	}{\end{description}\selectlanguage{iast}}
...
\newcommand{\alttrcite}{
	...
	\myvspace
	\begin{quote}
	\textcolor{gray}{\texteng{(\labelvnum)} 
	\ExecuteMetaData[\commfilename]{tr\commvnum}}
	\end{quote}
	}
