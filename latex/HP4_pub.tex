...
\pada{\app{\lem[wit={ceteri}]{mudreyaṃ}
	...
	\app{\lem[wit={Gr2,V19,V15,J10,P11,V3},alt={guro}]{\skm{d }guro}% +K3,C7
		\rdg[wit={E2,G11,N19,C6,Jyo}]{guroḥ} % J10pc
		\rdg[wit={N3}]{gurau}
		\rdg[wit={J5}]{gure}}}\\+}
\tl{
...
\tl{\app{\lem[nolem]{}
	...
	\rdg[wit={Gr1,Gr2,V19,C7}]{\incl}%
 	\rdg[wit={Gr2,V19,C7},alt=\textapp{found after \manuref{X4.42}}]{\skp{found after X4.42}}}%
...
\pada{\app{\lem[wit={Gr1,J7,V19,C7},alt={taṃ badhnīyāt}]{taṃ badhnīyā\skp{t}}
	...
	%\anm{\textrightarrow\ \manuref{3.48*1}}
	\label{patala}
	\orgvnr{9}\\!}
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={N23,J7,V19},postwit=\textapp{(after \ref{antarlaksya})}]{\also}}% Not in E2!
...
\pada{\app{\lem[wit={J10}]{tasmiñ śūnye}% +F; tasmin ś° J10
		...
		\rdg[wit={V3},alt={\om},post=\texteng{(eye-skip?)}]{\skp{\om\ (eye-skip?)}}} % cf. V3 resumes with tasmin!
...
\pada{\app{\lem[wit={G11,G5,N19,P11,C6},alt={abhyaset}]{abhyase\skp{t}}
		...
		\rdg[wit={V15},alt={\om},post=\texteng{(eye-skip?)}]{\skp{\om\ (eye-skip?)}}}%
...
\pada{\app{\lem[wit={J10,Jyo}]{manaso hy unmanī}
	...
	\app{\lem[wit={V15,V3},alt={°bhāve}]{\skp{°}bhāve}% +G7,F,J10pc
		\rdg[wit={P11}]{bhāvai}
...
\app{\lem[nolem]{}
	\rdg[wit={N3}]{\unavbl}
	\rdg[wit={Jyo},alt={\om}]{\skp{\om}}
	\rdg[wit={J5,J7,Gr3,GrB},alt=\textapp{found after \ref{rudra}b}]{\skp{found after \manuref{4.26b/X4.81b}}}}%	
...
\tl{\app{\lem[alt=\mylem{71cd},nosep,nonum]{\skp{pāda cd}}%
...
\tl{\app{\lem[nolem]{}
	\rdg{\texteng{=\,2.77}}
	\rdg[wit={N3}]{\unavbl}
	\rdg[wit={G11plus,J10,V3,Jyo},alt={\om}]{\skp{\om}}
	\rdg[wit={N19,V15}]{\textapp{abbreviated with \textup{haṭhaṃ vinā rājayoga iti}}}
	}%
\pada{\app{\lem[nolem]{}
	\rdg[wit={V19}]{\om}}%
	haṭhaṃ vinā rāja%
...
\pada{\app{\lem[wit={Gr2,Gr3,G11,N19,V15,P11,Jyo}]{prayāsaphalavarjitān}%ptalevi N23 
	...
	% \note[type=anmkg,nonum,lem=\mylem{29--30},labelb={hp4-30-1}]{The \textgamma\ and \textdelta\ manuscripts have the following verse as a substitute for \ref{hathamvina}--\ref{ajananta}:
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={N23,J7,V19,E2},postwit=\textapp{(after \ref{makaranda1})}]{\also}
	\rdg[wit={Jyo}]{\NotIn}}%
...
\pada{sūryo
	\app{\lem[wit={N3,J5,J7,Gr3,GrB}]{rājasa}
		\rdg[wit={N23},post=\texteng{(\textapp{end of the last available folio})}]{rā}} ucyate//\versenr}
...
%	\sgwit{N3,J5,J7,Gr3,GrB}
	\myfn{\getsiglum{G11,G5} have this set of verses as \manuref{3.93*7}\,ff. in a different order (4.62 \textrightarrow\ 4.61 with prescript \textrightarrow\ 4.63 \textrightarrow\ 4.64; cf. the introduction p.\,\hpref{75}\,f.). Their readings are reported here.}
\end{ava}
%</vs61a>
%<*vs61>
\begin{tlg}[hp04_061]
...
\tl{\app{\lem[nolem]{}
	...
	\rdg[wit={G11,G5},alt=\textapp{found as 3.93*7}]{\skp{found as 3.93*7}}
	}%
...
\pada{\app{\lem[wit={N3,E2,G11,G5,N19,GrB,Jyo}]{śeṣās tv eva}% aiva P11; +C7
	...
	\myfn{\getsiglum{G11,G5} have this verse after \manuref{3.93*7} too.}
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={N23}]{\unavbl}
	\rdg[wit={V19},alt=\textapp{pādas ab and cd are transposed}]{\skp{ab and cd are transposed}}}%
...
\pada{\app{\lem[wit={N3,J5,J7,N19,P11,Jyo},alt={ekapravṛtter}]{ekapravṛtte\skp{r}}
	...
	\rdg[wit={V15},post=\textapp{(alternative reading for pāda a)}]{ekasya nā<śā>d aparasya nāśaḥ}}/}%
	\\+}
\tl{
...
\app{\lem[wit={J5,C6,V3}]{svātmārāmayogīndra} % yogiṃdra V3
	...
	\rdg[wit={P11},post=\textapp{(sic!)}]{°yo°}
