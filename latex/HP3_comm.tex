...
\end{translation}
% MD: pāda a: adopt yathāśaktyā as in 2.7?
% pāda c: dakṣāṅge ca samabhyaset or dakṣāṅge punar abhyaset instead of dakṣiṇāṅge samabhyaset?
...
%which occurs in some manuscripts in the \textbeta\ (\getsiglum{J1}, \getsiglum{N12}), \textzeta\ (\getsiglum{J14}) and \textdelta\ (\getsiglum{J3}, \getsiglum{N16}, \getsiglum{N18}) groups, 
which occurs in some manuscripts in the \deltaOmega\ (\getsiglum{J1}, \getsiglum{J3}, \getsiglum{N16}, \getsiglum{N18}) and \textbeta\ (\getsiglum{N12} contaminated) and \textzeta\ (\getsiglum{J14} contaminated) groups, % by MD
...
% MD: These mss are not very strong. Is it not possible to interpret °vedhaghnaḥ as "destroys by piercing"? (like daṇḍaghna "striking with a stick" in the Manusmṛti) This verse only has no source in the middle of the long citation from Amaraugha, is probably authorial. Svātmārāma might have wanted to use the word vedha of mahāvedha, similar to dhauti/dhāvanti.
\end{philcomm}
...
% MD: Sorry, now I want to reactivate the verse, since α4 has the verse too:
% kalāṃ tu prāṅmukhī nītvā kṣaṇārddhaṃ <ya>di tiṣṭhati
% kṣaṇena mucyate vyādhi-jarāmṛtyumayādikaiḥ
% Fortunately, I have not yet changed the verse numbers.
%%%%%%%%%%
\subsection*{3.36}
...
A manuscript of an early recension of the \emph{Vivekamārtaṇḍa} (ms.~no.~4110) has \emph{hataḥ śaktyā}, which is attested by three \emph{Haṭhapradīpikā} manuscripts on lower branches of the stemma (i.e.~\getsiglum{Ba}, % MD: this ms does not belong to any group
...
Alternatively, the word \emph{hataḥ} (as well as the other variants \emph{kṛtaḥ, kṛte}, and even \emph{haṭhāt}) may derive from \emph{hṛtaḥ}, which is attested by manuscripts of the \emph{Jyotsnā} (i.e., \getsiglum{Ba5}, \getsiglum{N4a} and \getsiglum{N13}). % MD: These are Jyotsnā mss.
...
% MD: α1 and β-mss have 'yam iṣyate in place of 'yam ucyate.
...
% \alphaOne\ and \alphaTwo\ only; \alphaThree\ has uṣṇa.
...
Because the great bird tirelessly flies up (\emph{uḍyāṇaṃ kurute}), it is [called] `flying up'. In it, the [root] lock is applied.
\end{translation}
...
\end{translation}
% MD: In view of the position of the second tu, wouldn't it be better to separate the sentences after abhyaset?
...
At the end of the second \emph{pāda} \emph{sadā} is attested by witnesses of \textalpha, \texteta, \textzeta\ and \delta \ groups, %?? all but the gamma/delta groups; JM: but do we need to mention this?
as well as the \emph{Dattātreyayogaśāstra}. We have understood the first line to mean that even though the basics of the practice of \emph{uḍḍiyāna} are easy, it still needs to be taught by the guru. Some witnesses read \emph{yathā} for \emph{sadā}, % = gamma/delta
...
\end{translation}%??JM relevant to note too, isn't gala more throat than neck?
...
See \manuref{4.11}, where this verse is also found.
\end{philcomm}
...
% MD: pāda b: striyā must be a wrong emendation of gamma group. If the best attested bījaṃ does not work, shall we read svīyaṃ (β1)? Maybe, eva svīyaṃ > evamvījaṃ > evaṃ bījaṃ?
...
\end{translation}
% MD: adopt the reading "prathamāṃ ca dhārāṃ"? "ambu" was probably introduced in the mss where the last word "amaryāḥ" had been corrupted.
...
%No known source.
%\end{philcomm}
%?? MD: It seems that the redactor (= the creator of the extended version of HP) first moved 4.62 here, as it deals with kuṇḍalinī and fits the topic here, together with the three adjacent verses (4.61, 63 and 64), as these four form a set (ślokacatuṣṭaya). In the \textepsion\ they are still found in the order 4.62 -> heading of the ślokacatuṣṭaya -> 4.61 -> 4.63 -> 4.64. However, except for 4.62, they are omitted in the mss of the lower branches of the stemma (zeta, eta), probably because they were considered out of place. 
...
%?? MD: partly repeated. JB: okay, i've changed this.
...
%[his] body is immortal, filled with the nectar of the moon from the uvula for the first time. 
...
%?? MD: abhyasyato seems to be overcorrect in this text in which always abhyaset is used instead of abhyasyet. The participle abhyasato (cf. 3.63 abhyasan, though this might be wrong for abhyasen) or the adverb abhyāsato (cf. 1.27c) may be more prabable.
\end{philcomm}
...
\end{translation}
% MD: better to read "nirbhayaṃ cālanād asau" instead of "nirbhayaś cālayed asau". nirbhayaṃ is an adverb here. The variant reading nirbhayaś probably originates from the misreading of °bhayañcā° as °bhayaścā° in a South Indian ms.
...
Manuscripts of the \textbeta, \textepsilon, \texteta, and \textzeta\ groups have a different reading for the second line; `each mudrā is capable of being a cause of all powers' (\emph{kāraṇaṃ sarvasiddhīnāṃ ekaikāpi kṣamaiva sā}).%?? MD: karaṇe of ε may be the better reading: "capable of bringing about all siddhis"
\end{philcomm}
...
\end{translation}
%?? MD: Wouldn't the alpha reading rājayoga-samudra-vat work? "Like the ocean of rājayoga (as the ocean yields jewels?), Rudrāṇī bestows great perfection on those who are tireless..." I am not fully convinced myself, but the present reading is not nice either. And I have a strong feeling that the verse consists of only one sentence.
...
%       rudrāṇīvāparāṃ mudrāṃ bhadrāṃ siddhiṃ prayacchati//
