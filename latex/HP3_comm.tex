...
\dummy[\dots] the empty pathway becomes the royal highway for \emph{prāṇa}, the mind becomes free of support, and death is cheated.%JM: translate the tadā-s?
\end{translation}
%</tr3>
...
[\ldots] the bodily position called inverted, \emph{vajrolī} [and] the moving of the goddess: this group of ten \emph{mudrā}s and other [practices] destroys old age and death.
\end{translation}
%</tr7>
...
jarāmaraṇanāśanam~] daśa mudrāḥ prakīrtitāḥ HRĀ, jarāmaraṇavarjitam YCM, mudrāṇām uttamottamam YBhD 
\end{variants}
...
\dummy[The yogi] should press the perineum with the heel of the left foot, hold [the foot of] the extended leg with the hands and breathe in through the mouth.
\end{translation}
%</tr10>
...
This verse is taken from the \emph{Amaraugha}, which uses the alchemical imagery of the \emph{Amṛtasiddhi} to describe the stilling of Kuṇḍalinī in the central channel. Drawing on \textsc{Hellwig} 2009: 238–240, \textsc{Mallinson and Szántó} (2021: 21) note that “In alchemical texts \emph{māraṇa} (“killing”) involves heating a substance and thereby changing its state, usually through calcination or oxidation, so that it becomes inert. In the \emph{Amṛtasiddhi māraṇa} and other derivatives of the root \emph{mṛ}, “die”, are used to denote the stilling or stopping of either the breath or Bindu.” Thus when Kuṇḍalinī is said to be in the state of \emph{maraṇa} the meaning is that she is stilled. The \emph{dvipuṭa} or “vessel with two halves” in which this occurs is the same as the \emph{Amṛtasiddhi}’s \emph{saṃpuṭa}, which, drawing on \textsc{Hellwig} (2009: 342), \textsc{Mallinson and Szántó} (2021: 22) say “consists of two \emph{puṭa}s joined together to form a sealed crucible for heating reagents without evaporation”. In the yoga of the \emph{Amṛtasiddhi}, the bodily \emph{saṃpuṭa} is formed by applying locks at the top and bottom of the central channel, i.e.~constricting the perineal region and the throat. In the \emph{Haṭhapradīpikā} it is formed by pressing the perineum with the heel and constricting the throat.\lb

As \textsc{Birch} (2019: 971) notes, it is unlikely that later non-Buddhist authors understood \textit{maraṇāvasthā} and \emph{dvipuṭa} according to the alchemical metaphors of the \textit{Amṛtasiddhi}. Later commentators take \emph{dvipuṭa} as the two nostrils (e.g., \textit{Yuktabhavadeva} 7.187, \textit{dvināsāpuṭa}); the \textit{iḍā} and \textit{piṅgalā} channels (e.g., \textit{Jyotsnā} 3.27, \textit{puṭayor dvayam iḍāpiṅgalayor yugmam}); or the in and out flows of the breath (e.g., \textit{Yogaprakāśikā} 5.16–17, \textit{vāyor bahirnirgamanam antaḥpraveśa iti yat puṭadvayaṃ tam}). How these commentators understood \textit{asau māraṇāvasthā} is less clear. Brahmānanda seems to take it as the death of \textit{prāṇa}, or in other words, the absence of the breath, in the two nostrils (\textit{maraṇāvasthā jāyate kuṇḍalībodhe sati suṣumnāyāṃ praviṣṭe prāṇe dvayoḥ puṭayoḥ prāṇaviyogāt}).  Bhavadeva thought that Kuṇḍalinī, along with \textit{prāṇa} and \textit{apāna}, remains in the two nostrils while the breath is being held (\textit{evaṃ vāyudhāraṇāyāṃ kriyamāṇāyāṃ vyākulā bhūtā kuṇḍalinī apānaprāṇābhyāṃ saha nāsāpuṭadvayāśritā bhavati}). Others, such as Śivānanda and Bālakṛṣṇa, favour the reading \textit{tadā sā maraṇāvasthāṃ harate dvi\teimute{\-}puṭāśritām} (or \textit{dvipuṭāśrayām}), which is present in group \textgamma\ and \textdelta\ manuscripts of the \textit{Haṭhapradīpikā}. Bālakṛṣṇa understands this to mean that the great seal destroys death (\textit{maraṇāvasthāṃ harate mahāmudreti bhāvaḥ}) but it could also mean that the awakened Kuṇḍalinī destroys death, which is usually dependent on the in and out breaths.\lb
...
\dummy[The yogi] should then exhale very slowly, not quickly. This is the great seal revealed by the great Siddhas.
\end{translation}
%</tr13>
...
This verse appears to be explaining the name of \emph{mahāmudrā} through assonance with \emph{mahā\teimute{\-}kleśādayo, doṣā} and \emph{maraṇādayaḥ} in the first line.
\end{philcomm}
%</cm14>
...
\begin{versinnote}  
\tl{atrāyaṃ kramaḥ/ ākuñcitavāmapādapārṣṇiṃ yonisthāne saṃyojya prasāritadakṣiṇapādāṅguṣṭham ākuñcitatarjanībhyāṃ\skx{\linebreak}{ }gṛhītvābhyāso vāmāṅge\skx{}{ }'bhyāsaḥ/ asminn abhyāse pūrito vāyur vāmāṅge tiṣṭhati/ ākuñcita\teimute{\-}dakṣa\teimute{\-}pāda\teimute{\-}pārṣṇiṃ yoni\skx{-}{}sthāne saṃyojya prasārita\teimute{\-}vāma\teimute{\-}pādā\teimute{\-}ṅguṣṭham ākuñcita\teimute{\-}tarjanībhyāṃ gṛhītvābhyāso dakṣāṅge\skx{}{ }'bhyāsaḥ/ asminn abhyāse\skx{\linebreak}{ }pūrito vāyur dakṣāṅge tiṣṭhati/\\!}
\end{versinnote}
\closer
\begin{quote}
...
\dummy[For the yogi who practises thus] there is no wholesome or unwholesome [food], and all flavours without exception become flavourless. Even terrible poison, when consumed, is digested like nectar.
\end{translation}
%</tr16>
...
In \emph{Jyotsnā} 3.18, Brahmānanda understands \emph{mahāsiddhi} as referring to ‘great \emph{siddhi}s,’ but in other works it can mean liberation (\textsc{Mallinson} 2012b).
\end{philcomm}
%</cm18>
...
\dummy[The yogi] should place the heel of the left foot on the perineal region. And he should put the right foot on the left thigh, [\dots]
\end{translation}
%</tr19>
...
The referent of \emph{madhye} is uncertain. The verse is derived from the \emph{Amaraugha}, and the \emph{Amṛtasiddhi} makes no mention of a place to focus the mind in its treatment of \emph{mahābandha} (it does however instruct the yogi to place the mind at the \emph{catuṣpatha} in its teachings on \emph{mahāmudrā}). Bhava\teimute{\-}deva\teimute{\-}miśra (\emph{Yukta\teimute{\-}bhavadeva} 7.196), Brahmānanda (\emph{Jyotsnā} 3.20) and Bālakṛṣṇa (\emph{Yogamārgapradīpa} 5.24) take it to mean the central channel. It could also plausibly mean the region between the chest and perineum, or perhaps the place between the eyebrows. At 3.23 this practice is said to make the mind reach Kedāra, which is sometimes located between the eyebrows (see \textsc{Mallinson} 2007: 214 n.\,285; \textsc{Birch} 2019: 967 n.\,57).
\end{philcomm}
%</cm20>
...
This portion of the description of \emph{mahābandha} has undergone various revisions in the manuscript groups. The shortest version appears in \alphaOne, \alphaTwo\ and \alphaThree, as well as the \textdelta\ group and the \emph{Haṭha\teimute{\-}ratnāvalī}, all of which omit verses 3.21*2 and 3.22*1cd. We have adopted the \textalpha\ version, as it seems that 3.21–22 were reworked in a major redaction of the whole work (for further discussion, see the introduction p.\,\hpref{73}).
%
...
\begin{variants}
amuṃ yogī mahābandhaṃ mahāsiddhipradāyakam~] ayaṃ yogo mahābandhas sarvasiddhi\teimute{\-}pra\teimute{\-}dā\teimute{\-}ya\teimute{\-}kaḥ HRĀ    
\end{variants}
...
Triveṇī and Kedāra are pilgrimage sites, the former at Prayāga where the Gaṅgā, Yamunā and subtle Sarasvatī meet, the latter in the Himālaya, near the source of the Gaṅgā. The bodily \emph{triveṇī} is located in the navel or heart by earlier Śaiva works (\textsc{Birch} 2019: 967). Here it may be the same as the \emph{trikūṭa} and located between the eyebrows (\textsc{Mallinson} 2007: 209 n.\,259). Brahmānanda, who does not identify a location for Triveṇī, understands Kedāra to be between the eyebrows. In the \emph{Khecarīvidyā} it is located on the back of the head above the nape of the neck (\textsc{Mallinson} 2007: 214 n.\,285). For other references on the location of Kedāra, see \textsc{Birch} 2019: 967 n.\,57.
\end{philcomm}
%</cm23>
...
\begin{versinnote}
\tl{mahābandhasthito yogī kukṣim āpūrya vāyunā/\\+}
...
And the union of the moon, sun and fire arises, which leads to immortality. The dead state has arisen, so where is the fear of death?
\end{translation}
%</tr27>
...
The \textalpha, \textgamma\ and other groups have \emph{saṃbandhāj}, which is possible but somewhat awkward (i.e.~‘because of the union of the moon, sun and fire, the state of a dead person, which has arisen, leads to immortality’). The adopted reading \emph{saṃbandho}, which is supported by \zetaTwo, \emph{Yuktabhavadeva} 7.200 and \emph{Jyotsnā} 3.28, makes better sense but its meaning is not as clear as the formulation in the source text (i.e.~\emph{Amaraugha} 30: \emph{°saṃbandhaṃ jānīyād amṛtāya}).\lb

The compound \emph{mṛtāvasthā} (‘the dead state’) refers both to a dead person (in the sense that the yogi appears as if dead) and the dead state of the breath when the moon, sun and fire have united. For the alchemical metaphor of \emph{mṛtāvasthā} (cf.~\emph{maraṇāvasthā}), see the commentary on 3.12.\lb

In the version found in \emph{Jyotsnā} 3.28 and \zetaThree, \etaOne, \etaTwo\ and the \emph{Yuktabhavadeva}, the final verse quarter has been rewritten to say that the yogi then exhales the breath (\emph{tato vāyuṃ virecayet}). This implies that \emph{mṛtāvasthā} is a breath retention (\emph{kumbhaka}), which is apparent in Brahmānanda's explanation: 
...
% JM: agreed it's likely to = maraṇavāsthā. How about "the stilled state"? And make clearer that the Amaraugha version works and Svātmārāma must have had a corrupt version? And note alchemical metaphor.
\begin{versinnote}
...
as well as the \emph{Yogacintāmaṇi}, \emph{Yuktabhavadeva}, and \emph{Jyotsnā}. The mistake likely arose from the similarity of \emph{dha} and \emph{pa} in Nagari scripts.
...
%JM: MD suggestion seems unlikely to me, I can't think of similar expressions. We might mention the similarity between dh and p, together with vedha being in the previous line, as a likely source of the corruption
\end{philcomm}
%</cm28>
...
After cutting, he should rub [the cut] with a powder of rock-salt and myrobalan. After seven days he should again cut away a hair’s breadth.
...
%  em ed. to match source ( = Jyotsnā) °pathyābhyāṃ cūrṇitābhyāṃ: JB agree. MD please change.
\end{sources}
%</sc32-2>
...
[The yogi], regularly applying himself, should thus practise gradually for six months. After six months the binding tendon at the base of the tongue is destroyed.
%JB: this is one occasion where nitya might be rendered regularly? I can't beleive I just typed that ;) 
%JB: change edition to śirābandhaṃ (eta, omega pc). Correct spelling is sirā but I see that śirā is common elsewhere for this verse. JM: yes, and śarā in ed. is surely wrong. MD please change.
\end{translation}
%</tr32-3>
...
Then, knowing the rules of time and limit, the yogi should gradually pull upwards the tip of [the tongue,] the abode of the goddess of speech, having wrapped it in cloth.
...
%This verse was likely added to explain ‘by the method of the cloth’ (\emph{paridhānayuktyā}) in the previous verse. 
One would expect to read \emph{caturaṅgulavistāram} in the second verse quarter, and the current reading is probably a result of the metre. This verse also occurs at 3.95*2.
\end{philcomm}
%</cm32-5>
%%%%%
...
%JB: mātreṇa? Then, after repeated drawing out [of the tongue] for only six months, my dear, it extends as far as the middle of brow, across to the ears ... JM: I don't think mātreṇa has much value here, Cf.\,the next verse which says what happens after a year.
%JB: emend punaḥ in pāda b to nitya (vis-à-vis KhV)? It looks like it's been translated and makes better sense. JM: agreed.
\end{translation}
%</tr32-6>
...
% KhV ed has nityasaṃkarṣaṇāt which works better. Adopt? JB: Sorry, just seen these comments. JM: yes, I agree. MD please change ed.
...
% JB: em. saṃkhyā° to śaṅkhā° JM: agreed, MD please change
% \end{philcomm}
%</cm32-7>
...
And then, after the second year, o goddess, it easily covers the top of the aperture of Brahman, o she who is worshipped by the supreme [deity].
%JB: by tiṣṭhet, are we supposed to understand that the tongue can remain there? (that's pretty incredible)
% JB: paramavandite? I don't find this vocative elsewhere. Highly venerated? Combine with devi? (i.e.~O most venerable goddess). Or emend back to tiṣṭhaty amaravandite. JM: it must still refer to devi, keep it and tr. as "worshipped by the supreme" as it can be made sense of? 
\end{translation}
%</tr32-8>

%<*sc32-8>
\begin{sources}[hp03_032_8]
Cf.\,\emph{Khecarīvidyā} 1.51cd + 1.53ab 
\begin{variants}  
saṃvatsarād devi dvitīyād~] saṃvatsarāṇāṃ tu tṛtīyād KhV\sep
...
%  JB: mastakāc ca?  HP 10 Ch has mastakastha (probably a patch) JM: so ed. is wrong? This is v. complicated in KhV as it's in fact about the mantra but most sources think it's about the tongue. 10-ch H3 is reported as mastakastha, which is easy to make sense of so let's adopt that. Tr. changed accordingly.
\end{translation}
%</tr32-10>
...
The yogi should practise the mantra (\emph{vidyā}) that has been taught and is extremely hard to obtain joined with the previously described seed syllable [and] its six limbs with it divided according to the six \emph{cakra}s.
\end{translation}
%</tr32-11>
%NJL: Vidyā? 
...
This verse is a reworking (or corruption) of \emph{Khecarīvidyā} 1.34 which is difficult to make sense of. On the Khecarī mantra see \emph{Khecarīvidyā} 1.29–44 and the notes thereon in Mallinson’s edition.
\end{philcomm}
%</cm32-11>
...
The mind which moves in the eternally blessed void in which all activity has ceased is Khecarī, the bringer of union with Śivahood [and] the remover of the suffering of existence.
\end{translation}
%JB: nirastasakalakriyākrame? (...void in which the course of all activities has ceased). Wouldn't śāśvatodaya mean something like 'eternally arising'? And just wondering if it necessary to supply [mind]? JM: udaya = prosperity, good fortune.
%</tr32-12>
...
He who pierces the six \emph{cakra}s, wakes up the snake-goddess situated at the Base, breaks through the great triad of knots which are like a defensive wall in the rear channel [i.e.~the Suṣumṇā], then leads the breath to the opening in the head, churns that \emph{liṅga} sufficiently with his mind and drinks [the \emph{amṛta}] dripping from the orb of the moon, is liberated, Śiva himself in person.
\end{translation}
...
The referent of \emph{tat}, rendered here as “that” in “that \emph{liṅga}”, is unclear and may refer to something in a previous verse in an unidentified source text.
\end{philcomm}
%</cm32-15>
...
\end{translation}
%?? JB: do we know what the saptadhārā is? AŚ has vaktradhārā (drinks the stream of nectar flowing [down] to his mouth?). JM: No.
%JB: I don't understand śītalāṃgaṃ (whose essential part is cool?). JM: whose body is cool, i.e. is cool.
%?? maybe read bata mahāmṛtyurogā dravante instead of mṛtapathā mṛtyurogād bhavanti. At least the former makes some sense (not sure about bata though). Can't see a remedy for prasarati sakalaṃ yāti kālaṃ bhramitvā. I see the 10-ch HP has kālo, which provides a subject. But what to do with sakalaṃ and the AŚ's harati viṣajarāṃ? JM: just crux it?
%</tr32-16>
...
Cf.~\emph{Jnānasāra} 2.10cd 
\begin{versinnote}
\tl{ghṛtāsvādūpamānāś ca hy amaratvaṃ na saṃśayaḥ/\\!}  
\end{versinnote}
\end{sources}
</sc32-17>
...
%JB: Cf.\,JS 2.11:  mṛṣṭānikhaṇḍakadyāni laḍukāśokavartikāḥ| evaṃ vārāhy aneke ca kāmadevo vyavasthitaḥ (I don't understand the syntax (aiśa?) but perhaps the idea is that if the nectar is similar to any of these foods, one exists as a Kāmadeva). Maybe the second hemistich of the JS dropped out of the HP transmission (note?).
...
Cf.\,Jñānasāra 2.10cd (ab only)
\begin{versinnote}
\tl{madhusvādūpamānāś ca śāstrodgīraṇatā bhavet//\\!} 
\end{versinnote}

Cf.~\emph{Jñānasāra} 2.11 (cd only)
\begin{versinnote}
\tl{mṛṣṭāni khaṇḍakādyāni laḍukāśokavartikāḥ/\\+}
\tl{evaṃ vārāhy aneke ca kāmadevo vyavasthitaḥ//\\!}
\end{versinnote}
\end{sources}
</sc32-18>
...
The second half of this verse is related to \emph{Jñānasāra} 2.11ab but makes no sense on its own. Perhaps the second half of the \emph{Jñānasāra} verse has dropped out.
...
\emph{Śivasaṃhitā} 3.91, \emph{Jñānasāra} 2.6 
\begin{variants}
kalāṃ parāṅmukhīṃ kṛtvā~] rasanām ūrdhvagāṃ kṛtvā ŚS, JS\sep
yādhimṛtyu ŚS~] vyādhibhis tu JS
\end{variants}

% \emph{Jñānasāra} 2.6 %JB are we treating this as a source? JS 2.3–6 seems to be close to some HP verses. Also JS 2.12–15 are close to HP 2.54–56
% \begin{versinnote}
...
%<*cm34>
\begin{philcomm}[hp03_034]% for both 3.34 and 3.34*1-2
Although 3.34 is absent in \alphaOne, it is in \alphaTwo\ and \alphaThree, and also the \textgamma\ and \texteta\ groups. Other manuscripts have an additional line that gives \emph{vyomacakra} as an alternative name for \emph{khecarīmudrā} (3.34*1). On the meaning of \emph{vyomacakra}, see the commentary on X4.49.
\end{philcomm}
%</cm34>
...
[The yogi] should roll back the tongue onto [the junction of] the three pathways. This is \emph{khecarīmudrā}; it is [also] called the ‘\emph{cakra} of the void’ (\emph{vyomacakra}). If the yogi turns the tongue upwards and keeps it there for half a moment, he is instantly freed from disease, death, old age and the like.
...
%%%%%%%%%%
\subsection*{3.37}% = 4.11*7/X4.47
%<*tr37>
\begin{translation}[hp03_037]
The mind moves (\emph{carati}) in space (\emph{khe}) because the tongue moves (\emph{carati}) in space (\emph{khe}). That is why this seal is called Khecarī [and] is worshipped by the Siddhas.%
...
In the context of poison, \emph{takṣaka} refers to one of the three kings of the snakes (\emph{nāga}), the other two being Śeṣa and Vāsuki (\textsc{Mani} 1975: 782–783).\lb % Purāṇic Encyclopaedia: A Comprehensive Dictionary with Special Reference to the Epic and Purāṇic Literature. Vettam Mani. Delhi: Motilal Banarsidass.
...
I consider he who regularly eats cow flesh and drinks the liquor of the gods to be of good lineage. Others are destroyers of the lineage.%JM: lineage for family? family sounds a bit odd to me.
\end{translation}
%</tr43>
...
utkallolakalājalaṃ VM~] utkallolakalākalaṃ VM\vl, utkallolajalākulaṃ VM\vl, utkallolajalāmṛtaṃ VM\vl, tat kallola\teimute{\-}kalā\teimute{\-}jalaṃ VM\vl, tat kallolajalākulaṃ VM\vl\sep
...
\begin{versinnote}
\tl{ekaṃ sṛṣṭimayaṃ bījaṃ ekā mudrā tu khecarī/\\+} % eka[ṃ] sṛṣṭimayaṃ bījaṃ ek[ā]
...
The instruction to ‘contract the wind’ (\emph{vāyum ākuñcayet}) is odd (especially with \emph{samīraṇaḥ} in the fourth \emph{pāda}) and not found in other texts. Mallin\teimute{\-}son has adopted \emph{yonim} for \emph{vāyum} (cf.\,\emph{Haṭhapradīpikā} 3.49b) in his edition of this verse in its source text, the \emph{Dattātreyayogaśāstra}, which is not found in the manuscripts of that text but is in the \emph{Haṭhapradīpikā}’s \textdelta \ manuscripts. Another possibility is that \emph{vāyum} is a corruption of \emph{pāyum}, ‘anus’. \lb %MD: perhaps corrupted from pāyum?

In the context of the root lock, \emph{vāyum ākuñcayet} can be understood as an instruction to contract \emph{apāna\teimute{\-}vāyu}, which is mentioned in the previous verse (3.50a). Instructions to contract \emph{apāna\teimute{\-}vāyu} are found in other yoga texts, such as \emph{Yoga\teimute{\-}tārā\teimute{\-}valī} 7b (\emph{ākuñcanaiḥ śaśvad apānavāyoḥ}), \emph{Śiva\teimute{\-}saṃhitā} 4.84cd (\emph{apāna\teimute{\-}vāyum ākuñcya balād...}), \emph{Śiva\teimute{\-}yoga\teimute{\-}pradīpikā} 2.53ab (\emph{athordhva\teimute{\-}madhya\teimute{\-}sthira\teimute{\-}bandha\teimute{\-}nābhyām ākuñcanād ūrdhvam apānavāyoḥ}) and \emph{Yukta\teimute{\-}bhava\teimute{\-}deva} 7.297 (\emph{ādhāra\teimute{\-}kamale suptāṃ cālayet kuṇḍalīṃ dṛḍhām}/ \emph{apāna\teimute{\-}vāyum ākṛṣya balād ākuñcya buddhimān}). In \emph{Jyotsnā} 3.63, Brahmānanda understands \emph{vāyu} in this verse as \emph{apāna} when he says that ‘one should contract the wind, \emph{apāna}’ (\emph{vāyum apānam ākuñcayed}), which he explains as, ‘one should pull it by contractions of the anus’ (\emph{gudasyā\teimute{\-}kuñcanenā\teimute{\-}karṣayet}). In the same vein, Bhava\teimute{\-}deva\teimute{\-}miśra glosses ‘pulling \emph{apāna}’ (\emph{apānā\teimute{\-}karṣaṇam}) as ‘contracting the anus’ (\emph{gudā\teimute{\-}kuñcanam}), when commenting on ‘having pulled \emph{apāna\teimute{\-}vāyu} and forcefully contracted it ...’ (\emph{apāna\teimute{\-}vāyum ākṛṣya balād ākuñcya...}) in \emph{Yukta\teimute{\-}bhava\teimute{\-}deva} 297 and 301.  
\end{philcomm} %
%</cm51>
...
Since the term \emph{nāda} usually means ‘internal sound’ in Haṭha and Rājayoga texts, it is possible that \emph{bindu} here was understood by some to have the tantric connotations of sonic and visual foci (\textsc{Mallinson} 2007: 219 n.\,325) or two levels of sonic emanation in \emph{mantroccāra}, where \emph{nāda} is an unvoiced sound and \emph{bindu} is the slightly coarser sound of inner murmuring (see \emph{Tāntrikā\teimute{\-}bhidhānakośa} vol.~3: 278–279). However, there is a passage in the \emph{Amaraugha} (10–12) where \emph{nāda} and \emph{bindu} are paired and it is clear that \emph{bindu} means generative fluid. 
\end{philcomm}
%</cm52>
...
\end{translation}
%JB: I'm not sure whether the referent of the second "it" is clear. "yogis say that this [lock] is called Uḍḍīyaṇa because the breath flies up (\emph{uḍḍīyate}) into the Suṣumṇā when bound by it." JM: clear to me, what do others think?
%</tr58>
...
\end{translation}
%</tr61>
% MD: "One should always practise uḍḍiyāṇa in its original form, as taught by a guru"? JM: this is how I have translated it in the DYŚ, albeit without great certainty, and I have a note there saying: "The import of sahajam here is not clear to me. Perhaps more meaning than is usual in the text should be placed in tu: even though the practice is easy, for some unspecified reason it still needs to be taught by a guru. Or perhaps sahajam refers to the fact that anyone can perform Uḍḍiyāṇa, unlike some of the other haṭha practices."
...
Cf.\,\emph{Yuktabhavadeva} f.\,76v (\attr \emph{Śivayoga})
\begin{versinnote}
...
\tl{siddhāsane sthitvā hastābhyāṃ pādau gulphapradeśasamīpe dṛḍhaṃ dhṛtvā tunde nālotthānaṃ sādhu vidhāya samāhita\skx{-}{}manasā sudṛḍhamūlabandhajālandharabandhavatābhyāsinā sādhakena recakādau kuṃbhakānte udare paścimatāne kriyamāṇe nitarāṃ tadā tatra nābhikandanipīḍane paścimatānena sati nābhikandotthā nāḍaya ūrdhvamukhā vikasitā viralā vimalā asaṃhatā vāyugrahasamarthā bhavanti tadā sakuṃbhitaḥ prāṇavāyuḥ śanaiḥ//\\!}
\end{versinnote}
...
\dummy[The yogi] should contract the throat and place it firmly [and] deliberately on the chest. This is the lock called \sl{jālandhara}. It prevents loss of the nectar of immortality.
%\dummy[The yogi] should contract the throat and firmly place the chin on the chest. This is the lock called \sl{jālandhara}. It prevents loss of the nectar of immortality.
%%JB and MD we should reconsider the sthāpayed dṛḍham icchayā reading: perhaps, we could understand it as, "Having contracted the throat against the chest, [the yogi] should fix it firmly, as he likes." The dṛḍham icchayā reading is in the ŚDP, so it was circulating before the HP was composed. JM: surely sthāpayet needs an object (which can't be kaṇṭham)? Adopt icchayā reading but JM to write note. In DYŚ this is one of the very few places where I adopt a reading against the stemmatic hypothesis. In note say we aren't sure of meaning of icchayā. Wilfully? Deliberately? According to desire doesn't make sense.??
\end{translation}
%</tr66>
...
\begin{variants}
dṛḍham icchayā DYŚ\vl~] dṛḍhayā dhiyā DYŚ\vl, cibukaṃ dṛḍham DYŚ\sep
...
\begin{variants}
dṛḍham icchayā YCM~] cibukaṃ dṛḍham HRĀ\sep
...
The reading \emph{sthāpayed dṛḍham icchayā} in the second verse quarter is attested by the manuscripts of the \textalpha, \textdelta, \texteta\ and \textpi\ groups. It is also well-attested in the transmission of the source text, the \emph{Dattātreyayogaśāstra}, but in his edition Mallinson has adopted \emph{sthāpayed cibukaṃ dṛḍham} on semantic grounds. This reading is found in two of his favoured manuscripts but this is one of the very few instances where he reads against his stemmatic hypothesis. He puts this down to contamination in the transmission. Our sources, in particular the manuscripts of the \textalpha\ group, indicate that Svātmārāma read \emph{sthāpayed dṛḍham icchayā} (which is also the reading which Mallinson’s stemmatic hypothesis indicates is primary in the \emph{Dattātreyayogaśāstra}) and we have adopted it accordingly. It is certainly the \emph{lectio difficilior}. Taking \emph{kaṇṭhaṃ} as the object of \emph{sthāpayet} is awkward, as it is hard to see how one could place the throat on the chest, and the meaning of \emph{icchayā}, which we have translated as “deliberately”, is uncertain.%The word \emph{icchayā} may have crept in to this verse because someone wanted to make this practice optional in light of 3.21*2, % MD: 3.22, now 3.21*2, is not  in the α mss, so this argument is not appropriate.
...
By contracting the throat, [the yogi] firmly blocks the two channels. This should be known as the middle \emph{cakra}, which binds [the mind to] the sixteen supports [in the body].
\end{translation}
%</tr69>
...
The import of the second line of this verse is not entirely clear without the context of the source text. It derives from a passage in the \emph{Jñānasāra} (2.1–5), which identifies \emph{khecarīmudrā} as the ‘\emph{cakra} of the void’ (\emph{vyomacakra}) and \emph{khecarīmudrā} combined with the contraction of the throat as the ‘middle \emph{cakra}’ (\emph{madhyacakra}). The middle \emph{cakra} seems to be so designated because it is situated between the \emph{vyomacakra} and a root \emph{cakra} (\emph{mūlacakra}), which is located between two \emph{śakti}s in the navel.\lb

Svātmārāma appears to have incorporated the \emph{Jñānasāra}'s verse on \emph{khecarī} and the \emph{madhyacakra} into his discussion of the \sl{jālandhara} lock because its reference to contracting the throat (\emph{kaṇṭhasaṅkocana}) reinforces the idea that this contraction blocks important channels, a point stated more generally in the two preceding verses that he borrowed from the \emph{Vivekamārtaṇḍa}. The \emph{Jñānasāra}'s verse on \emph{vyomacakra} was incorporated into later versions of the \emph{Haṭhapradīpikā} (see the commentary on X4.49).\lb 

In \emph{Jyotsnā} 3.73, Brahmānanda, who appears to have been unaware of the \emph{Jñānasāra}, says that the middle \emph{cakra} (\emph{madhyacakra}) is \emph{viśuddha cakra}. He appears to say this because the \emph{viśuddha cakra} is located in the throat and the \sl{jālandhara} lock is a contraction of the throat. However, he also connects the \emph{viśuddha cakra} to the sixteen supports (\emph{ṣoḍaśādhāra}) at the end of this verse, perhaps because this \emph{cakra} has sixteen petals (as mentioned in 3.46). On the meaning of \emph{ādhāra} in yogic contexts, see entry no.\,3 in the \emph{Tāntrikābhidhānakośa} vol.\,1: 191.%
% ?? JB: please check> Nice job. one comment: shouldn't cakra be in italics? Only chakra is in the OED etc.
% ref format? s.v. ādhāra? [MD: fixed]
...
By this method alone [the yogi] may frequent the [true] home of the breath. Then death does not arise nor old age, disease and the like.
\end{translation}
%</tr72>
...
pavanālayam YCM~] pavano layam HRĀ
\end{variants}
...
%The \textalpha, \textpi\ and delta groups have the reading \emph{sevayet pavanālayam} as the second verse quarter of this verse. 
%It renders the meaning, ‘by this method alone, one should honour the abode of the %breath.’ 
As far as we know, the compound \emph{pavanālaya} does not occur in other yoga texts. Here, it appears to refer to Suṣumṇā. The similar compound \emph{prāṇālaya}) is mentioned in other yoga texts, such as the \emph{Yogayājñavalkya} (4.52–53), but it refers to the locations in the body where \emph{prāṇa} resides, as opposed to the other bodily winds.
...
% MD: We need anyway a commentary. sevayet pavano layam is a mix of two recensions: we should adopt either prayāti pavano layam or sevayet pavanālayaṃ (alpha reading). JM: I suppose one could understand sevayet pavanālayam to mean "one may frequent the [true] home of the breath".
...
\tl{vāsare'thādime'bhyāsavṛddhyā dhayet/\\+}
...
%See 4.10, where this verse is also found.\lb
See 4.10–11, where these verses are also found.\lb

The \textalpha\ group do not have 3.77*1 and 3.77*2 in the third chapter (but rather in the fourth) and other manuscripts omit them as well (notably the \texteta\ group). For a discussion of these verses, see the introduction p.\,\hpref{75}.
\end{philcomm}
%</cm77-2>
...
\tl{samabhyasen niścalam alpam alpaṃ bhage patadbindum athordhvam āharet//\\!}
\end{versinnote}
...
Cf.\,\emph{Haṭhatattvakaumudī} 16.10 (\attr granthāntara)
\begin{versinnote}
...
The omission of 3.84ab in the \texteta\ group and \deltaThree\ is likely to be the result of haplography (\emph{bindu\teimute{\-}dhāraṇāt} is repeated).\lb
...
niṣevyate śītalamadhyadhārā HTK~] niṣevyate śītalamadhyadhārāṃ HRĀ, vihāya niḥsāratayāntya\teimute{\-}dhārāṃ HYS\sep
...
Now the Moving of the Goddess (\emph{śakticālanam}):
\end{translation}
%</tr93-2a>
...
\begin{variants}
suptā mokṣāya yoginām VM~] aṣṭadhā kuṃḍalīkṛtā VM\vl, aṣṭadhā kuṇḍalākṛtiḥ VM\vl, śubha\teimute{\-}mokṣā\teimute{\-}pradāyinī VM\vl, śubhā mokṣapradāyinī VM\vl, aṣṭadhā kuṭilīkṛtā VM\vl    
\end{variants}
...
[Just as] the coiled serpent Ananta (\emph{śeṣa\teimute{\-}kuṇḍalī}) is the foundation of the oceans, mountains and islands, so Kuṇḍalinī is the foundation of all systems of yoga.
\end{translation}
%</tr93-6>
...
%No known source. 
The referent of \emph{bālaraṇḍā tapasvinī} here is unclear. In some manuscripts this verse is followed by one (3.94*1) in which \emph{bālaraṇḍā} is identified as \emph{sarasvatī}, which in the context of \emph{śakticālana} could refer to the tongue. She could also be Kuṇḍalinī, who in 3.93*5 is located at the navel, which is said to be the location of Viṣṇu (e.g.~\emph{Dhyāna\teimute{\-}bindū\teimute{\-}paniṣat} 28–30). In his commentary on this verse in the \emph{Bodhasāra} (1906: 137), Divākara says that the seizing of Kuṇḍalinī itself is the highest state of Viṣṇu (\,... \emph{bālaraṇḍāṃ ... gṛhṇīyād vaśīkuryāt tat tasyā vaśīkaraṇam eva viṣṇor vyāpana\teimute{\-}lakṣa\teimute{\-}nasya paramā\teimute{\-}tmanaḥ paramaṃ kevalaṃ ... padaṃ svarūpaṃ jñeyam}).
...
Verse 3.94*1, which has no known source, simply identifies the technical terms in 3.94, namely, \emph{gaṅgā}, \emph{yamunā} and \emph{bālaraṇḍā} as \emph{iḍā, piṅgalā} and \emph{sarasvatī}. The verse appears to be missing in \alphaThree, and a different version of it occurs in \alphaTwo. The relevant folio is missing in \alphaOne. Nonetheless, the verse is absent in the most reliable manuscripts of the \textgamma, \textdelta, \textepsilon, and \textpi\ groups, and so it is likely that it came into the text as a marginal note early in the transmission. %
\end{philcomm}
%</cm94-1>
...
\tl{paridhānayukteti dvādaśāṅgulapramitasitasūkṣmacaturaṅgulavisṛtaśuddhavastrakhaṇḍena dṛḍhaṃ veṣṭatā sā prasiddhā phaṇāvatī suṣumṇātmakā arundhatī jihvaiva kuṇḍalinī// uktaṃ ca//\\+}
...
This verse was likely added to explain ‘by the method of the cloth’ (\emph{paridhānayuktyā}) in the previous verse. For information on sources and testimonia, see 3.32*5.

%One would expect to read \emph{caturaṅgulavistāram} in the second verse quarter, and the current reading is probably a result of the metre.
\end{philcomm}
%</cm95-2>
...
Sitting in \emph{vajrāsana}, the yogī should move Kuṇḍalinī and immediately afterwards perform \emph{bhastrī}. He quickly awakens Kuṇḍalinī.
\end{translation}
%</tr96>
...
[The yogi] should contract the sun and then move Kuṇḍalinī. Even if he were in the jaws of death, why would he fear death? 
\end{translation}
%</tr97>
...
\tl{mṛtyuvakragatasyāpi tasya mṛtyubhayaṃ kutaḥ//\\+} % [bha]yaṃ
\tl{asyārthaḥ sūryanāḍyākarṣaṇena vahneḥ prācuryaṃ tasmāj jvalanatejasā apānavāyvākarṣaṇena vā kuṇḍalyābodho bhavati/ tasya śakticālanakṛtābhyāsasya mṛtyubhayaṃ kuta iti//\\!} % daṇḍas added
\end{versinnote}
\end{testimonia}
%</ts97>
...
In \emph{Jyotsnā} 3.116, Brahmānanda understands \emph{bhānor ākuñcanaṃ} as a contraction of the navel. In contrast, Sundaradeva, in his \emph{Haṭha\teimute{\-}saṃketa\teimute{\-}candrikā} (see testimonia), interprets it as drawing \emph{prāṇa} through the sun channel (\emph{sūrya\teimute{\-}nāḍyā\teimute{\-}karṣaṇa}), thereby intensifying the bodily fire.
\end{philcomm}
%</cm97>
...
Verse 3.97*1 is absent in the \textalpha\ group. It is very close to a verse in the \textit{Amaraughaśāsana}, which is likely to be its source, although the date of the \textit{Amaraughaśāsana} is yet to be firmly established. This verse's import of rejuvenating the body by flooding it with nectar is not directly connected with those proceeding it. Its meaning is not clear in the published edtion of the \textit{Amaraugha\teimute{\-}śāsana} and we are not confident of the readings adopted in our edition nor the meaning of the verse.
...
After moving Kuṇḍalinī, the yogi should perform \emph{bhastrī} in particular. The god of death is afraid of the ascetic who regularly practises in this way.
\end{translation}
%</tr97-2>
%greyscaled
...
suṣumṇā kuṇḍalīgatā GŚ] suṣumnāṃ kuṇḍalīgatāṃ GŚ\vl, suṣumnā kuṇḍalīyutā GŚ\vl
\end{variants}
...
ākṛṣyate HRĀ~] ākṛṣya tau HRĀ\vl\sep
suṣumṇāṃ kuṇḍalī gatā HRĀ\vl~] suṣumṇāṃ kuṇḍalīgatām HRĀ, suṣumnā kuṇḍalīyutā YLĀ
\end{variants}
...
Without a king the earth is not resplendent, without the moon the night does not sparkle, and without Rājayoga the wonderful [practice of] \emph{mudrā} does not shine.%JM: get rid of the rājate-s? Or include all the rājayogas? I prefer getting rid. 
% JM: Also I think the api is not concessive and just = "and" (or if we do undestand it as concessive, then "without Rājayoga, the [practice of] mudrā, even though it is wonderful, does not succeed". And "shine" doesn't work; "succeed"? "reign supreme"?
\end{translation}
%</tr104>
...
The \emph{Yogaprakāśikā} (5.186) interprets the similes in this verse as we have translated them, ‘Just as without a king [and] moon, the earth and night do not shine...’ (\emph{yathā mahīpālaṃ candra\teimute{\-}masaṃ vinā pṛthvīniśe na rājete}...). However, in \emph{Jyotsnā} 3.126, Brahmānanda interprets the earth (\emph{pṛthvī}) as \emph{āsana} because both are connected by the quality of steadiness (\emph{sthairyaguṇa\teimute{\-}yogāt}), and the night (\emph{niśā}) as breath retention (\emph{kumbhaka}) because both are characterised by the absence of movement of people and wind (\emph{prāṇasañcārābhāvalakṣaṇaḥ}). Brahmānanda's interpretation seems somewhat far-fetched. 

The last line could also be understood in a non-yogic meaning: “Without a king a coin (or a seal) does not shine”, probably referring to coins onto which the head of the king were stamped. Strangely, this \emph{śleṣa} does not have any poetical function here. 
%Jürgen possible double meaning of the second half of the verse. done
\end{philcomm}
%</cm104>
...
Through yogis' steady practice by means of postures, breath retentions and \emph{mudrā}s, their central channels, even though untraversed, become straight.
%By means of postures, breath retentions and \emph{mudrā}s, the central channel, even though untraversed, becomes straight through yogis' firm practice.%JM: "Through yogis’ steady practice by means of postures, breath retentions and \emph{mudrā}s, their central channels, even though untraversed, become straight." JB: At the last meeting, we reorganised the translation and went with the singular. Jim, please take a look.  JM: ok (I tweaked it a bit), but why not the plural?
\end{translation}
%</tr106>
%
...
The reading of \emph{khilāpi} in the first verse quarter is unusual but well attested by the witnesses including the \textalpha\ group of manuscripts. In the \emph{Abhidhāna\teimute{\-}cintāmaṇi} (940), \emph{khila} is defined as something uncultivated such as field (\emph{kṣetrādyaprahataṃ khilam}) or, as the \emph{Amarapadavivṛti} (2.1.5) puts it, ‘not marked by a plough’ (\emph{lāṅgalena na likhitam iti khilam}). In the context of \emph{Haṭhapradīpikā} 3.106, qualifying \emph{suṣumṇā} with \emph{khila} implies that the central channel has yet to be cultivated (i.e.~traversed).
