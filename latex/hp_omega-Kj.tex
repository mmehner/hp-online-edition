...
\begin{ekdosis}
\begin{center}
\subsection*{\Large\texteng{\emph{Kālajñāna}, \emph{videhamukti}, and \emph{kālavañcana}*\\ (in chapter 4)}}
\end{center}
\teimute{%
\def\hindsection{Kj}
...
\begin{ava}[Kj01a]
atha kālajñānam/%
\teimute{\note[type=anmkg, labelb={kjloc},nonum,lem={*}]{These passages are found after X4.116 in \getsiglum{E4}. For their locations in \getsiglum{V3} and \getsiglum{J6} see the introduction p.\,\hpref{87}.}}
\end{ava}
...
\begin{tlg}[Kj05]
\tl{
\pada{dṛṣṭvā pretapiśācādī}%
\pada{n gandharvanagarāṇi ca/}\\+}
\tl{
\pada{suvarṇa%
...
\pada{\app{\lem[resp=emend]{kravyādo}
	...
	\app{\lem[resp=emend]{līnaḥ}
		\rdg[wit={E4,V3}]{līnaṃ}
		\rdg[wit={J6}]{\om}}\myfn{\getsiglum{J6} omits \emph{pāda} 8c. As a correction \textit{spṛśanti yaṃ prātar eva} is added in the bottom margin.}}
...
\pada{svapne \app{\lem[wit={E4},alt={so 'pi na jīvati}]{so'pi na jīvati}
		\rdg[wit={V3,J6}]{\om}
		}//\versenr}\\!}
\end{tlg}
\commcite\newpage
...
\pada{\app{\lem[wit={E4,V3}]{hasantaṃ}
	...
	\app{\lem[resp=emend]{nṛtyatatparam}
		\rdg[wit={E4,V3},postwit=\texteng{(\textapp{corrected to} nṛtyatī \textapp{in} \getsiglum{V3})}]{nṛtyatatparāṃ}
		\rdg[wit={J6}]{nṛtyati}
		%\rdg[wit={V3}]{nṛtyatī}
		}/}\\+}
\tl{
...
\tl{
\pada{jāyate \app{\lem[wit={J6}]{dantagharṣaś ca}% +N9
		\rdg[wit={E4,V3}]{dantasya gharṣaś}}}
\pada{\app{\lem[resp=emend]{sa gatāyur asaṃśayaḥ}% gatāyur vai nātra saṃśayaṃ N9
		\rdg[wit={E4,V3}]{ca gatāyur asaṃśayaḥ}%
...
\pada{divā \app{\lem[wit={J6}]{grahagaṇaṃ}
		\rdg[wit={E4ac}]{graharggaṇaṃ}
		\rdg[wit={E4pc,V3}]{grahaggaṇaṃ}
		} tathā/}\\+}
\tl{
\pada{dṛṣṭvā manyeta saṃkṣīṇa}%
\pada{m ātmajīvitam ātmavān//\versenr}\\!}
\end{tlg}
\commcite%\newpage
...
\tl{
\pada{tadā prājño vijānīyā}%
\pada{n mṛtyum ātmānam āgatam//\versenr}\\!}
\end{tlg}
\commcite%\newpage
...
\tl{
\pada{prayāti taṃ vijānīyā}%
\pada{t sadyo\app{\lem[resp=emend]{mṛtyuṃ nareśvara}
...
\pada{na śṛṇoty ātmasaṃbhavam/}\\+} % sṛṇoty E4
\tl{
\pada{na paśyec cakṣuṣor jyoti}%
\pada{r yaś ca so'pi na jīvati//\versenr}\\!}
\end{tlg}
\commcite%\newpage
...
\pada{na \app{\lem[wit={J6}]{cottiṣṭhati}
		...
		\rdg[wit={E4,V3,J6}]{svapnāt}
		}}%
\pada{t tad antaṃ tasya jīvitam//\versenr}\\!}
\end{tlg}
\commcite\newpage
...
\begin{tlg}[Kj35]
\tl{
\pada{yasyāpi hanyate dṛṣṭi}%
\pada{r bhūtai rātrāv atho divā/}\\+} % rātr<<ā>>v E4
\tl{
...
\pada{raktaṃ \app{\lem[resp=emend,alt={paśyaty athā°}]{paśyaty athā\skp{°}}
		\rdg[wit={E4}]{paśyet tathā}
...
\begin{tlg}[Kj41]
\tl{
\pada{uṣṇaṃ yasya śarīrārdha}%
\pada{m ardhaṃ cāpi ca śītalam/}\\+}
\tl{
...
\tl{
\pada{nyāsataḥ 
	\app{\lem[wit={E4,V3,J6pc},alt={sa pra°}]{sa pra\skp{°}}%
		\rdg[wit={J6ac}]{sapta}
		}sannātmā}
...
\begin{tlg}[Kj48]
\tl{
\pada{baddhapadmāsano dhīmā}%
\pada{n samasaṃsthānakandharaḥ/}\\+}
\tl{
...
\tl{
\pada{tatrātmānaṃ
	\app{\lem[resp=emend,alt={śaraṃ so 'pi}]{śaraṃ so'pi}
...
\begin{tlg}[Kj52]
\tl{
\pada{tataḥ paramam ākāśa}%
\pada{m atīndriyam agocaram/}\\+}
\tl{
...
\tl{
\pada{yuñjīta yogaṃ \app{\lem[resp=emend,alt={kālo 'sya}]{kālo'sya}
...
\pada{\app{\lem[wit={E4pc}]{śive}
		\rdg[wit={E4ac,V3}]{śivo}
		\rdg[wit={J6}]{śivāṃ}
		} līnāṃ vicintayet//\versenr}\\!} % J6 f.22v
\end{tlg}
\commcite\newpage
...
\pada{cidvṛttim api saṃtyajet//\versenr}\myfn{This verse has been omitted in the collated manuscripts but is found in \locsiglum{J15} of the \getsiglum{E4} group, the 10-chapter \emph{Haṭhapradīpikā} (10.26) and all of the reported testimonia.}\\!}
\end{tlg}
\commcite\newpage
...
\pada{tato\app{\lem[resp=emend,alt={'lakṣyam anābhāsam}]{'lakṣyam anābhāsa\skp{m}}
		...
		\rdg[wit={J6}]{lakṣyamano 'bhyāsam}}}%
\pada{m ahaṃbhāvavi\app{\lem[wit={E4,V3,J6pc}]{varjitam}
