...
\begin{ekdosis}
\begin{center}
\subsection*{\texteng{\emph{Kālajñāna}, \emph{videhamukti}, and \emph{kālavañcana}*\\ (in chapter 4)}}
\end{center}
\teimute{%
\def\hindsection{Kj}
...
\begin{ava}[Kj01a]
atha kālajñānam/%
\note[type=anmkg, labelb={kjloc},nonum,lem={*}]{These passages are found after X4.116 in \getsiglum{E4}. See Introduction p.\,\hpref{86} for their locations in \getsiglum{V3} and \getsiglum{J6}.}
\end{ava}
...
\tl{
\pada{nyāsataḥ \app{\lem[wit={E4,V3,J6pc},alt={sa pra°}]{sa pra\skp{°}}%
		\rdg[wit={J6ac}]{sapta}
		}}{sannātmā}
