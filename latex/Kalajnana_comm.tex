...
The man who cannot see the Milky Way, the pole star, Venus, the light of the moon, and Alcor will not live more than a year.
\end{translation}% just Alcor (Cf.~Venus)? JB: is the note below adequate? JM: my point is that it's inconsistent to translate śukra but not arundhatī
%</tr2>
...
Cf.~\emph{Viṣṇudharmottarapurāṇa} 519.2-5
\begin{versinnote}
\tl{na paśyati tu yo vyabhre prabhām arkaniśākṛtoḥ/\\+}
\tl{chāyāṃ candrārkayoś cāpi tayoś ca gamanaṃ tathā/\\+}
\tl{devamārgaprabhāṃ vahner dhruvaṃ tārām arundhatīm/\\+}
\tl{paśyaty adṛṣṭam anyair vā mṛtyuḥ syāt tasya vatsarāt//\\!}
\end{versinnote}
...
%<*cm2>
\begin{philcomm}[Kj02]
We are not certain of the meaning of \emph{devamārga} here.  \textsc{Monier-Williams} (s.v. 1899) says it means the sky but one would expect it to have a more specific astrological meaning in a list of stars and planets. It could be a synonym for \emph{devapatha}, which can mean the Milky Way according to one lexicographical source (\emph{Trikāṇḍaśeṣa} 1.1.97). The reference in the \emph{Viṣṇudharmottarapurāṇa} (see the Testimonia) suggests it is a celestial object that shines.\lb  
...
Arundhatī is mentioned in the \emph{Bṛhatsaṃhitā} (13.6) and is said to be close to Vasiṣṭha (\emph{tatra vasiṣṭhaṃ munivaram upāśritārundhatī sādhvī}). Vasiṣṭha and Arundhatī are the double star, Mizar and Alcor in the \emph{saptarṣi nakṣatra} (Ursa Major). See \textsc{Rao} 2019: 53.
...
When he sees a rayless disc of the sun and a fire with a halo, a man lives eleven months and not longer.% JM no longer than eleven months; or, better, no emendation and read °māsāṃs (which matches the other verses). JB: see the comments below (One would expect the ablative with ūrdhvaṃ) JM: but then plural would be usual, māsebhyo. It's a problem to which I don't see a good solution, so maybe conj. rather than em.
\end{translation}
%</tr3>
...
\begin{variants}
 māsāt tu~] māsebhyo MP, māsāṃś ca ŚP\sep
 sa ŚP~] tu MP
\end{variants}
...
[The life of the man] who emits urine and faeces as gold and silver, either in reality or in a dream, [will last] ten months.
\end{translation}
%</tr4>
    %JM will live for ten months (otherwise syntax doesn't work): JB: I have assumed that one has to supply tasya and the verb-to-be with jīvitaṃ daśamāsikam. Otherwise, we would have to emend to the MP's reading to justify your suggested translation. JM: ok then maybe change tr. to "[The life of the man] who... [will last] ten months."
    
%<*sc4>
\begin{sources}[Kj04]
\emph{Mārkaṇḍeyapurāṇa} 40.4, cf.~\emph{Śārṅgadharapaddhati} 4569
\begin{variants}
 vamen~] vānte MP, vāntyā ŚP\sep   
 purīṣaṃ ŚP~] purīṣe MP\sep
 suvarṇaṃ rajataṃ tathā MP~] suvarṇarajataṃ vamet ŚP\sep
 athavā ŚP~] kurute MP\sep
 jīvitaṃ ŚP~] jīvet sa MP
\end{variants}
...
\begin{variants}
    pārṣṇau~] pārṣṇyāṃ MP, pārṣṇyoḥ ŚP\sep
    tathā~] ca vā MP, 'thavā ŚP\sep
    kardamayor madhye MP~] kardamamadhye vā ŚP
\end{variants}
...
\begin{variants}
    kapotagṛdhrau~] gṛdhraḥ kapotaḥ MP, kapotagṛdhra ŚP\sep
    kākolo MP~] kākolā ŚP\sep
    vā khago MP~] vāparo ŚP
\end{variants}
...
\begin{variants}
    śreṇībhiḥ~] paṅktībhiḥ MP, ŚP\sep
    sva ŚP~] svāṃ MP\sep
    vānyathā~] anyathā MP, cānyathā ŚP\sep
    caturmāsān ŚP~] catuḥpañca MP
\end{variants}
...
\begin{variants}
    ...
    svacchāyāṃ vānyathā dṛṣṭvā caturmāsān sa jīvati~] śuṣyec ca vai yasya marma snānād vāmād adhas\teimute{\-}tanam YCM
\end{variants}
% \begin{versinnote}
...
\begin{variants}
    payasīndradhanur vāpi ŚP~] rātrāv indradhanuś cāpi MP\sep
    dvitrimāsikam~] hi trimāsikam MP, tridvimāsikam ŚP
\end{variants}
% \begin{versinnote}
...
The \emph{Mārkaṇḍeyapurāṇa} preserves the original idea of seeing a rainbow at night, which is as extraordinary as the first sign (i.e.~seeing lightning in a cloudless sky). %
...
\begin{variants}
    vānātmanas MP~] vāpy ātmanas ŚP\sep
    aśiraskāṃ ca~] aśiraskāṃ vā MP, aśiraḥskandhāṃ ŚP
\end{variants}
% \begin{versinnote}
...
\begin{variants}
    yasyāsthisadṛśo~] yasya bastasamo MP ŚP\sep
    tasyārdhamāsikaṃ MP~] tasya māsārdhakaṃ  ŚP\sep
    yogino nṛpa MP~] yoginaḥ kila ŚP
\end{variants}
...
\begin{variants}
    hṛtpādam MP~] hṛttoyam ŚP\sep
    avaśuṣyati ŚP~] avaśuṣyate MP
\end{variants}
...
%<*cm14>
\begin{philcomm}[Kj14]
It seems more likely that \emph{mārutaḥ} here refers to the breath rather than external wind, since it is difficult to conceive how wind could cut the vital points, which are located inside the body. In his commentary on \emph{Chāndogyopaniṣat} 6.8.6, Śaṅkara describes an internal process in which the breath cuts vital points as a person dies, with the breath merging into heat, which in turn merges into the highest deity (\emph{prāṇaś ca tadordhvocchvāsī svātmany upasaṃhṛta\teimute{\-}bāhya\teimute{\-}karaṇaḥ saṃvarga\teimute{\-}vidyāyāṃ darśanād dhastapādādīn vikṣipan marma\teimute{\-}sthānāni nikṛntann ivotsṛjan krameṇopa\teimute{\-}saṃhṛtas tejasi sampadyate} [...]). Similarly, the first half of a parallel verse in the \emph{Dharmaputrikā} (213) appears to be describing an internal process in which the breath is disturbed and then escapes from the vital points. %Nonetheless, whether one interprets \emph{mārutaḥ} as breath or wind, it remains difficult to understand how this relates to the person not delighting in the touch of water. 
% check note
...
\tl{yāti majjed dadhau paṅke gomaye vā na jīvati//\\!}
\end{versinnote}
...
\begin{variants}
    hasantaṃ nṛtyatatparam ŚP~] hasamānaṃ mahābalam MP\sep
    ekaṃ ŚP~] evaṃ MP\sep 
    saṃvīkṣya valgantaṃ MP~] vilakṣaṃ vibhrāntaṃ ŚP
\end{variants}
% \begin{versinnote}
...
%<*cm17>
\begin{philcomm}[Kj17]
Other printed versions of the \emph{Mārkaṇḍeyapurāṇa} read \emph{ekaṃ saṃvīkṣya}, e.g.~\emph{Mār\teimute{\-}kaṇḍe\teimute{\-}ya\teimute{\-}purāṇa} 43.17 (ed.~Vihārilāl Sarkar, Kalikātā-rājadhānyām, 1890)%ref looks odd.
...
Then he who sees oneself in a dream immersed in an ocean of mud up to the top of the head dies immediately. %MD: ā mastalatalād "up to the top of the head"?
\end{translation}
%</tr18>
...
If in a dream a man is struck by stones [thrown] by terrifying, monstrous and malevolent men with raised weapons, he dies immediately. 
\end{translation}
%</tr20>
...
\begin{variants}
    vikaṭai rūkṣaiḥ puruṣair~] vikaṭaiḥ kṛṣṇaiḥ puruṣair MP, puruṣaiḥ kṛṣṇair vikaṭair ŚP\sep
    mṛtyur bhaven naraḥ ŚP~] mṛtyuṃ labhen naraḥ MP
\end{variants}
...
\begin{variants}
    dīpādigandhaṃ no ŚP~] dīpagandhaṃ na yo MP\sep
    svapne 'py ahni~] trasyaty ahni MP, paśyaty agniṃ ŚP\sep
    na sa jīvati MP~] yaḥ mṛtyumān ŚP
\end{variants}
...
%<*sc24>
\begin{sources}[Kj24]
\emph{Mārkaṇḍeyapurāṇa} 40.24, cf.~\emph{Skandapurāṇa} 81cd–82ab
\begin{variants}
...
\begin{variants}
    vāpy asitā ŚP~] vā śyāmatāṃ MP\sep
    yadā MP~] bhavet ŚP\sep
    ātmānam āgatam~] āsannam ātmanaḥ MP, āsannam āgatam ŚP
\end{variants}
% \begin{versinnote}
...
% MD: read maṇi as one long syllable and adopt the reading of ηω vīkṣyate? Cf. praṇavo dhanuḥ śaro hy ātmā, brahma tallakṣyam ucyate
...
\begin{variants}
    yasyāpi ŚP~] yaś cābhi MP\sep
    dṛṣṭair ŚP~] duṣṭair MP\sep
    pumān ŚP~] naraḥ MP
\end{variants}
...
A reversal of men's true nature and an alteration to their constitution indicate Yama and Antaka are near to them. %MD: The subject may be viparītatva and viparyaya. JM: yes, works better (although verb should be dual).
\end{translation}
%</tr37>
...
\begin{variants}
    viparītatvaṃ~] vaiparītyaṃ tu MP, vaiparītyena ŚP\sep
    viparyayaḥ MP~] viparyaye ŚP
\end{variants}
...
For him who does not see his own reflection in a mirror or in water, death will undoubtedly occur at the end of a month.
\end{translation}
%</tr40>
...
\begin{variants}
    ca MP~] vā ŚP\sep
    'ntakāle~] tu kāle MP, ca kāle ŚP\sep
    vijñeyaṃ MP~] vicāryaṃ ŚP
\end{variants}
...
Now, the explanation of bodiless liberation:
\end{translation}%the teaching on bodiless liberation JM bodiless seems better to me
%</tr43a>
...
Whether in the morning, in the afternoon, at midday, at any time of day, or sometime at night, [the yogi] should pay attention to the omen.% observe? pay attention to?
\end{translation}
%</tr43>
...
\begin{variants}
    vā ŚP~] ca MP\sep
    vā dine kvacit~] vā pare kvacit ŚP, cāpi taddine MP
\end{variants}
...
%<*cm46>
\begin{philcomm}[Kj46]
The term \emph{tārakam brahma} (“salvific mantra”) is found in various Purāṇas and more recent Upa\teimute{\-}niṣads. On its meaning in Śaiva sources and its reinterpretion as the six-syllable Rāma mantra by Vaiṣṇava scholars, see \textsc{Bakker} 2019: 467–468.
...
\begin{variants}
    nirudhya prāṇāpānau ca~] niruddhaprāṇapavano ŚP\sep
    dantān asaṃpṛśan~] dantān na saṃspṛśet ŚP
\end{variants}
% \begin{versinnote}
...
\begin{versinnote}
\tl{praṇavo dhanuḥ śaro hy ātmā brahma tallakṣyam ucyate/\\+} 
...
% JB: well spotted. I've adopted the ŚP reading for pāda 4, and changed the translation.
...
\begin{variants}
    paramam ākāśam ŚP~] paramanirvāṇam MP\sep
    buddhyā ŚP~] buddher MP\sep
    naiva ŚP~] yan na MP\sep
    na ca vastu tat~] 'nantam aśnute ŚP, tat samaśnute MP
\end{variants}
...
The yogi should always carefully consider the omens so that, when [the time of death] is known, death does not kill him because of [the yogi's] deception.
\end{translation}
%</tr55>
% alternatively, ... consider the omens so that, when death is known, it does not kill him through deception. JM: this is better
%JM: surely it's the yogi's deception? If so this needs rephrasing: through [the yogi’s] deception, death does not... JB: I understood it as the yogi not being deceived by death (i.e., death unexpectedly taking him)... and so translated as above. JM: but kālavañcana, i.e. the cheating of death by the yogi, is a very common idea. How is death a deceiver? See also vv. 65 and 66 where the yogi is a deceiver and death is confused.
...
\begin{variants}
    ca kālaṃ~] kālaṃ ca ŚP MP\sep
    layasthānaṃ sam ŚP~] abhayasthānam MP\sep
    yogaṃ ŚP~] yogī MP\sep
    'sya yathāsau jāyate 'phalaḥ ŚP~] 'sau yathā nāsyāphalo bhavet MP
\end{variants}
% \begin{versinnote}
...
Having used pneumatic blows to raise from the base the serpentine power (i.e.~Kuṇḍalinī) situated below, Śiva’s consort who enters Suṣumṇā and pierces the five \emph{cakra}s,[\dots] 
\end{translation}
...
\begin{variants}
    hṛdyā~] hṛdā ŚP\sep
    buddhi~] buddhiṃ ŚP\sep
    sthe~] stha ŚP\sep
    vicintayet~] sudhāmaye ŚP
\end{variants}
% \begin{versinnote}
...
Thus, the yogi becomes perfected, having duly and with extraordinary valour cheated death, the creator of samsara.% samsara for transmigration? JM: I think so, samsara here is more than just transmigration: JB: I see samsāra is in the OED. Should we use it without diacritic marks?
\end{translation}
%</tr66>
...
That singular yogi wanders there in the three worlds, seeing the wonder of worldly life, as he pleases, without ego. 
\end{translation}% JM: maybe eka eva = unique? Hard to square with eka in the next verse otherwise. JB: singular? JM: ok. How about "That singular..."?
%</tr67>
...
%<*sc68>
\begin{sources}[Kj68]
\emph{Śārṅgadharapaddhati} 4613, cf.~\emph{Mārkaṇḍeyapurāṇa} 40.49
\begin{variants}
