...
% N3,(G4), P11,C6,V3, N23,J7, V19,K3(except Vajrolī),C7, P15(up to 13a),N19,V15,J11(3.49-66 only) V1,J10,Jyo
...
\pada{\app{\lem[wit={N3,GrB,Gr2,V15,Jyo}]{tadā}% +J17
		\rdg[wit={G4,Gr3a,P15,N19,V1,J10}]{tathā}}
...
rāja\app{\lem[wit={ceteri}]{pathāyate}% raja° C6
		\rdg[wit={V1}]{padāyate}}/}\\+}
\tl{
\pada{\app{\lem[wit={N3,GrB,J7,J10,Jyo}]{tadā}% +C6pc
		\rdg[wit={V19,C7,V1}]{tathā} % +C6ac; tathac V19
		\rdg[wit={K3}]{yathā}
		\rdg[wit={N23}]{yadā}}
	cittaṃ nirālambaṃ} % °lambhaṃ K3
\pada{\app{\lem[wit={N3,GrB,Gr2,J10,Jyo}]{tadā}
...
\tl{
\pada{\app{\lem[wit={N3,G4,GrB,P15,N19,V15,V1,J10,Jyo}]{śmaśānaṃ}
		\rdg[wit={V19}]{śmaśāne} % C8ac? °naṃ pc?
		\rdg[wit={J7,K3,C7}]{śmaśānī}% #
		\rdg[wit={N23}]{aiśānī}} śāmbhavī
	\app{\lem[wit={N3,G4,P11,Gr2,V19,C7,P15,V15,Jyo}]{madhya}
		\rdg[wit={C6,V3,V1,J10}]{madhyaṃ}
		\rdg[wit={N19}]{madhye}
		\rdg[wit={K3}]{mudrā}}}%
\pada{\app{\lem[wit={N3,GrB,Gr2,V19,P15,V15,Jyo}]{mārgaś cety eka} % māgraśceteka P15, māga° V15; catye°? V19,
...
\pada{brahma\app{\lem[wit={ceteri}]{dvāra}
	...
	\app{\lem[wit={ceteri}]{suptāṃ}
		\rdg[wit={G4}]{suptā}
		\rdg[wit={V3}]{supto}}}
\pada{mudrā\app{\lem[wit={N3,G4,P11,V3,P15,N19,V15,V1,J10,Jyo}]{bhyāsaṃ samācaret}% bhyāsa V3; samabhyaset J14
...
\pada{\app{\lem[wit={N23,K3,C7,J10}]{uḍḍiyānaṃ}
  ...
  mūla\app{\lem[wit={Gr2,K3,C7},alt={mūlabandho}]{bandho}% muḷa° V15 % ra-vipulā
		...
		\rdg[wit={P11,V3}]{°bandha}
		\rdg[wit={N19,V15,Jyo}]{°bandhaś ca}
		\rdg[wit={V1}]{°bandhāś ca}
		\rdg[wit={V19},alt={\om}]{\skp{\om}}}}
\pada{\app{\lem[wit={G4,J7,Gr3a,N19,V1,Jyo}]{bandho}% + 3 testimonies
		\rdg[wit={N23}]{bandhā}
		\rdg[wit={N3,GrB,P15,V15,J10}]{tato}} % ##
...
\begin{tlg}[hp03_007]
\tl{
\pada{\app{\lem[wit={ceteri}]{karaṇī}
	\rdg[wit={G4,P11}]{karaṇaṃ}}  % karanī N23
...
\begin{ava}[hp03_010]
	\app{\lem[wit={J5,P11,V1,J10}]{tatra mahāmudrā}% ##
		...
		\rdg[wit={N3,G4,J7,Gr3a},alt={\om}]{\skp{\om}}}/
\end{ava}
...
\pada{\app{\lem[wit={ceteri}]{pādaṃ}
	...
	\app{\lem[wit={J7,K3,C7,V15,V1,J10}]{dhṛtvā}
		\rdg[wit={N3,GrB,N23,V19,P15,N19,Jyo}]{kṛtvā}}}
\pada{karābhyāṃ
...
\pada{\app{\lem[wit={ceteri}]{yathā}
	...
	\app{\lem[wit={N3,G4,P11,V3,P15,V15,J10}]{daṇḍāhataḥ} % + J7pc; daṃḍohataḥ C8, °hata V3
		\rdg[wit={C6,Gr2,Gr3a,N19,V1,Jyo}]{daṇḍahataḥ}} sarpo}
\pada{\app{\lem[wit={ceteri}]{daṇḍākāraḥ} % kāraṃ J7ac, kāraḥ J7pc, kāra P11
...
\tl{
\pada{\app{\lem[wit={N3,GrB,Gr2,P15,N19,V1}]{tadāsau}
...
\pada{\app{\lem[wit={ceteri}]{jāyate}
	...
	\app{\lem[wit={N3,GrB,V19,K3,V1,J10,Jyo}]{dvipuṭā}
		\rdg[wit={N23}]{dvipūtā}
...
\pada{mahā\app{\lem[wit={ceteri}]{siddhaiḥ}% siddhai P11,V19
...
\pada{\app{\lem[wit={N3}]{hīyante}
		...
		\rdg[wit={G4,P11,C6,Gr2,V19,K3,V15,V1}]{jīryante}%## +SouthIndMss; jīryate K3, jīyaṃte V15
		\rdg[wit={N19}]{jāyante}}
		maraṇādayaḥ/}\\+} % °ādaya P11,V3,N19
\tl{
\pada{mahā\app{\lem[wit={GrB,V15,J10,Jyo}]{mudrāṃ}
		\rdg[wit={V1}]{mudrā[ś]}
		\rdg[wit={N3,G4,Gr2,N19}]{mudrā}
...
\pada{vadanti \app{\lem[wit={ceteri}]{vibudho}
		\rdg[wit={J7}]{vividho}
		\rdg[wit={V19,K3},alt={\om}]{\skp{\om}}}ttamāḥ//} \lineom{cd}{V19,K3}\\!}  %3.14  % ttamaḥ N3, ttamā P11,V3
\end{tlg}
...
\pada{\app{\lem[wit={ceteri}]{sūryāṅge}
	...
	\app{\lem[wit={N3,GrB,Gr2,J10,Jyo}]{punar abhyaset}
		\rdg[wit={V19,K3,N19,V15}]{tu samabhyaset}
		\rdg[wit={V1}]{°ṣu samabhyaset}}/}\\+}
\tl{
\pada{yāva\app{\lem[wit={N3,GrB,Gr2,N19,V1,Jyo},alt={tulyā}]{\skm{t }tulyā} % tulyāṃ V1?
		\rdg[wit={J10}]{saṃkhyā}
	...
	\app{\lem[wit={ceteri},alt={bhavet}]{bhave\skp{t}}
		...
		\rdg[wit={V15},alt={\om}]{\skp{\om}}}%
	\app{\lem[wit={N3,GrB,Gr2,V1,Jyo},alt={saṃkhyā}]{\skm{t }saṃkhyā}
		\rdg[wit={N19}]{saṃkṣā}
		\rdg[wit={J10}]{tulyā}
...
\pada{\app{\lem[wit={C6,V15,V1},alt={dakṣiṇāṅge sam°}]{dakṣiṇāṅge sama}
		...
		\myfn{\getsiglum{N3,J5,G4} have this hemistich after \ref{III23}.}\\!}
...
\begin{tlg}[hp03_023]
\tl{
\pada{\app{\lem[wit={ceteri},postwit={(\getsiglum{G4})}]{ayaṃ}
		\rdg[wit={J5}]{asaṃ}
		\rdg[wit={N3}]{amuṃ}}
...
\pada{\app{\lem[wit={ceteri}]{mahā}
		\rdg[wit={N23}]{sahā}
		\rdg[wit={J10}]{sarva}}siddhi% siddhiṃ ,p
	\app{\lem[wit={ceteri}]{pradāyakaḥ} % +J5,G4,N24; dā om. in V1, °yaka P11
...
\pada{\app{\lem[wit={ceteri},alt={ūrdhvaṃ}]{\skm{m }ūrdhvaṃ}
	...
	\app{\lem[wit={N3,P11,V3,V15,V1,J10}]{gativibodhakaḥ}% ḥ oṃ P11
...
\pada{\app{\lem[wit={J7,Gr3a,J10,Jyo}]{niṣphalau}
		\rdg[wit={P11,C6,N23}]{niṣphalo}% niḥphalo N23
		\rdg[wit={J5}]{niṣkalaḥ}
		\rdg[wit={N3}]{niṣkalā}
...
\begin{tlg}[hp03_026]
\tl{
\pada{\app{\lem[wit={N3,G4,N19,V15,V1,Jyo}]{mahābandha}
...
\pada{\app{\lem[wit={P11,J7,Gr3a,V15,Jyo}]{vāyūnāṃ}
		\rdg[wit={V1}]{vāyunāṃ}
		\rdg[wit={N3,J5,G4,C6,V3,N23,N19,J10}]{vāyunā}}
	\app{\lem[wit={ceteri},postwit=\texteng{(\getsiglum{G4})}]{gatim āvṛtya}
...
\pada{\app{\lem[wit={ceteri}]{samahasta}
	...
	\app{\lem[wit={P11,V3,N23,V19,J10,Jyo}]{yugo}% yuga J5
...
\pada{\app{\lem[wit={N3,P11,V3,J7,Gr3a,J10}]{sphijau}
	...
	\app{\lem[wit={ceteri},alt={saṃtāḍayec}]{saṃtāḍaye\skp{c}} % saṃtāḍanec N23; °yechanaiḥ J10
		...
		\rdg[wit={V15}]{nutāḍayec}}c chanaiḥ/}\\+} % P11,V3 om. ḥ; chūnaiḥ N19
\tl{
...
\pada{jāyate % jāyata? V15
	\app{\lem[wit={N3,G4,P11,Jyo}]{cāmṛtāya vai}
...
\pada{\app{\lem[wit={ceteri}]{mṛtāvasthā}
	...
	\app{\lem[wit={ceteri}]{samutpannā}
		...
		\rdg[wit={N23},alt={\om}]{\skp{\om}}}}
\pada{tato \app{\lem[wit={N3,GrB,J7,Gr3a,N19}]{mṛtyubhayaṃ kutaḥ}
...
\pada{\app{\lem[wit={ceteri}]{etat trayaṃ mahā}% °traya N23; V3,V19 etatrayaṃ; J10 sahā
	...
	\app{\lem[wit={N3,G4,GrB,Gr2,N19,V15,V1,Jyo}]{guhyaṃ}
		\rdg[wit={Gr3a}]{guptaṃ}
		\rdg[wit={J10}]{mudrā}}}
...
\pada{vahnivṛddhikaraṃ % buddhivṛddhi C6
	\app{\lem[wit={N3,C6,Gr2}]{caiva}
		\rdg[wit={P11,V3,N19,V15,J10}]{caivam}
...
\pada{\app{\lem[wit={ceteri}]{puṇya}
	...
	\app{\lem[wit={N3,J7,Gr3a,N19,Jyo}]{saṃbhāra}
		...
		\rdg[wit={G4}]{saṃcaya}
		\rdg[wit={N23},alt={\om}]{\skp{\om}}}%
	\app{\lem[wit={G4,V3,Gr2,N19}]{sambhāvi}
...
\pada{\app{\lem[wit={ceteri}]{pāpaugha}
	...
	\app{\lem[wit={ceteri}]{bhiduraṃ sadā}
...
\tl{
\pada{\app{\lem[wit={N3,J5,P11,C6,V15,V1,J10,Jyo},alt={sā yāvad}]{sā yāva\skp{d}}% ma+ P11; yāva N3, pāvad J10
	...
	\app{\lem[wit={ceteri},alt={bhrūmadhyaṃ}]{\skm{d }bhrūmadhyaṃ} % bhū N23, bhṛ N3
		...
		\rdg[wit={N26}]{spṛśati}}
	\app{\lem[wit={ceteri},postwit=\texteng{(\getsiglum{G4})}]{spṛśati}
...
\pada{\app{\lem[wit={V3,N9,J6}]{veṣṭitāmbara}
	\rdg[wit={N26}]{veṣṭitādhāra}}lakṣaṇam//} 
	\sgwit{Gr6} \anm{=\,\ref{vitasti}}\label{III33-5}\\!}
\end{alttlg}
...
\pada{bhruvo%r  % bhṛ° N3, bhrū° V3, bhrūvaur N23
	...
	\app{\lem[wit={ceteri},alt={dṛṣṭir}]{dṛṣṭi\skp{r}}
		\rdg[wit={N3,P11,N23,V15}]{dṛṣṭi}}r}
...
\tl{
\pada{\graus{rasanām ūrdhvagāṃ kṛtvā}}\myfn{The Pādas in grey scale are not found in \getsiglum{Gr2,V1,J10}, but in \getsiglum{GrB,Gr3a,N19,V15,Jyo}.
\getsiglum{N3} omits the whole verse. \getsiglum{J5,G4} have this verse without the grey-scaled part.}
\pada{kṣaṇārdhaṃ % ṃ om. P11
...
\pada{\app{\lem[wit={ceteri}]{yo mudrāṃ vetti}
	...
	\app{\lem[wit={G4,J7,V19,K3,N19,V15,V1,J10,Jyo}]{khecarīm}
		\rdg[wit={N3,GrB,N23,C7}]{khecarī}}//}\myfn{In \getsiglum{J7} this verse is found after \ref{III38}.}\\!}  %3.36
\end{tlg}
...
\pada{\app{\lem[wit={N3,GrB,J10,Jyo}]{yo mudrāṃ vetti}% mudrā N3
		\rdg[wit={V1}]{yasya mudrāsti}}
	\app{\lem[wit={N3,J10,Jyo}]{khecarīm}
		\rdg[wit={GrB,V1}]{khecarī}}//}
	\NotIn{Gr2,Gr3,N19,V15}\\!}
%	\sgwit{N3,J5,G4,GrB,V1,J10,Jyo}\\!}  %3.37
\end{tlg}
...
\pada{\app{\lem[wit={ceteri}]{cittaṃ}
		\rdg[wit={V19}]{citte}
		\rdg[wit={N3}]{ci\,+}}
	\app{\lem[wit={ceteri}]{carati khe} % kṣe P11
		\rdg[wit={N3},alt={\damaged}]{\skp{\damaged}}}
	\app{\lem[wit={ceteri},alt={yasmāj}]{yasmā\skp{j}}
		\rdg[wit={V3}]{yasyā}
		\rdg[wit={N3}]{+\,.āj}}j}
\pada{jihvā carati % jihva J8; jihvā jihva V19; calati N3
...
\pada{\app{\lem[wit={N3,P11,V15,Jyo}]{mudrā}
		...
		\rdg[wit={G4},alt={\damaged}]{\skp{\damaged}}}
	\app{\lem[wit={ceteri}]{siddhair namaskṛtā}
	\rdg[wit={G4}]{siddhir nigadyate}}//}\label{III38} \NotIn{N23}
	\anm{=\,\manuref{4.8*10}}\\!}  %3.38  % siddhai V19, siddhir C8ac
\end{tlg}
...
\pada{\app{\lem[wit={ceteri}]{khecaryā}
	...
	\rdg[wit={G4,C6}]{mudritā}} yena} % ye tu C6
\pada{\app{\lem[wit={ceteri}]{vivaraṃ}
		\rdg[wit={K3}]{viviraṃ}
		\rdg[wit={P11,C6,V1}]{vicaran/raṃ}}
	\app{\lem[wit={ceteri},postwit=\texteng{(\getsiglum{G4})}]{lambikordhvataḥ}
		\rdg[wit={K3,C7}]{lampikordhvataḥ}
		\rdg[wit={N3},alt={\damaged}]{\skp{\damaged}}}/}\\+}
\tl{
\pada{\app{\lem[wit={G4,GrB,N23,N19,V15,V1,J10}]{tasya na}% naḥ V15
		\rdg[wit={N3}]{+\,[s]ya na}
...
\pada{\app{\lem[wit={ceteri}]{calito}
		...
		\rdg[wit={V19}]{calate}
		\rdg[wit={N3}]{calato}
		\rdg[wit={C6}]{patito}}'pi yadā binduḥ} % bindu P11,K3, biṃḥ N19
...
\pada{\app{\lem[wit={ceteri},alt={vrajaty}]{vraja\skp{ty}}
	...
	\app{\lem[resp=emend,postwit=\texteng{(cf.\,VM)}]{hataḥ śaktyā}
		...
		\rdg[wit={N3,G4},alt={\damaged}]{\skp{\damaged}}}}\marmas
\pada{\app{\lem[wit={J5,G4,P11,C6,N19,V15,Jyo}]{nibaddho}
		...
		\rdg[wit={N3},alt={\damaged}]{\skp{\damaged}}}
	\app{\lem[wit={N3,G4,C6,Gr2,Gr3a,N19,V15,V1,Jyo}]{yoni}
...
\pada{\app{\lem[wit={G4,V3,V15}]{kalā}
		\rdg[wit={Gr2,N19}]{kāla}
		\rdg[wit={N3}]{kālā}
		\rdg[wit={P11,C6}]{kṛtvā}}%
	\app{\lem[wit={N3,G4,GrB,V15}]{saṃdhāna}
		\rdg[wit={N19}]{saṃdhāra}
		\rdg[wit={Gr2}]{saṃhāra}}%
	\app{\lem[wit={N3,G4,P11,C6,Gr2,N19,V15}]{mudrayā}
		\rdg[wit={V3}]{varjitā}}/} % varjitāḥ
%		\NotIn{Gr3a,V1,J10,Jyo}
		\sgwit{N3,G4,C6,V3,Gr2,N19,V15}\label{III40_1}\\!}
\end{alttlg}
\endaltnormal
...
\pada{\app{\lem[wit={ceteri}]{ūrdhva}
		\rdg[wit={G4,N19}]{ūrdhvaṃ}}%
	\app{\lem[wit={J7,V19,C7,Jyo}]{jihvaḥ}
		\rdg[wit={N23}]{jihva}
		\rdg[wit={N3,GrB,K3,N19,V15,V1,J10}]{jihvā}}
...
\pada{\app{\lem[wit={V3,V19,K3,V15,Jyo},alt={tailavartiṃ}]{\skm{s }tailavartiṃ}
		\rdg[wit={N3,P11,C7,N19}]{tailavarti}% tela P11; vartti P11,N19
...
\pada{\app{\lem[wit={ceteri}]{dehī dehaṃ}% dehāṃ V3
		...
		\rdg[wit={N3},alt={\damaged}]{\skp{\damaged}}}
	\app{\lem[wit={P11,Gr2,Gr3a,N19,V1,Jyo}]{na muñcati}
...
\pada{\app{\lem[wit={N3,G4,C6,V3,J10,Jyo}]{itare}
	...
	\app{\lem[wit={ceteri}]{kulaghātakāḥ} % °kā P11
...
\pada{\app{\lem[wit={J7,K3,N19,Jyo}]{vahninotpāditaḥ}% =P17
	...
	\app{\lem[wit={J5,G4,Gr2,Gr3a,N19,Jyo}]{khalu}% =P17;Gr1*
...
%		N26 vahnino[kṣ]āpitodarāt*, N9 vahni[natpi or: nāpi]tādaraṃ
		...
		\rdg[wit={N3},alt={\damaged}]{\skp{\damaged}}}/}\\+}
\tl{
\pada{\app{\lem[wit={G4,C6,V3,Gr2,K3,N19,J10,Jyo}]{candrāt sravati} % śravati N19, snavati? J10
...
\pada{\app{\lem[wit={ceteri},alt={ūrdhvāsyo}]{\skm{d }ūrdhvāsyo} % J8 °smo?
	...
	\app{\lem[wit={ceteri}]{rasanāṃ}
		\rdg[wit={N19}]{rasanā}
		\rdg[wit={N23}]{ramanā}}
	\app{\lem[wit={N3,P11,C6,J7,Gr3a,V15,Jyo}]{niyamya}
...
\pada{\app{\lem[wit={N3,GrB,C7,N19,V15,V1,Jyo}]{utkallola}
	...
	\app{\lem[wit={ceteri}]{dhārāmṛtaṃ}
		\rdg[wit={Jyo}]{dhārāmayaṃ}}\marmas yaḥ pibet}\\+}
\tl{
\pada{\app{\lem[wit={ceteri}]{nirdoṣaḥ sa}
		\rdg[wit={P11,V1}]{nirdoṣaṃ sa}
...
\pada{\app{\lem[wit={ceteri}]{cumbantī}% °ti P11
		\rdg[wit={N23}]{vipitīṃ}}
	yadi \app{\lem[wit={ceteri}]{lambikāgram}
		\rdg[wit={P11}]{laṃbakārgram}
		\rdg[wit={K3,C7}]{lampikāgram}}
		aniśaṃ jihvā
...
\pada{vyādhīnāṃ haraṇaṃ % vyādhināṃ V1
	...
	\app{\lem[wit={N3,J5,Jyo}]{śāstrāgamodīraṇaṃ}% śastrārthagamodīraṇaṃ J5
...
\begin{tlg}[hp03_049]
\tl{
\pada{\app{\lem[wit={ceteri}]{ekaṃ}% ekāṃ P11
	\rdg[wit={C7}]{eka}
	\rdg[wit={N23}]{evaṃ}}
...
\tl{
\pada{eko
	\app{\lem[wit={ceteri},postwit=\texteng{(\getsiglum{G4})}]{devo}% +J5
		\rdg[wit={N23}]{devā}
		\rdg[wit={N3}]{nirā°}}
...
\pada{\app{\lem[wit={ceteri}]{candrāt sāraḥ}
	...
	\app{\lem[wit={ceteri},alt={sravati/śravati}]{sravati} % śravati N19,V15,J5
		\rdg[wit={P11}]{grasati}
		\rdg[wit={N23}]{rapati}
		\rdg[wit={V1}]{[sra]vaṃtyai}}\myfn{\getsiglum{V15} jumps to Jālandharabandha (\ref{III67}) from here. For the lost part (\ref{III50}--\ref{III66}) \getsiglum{J11} is used instead.} % one illegible akṣara before
...
%\newpage
\begin{ava}[hp03_050]
\app{\lem[wit={N3,G4,GrB,N19,V1,J10,Jyo}]{atha mūlabandhaḥ} % bandha V3,N19
\rdg[wit={J7,Gr3a}]{mūlabandhaḥ}
\rdg[wit={C7}]{atha mūle bandhaḥ}
\rdg[wit={N23,J11},alt={\om}]{\skp{\om}}}%
	\myfn{After this header the description of Uḍḍiyāna is found in \getsiglum{G4}, followed by the description of Mūlabandha. \getsiglum{V3,Jyo} have the Mūlabandha section (including its header) after the Uḍḍiyāna as in the order of mudrās mentioned in \manuref{3.6}.}//
\end{ava}
...
\app{\lem[wit={N3,P11,C6,Gr2,N19,J11,J10},alt={apānaṃ vai}]{\skm{m }apānaṃ vai}
...
\app{\lem[wit={ceteri}]{taṃ}% +C7
	...
	\rdg[wit={K3}]{te}
	\rdg[wit={C6}]{tu}}
\app{\lem[wit={ceteri},alt={prāhur}]{prāhu\skp{r}}% prāhu P11,V3,V1,J10; +J11 s.l.
...
\pada{\app{\lem[wit={ceteri}]{gudaṃ}
	\rdg[wit={N19}]{gulpha}
	\rdg[wit={C6}]{pārṣṇi°}}
\app{\lem[wit={N3,P11,V3,Gr3a,J10,Jyo}]{pārṣṇyā tu} % prob. V19, pāṣṇyā V3; nu P11
	...
	\rdg[wit={C6}]{āpīḍya}}}
\pada{\app{\lem[wit={N3,G4,C6,V3,Gr2,V1,J10,Jyo},alt={vāyum ā°}]{vāyum ā\skp{°}} % +J11 s.l.; read pāyum?
...
\tl{
\pada{apānaprāṇa%
\app{\lem[wit={ceteri},alt={°yor aikyaṃ}]{\skp{°}yor aikyaṃ} % +C7; °tor G4
...
\pada{\app{\lem[wit={P11,C6,Gr2,Gr3a,N19}]{saṃprāpte}% = GŚ keep
	\rdg[wit={P11}]{saṃprāptau}
	\rdg[wit={V3}]{saṃyāte}
	\rdg[wit={N3,J5,J11,V1,J10,Jyo}]{prayāte}} % damaged G4 ##
\app{\lem[wit={N3,P11,V3,Jyo}]{vahnimaṇḍalaṃ}
...
\pada{\app{\lem[wit={N3,P11,V3,Gr2,N19}]{vardhate vāyunāhatā}
...
\pada{\app{\lem[wit={G4,P11,C6,N19,J11,Jyo}]{prāṇam uṣṇa}% praṇam P11
...
\pada{\app{\lem[wit={ceteri}]{jvalano dehajas tathā} % jvalanā N23
	\rdg[wit={P11}]{jvalano dehajas tadā}
...
\pada{\app{\lem[wit={N3,GrB,Gr2,J11,V1,J10,Jyo}]{saṃtaptā} % 	sataptā P11; sa pra° V3
...
\tl{
\pada{daṇḍāhatā bhujaṅgīva} % hatya N23; °hatabhujaṃgevā G4
...
\tl{
\pada{bilaṃ
\app{\lem[wit={N3,G4,Gr2,V19,N19,J11,V1,Jyo}]{praviṣṭeva}
	\rdg[wit={P11,C6}]{praviṣṭe ca}
...
\app{\lem[wit={ceteri}]{\skm{n }nityaṃ}
	\rdg[wit={N19}]{nityo}} mūlabandhaḥ} % ḥ om. P11
\pada{kartavyo yogibhiḥ sadā//}\\!}
\end{tlg}

%\newpage
\begin{ava}[hp03_059]
\app{\lem[resp=emend]{athoḍḍiyānam}
...
\pada{a\app{\lem[wit={C6,V3,Gr3a,N19,V1,J10,Jyo},alt={aviśrāntaṃ}]{\skp{a}viśrāntaṃ}
	\rdg[wit={N3,J5,P11}]{aviśrānta}
	\rdg[wit={J7,J11}]{aviśrānto}
	\rdg[wit={N23}]{aviśrāntā}
	\rdg[wit={G4}]{khaviśrāṃtā}} mahākhagaḥ/}\\+} % khaga V3
\tl{
...
\pada{\app{\lem[wit={N3,GrB,Gr2,N19,J11,V1,Jyo},alt={tatra}]{\skm{t }tatra}
	\rdg[wit={J10}]{kṣetra}
...
\app{\lem[wit={N3,G4,P11,C6,Gr2,N19,J11,V1,J10,Jyo},alt={asau}]{\skm{hy }asau}
	\rdg[wit={C7}]{asam}
	\rdg[wit={V19,K3}]{ayaṃ}
...
\pada{\app{\lem[wit={C6,Gr2,Gr3a,J11,J10,Jyo}]{tānaṃ}
	\rdg[wit={G4,P11,V3,N19,V1}]{tāṇaṃ}
%	\rdg[wit={J5}]{tāruṇaṃ}
	\rdg[wit={N3}]{tāpyaṃ}}
	kuryā%t
...
\tl{
\pada{\app{\lem[wit={ceteri},alt={ṣaṇmāsam}]{ṣaṇmāsa\skp{m}}% māsām G4
	\rdg[wit={V1,J10}]{yogī sam°}}%
\app{\lem[wit={N3,P11,Gr2,J10},alt={abhyasan}]{\skm{m }abhyasa\skp{n}} %
	\rdg[wit={G4,V3,K3,C7,N19,J11,V1,Jyo}]{abhyasen}% J5??
...
\pada{\app{\lem[wit={ceteri}]{kandaṃ}
	...
	\rdg[wit={P11}]{kaṃṭhaṃ}
	\rdg[wit={C7}]{skandaṃ}}
\app{\lem[wit={G4,P11,C6,Gr2,Gr3a,N19,J11,Jyo}]{tatra}
	\rdg[wit={V3,J10}]{tacca}
	\rdg[wit={N3}]{tava}
	\rdg[wit={V1}]{tasya}}
\app{\lem[wit={G4,P11,C6,Gr2,Gr3a,N19,J11,Jyo}]{prapīḍayet}
...
\pada{\app{\lem[wit={ceteri},alt={paścimaṃ tānam}]{paścimaṃ tāna\skp{m}}% +J5
	\rdg[wit={G4,P11,V1}]{paścimaṃ tāṇam}
	\rdg[wit={N3,V3}]{paścimatāṇam}}%
\app{\lem[wit={N3,G4,GrB,J7,Gr3a,J11},alt={udare}]{\skm{m }udare}
	\rdg[wit={N23}]{udara}
	\rdg[wit={N19}]{udaraṃ}
	\rdg[wit={V1,J10}]{upari}}}
\pada{\app{\lem[wit={ceteri},alt={kārayed}]{kāraye\skp{d}}
	\rdg[wit={J10}]{pīḍayed}}%
\app{\lem[wit={N3,G4,GrB,J7,J11,V1,J10},alt={dhṛdaye gale}]{\skm{d }dhṛdaye gale} % kāraye hṛdaye V3, kārayed-hṛ°? V1
...
\pada{śanaiḥ \app{\lem[wit={ceteri}]{śanair yathā} % J11 s.l.
	...
	\rdg[wit={N23},alt={\om}]{\skp{\om}}}
\app{\lem[wit={N3,P11,V3,Gr3a,V1},alt={prāṇas}]{prāṇa\skp{s}}
...
\app{\lem[wit={N3,P11,Gr2,V19,C7,J11,V1}]{saṃdhiṃ} % +C7
	...
	\rdg[wit={K3}]{siṃddhiṃ}
	\rdg[wit={C6}]{siddhiṃ}}
\app{\lem[wit={N3,GrB,Gr2,N19,J11,V1}]{na}
	\rdg[wit={Gr3a}]{ca}
...
\app{\lem[resp=emend]{atha jālandharaḥ}
	...
	\rdg[wit={C6,C7,J11,V1,J10,Jyo}]{atha jālandharabandhaḥ}
...
\pada{sthāpaye%c% °ye Gr3a,N3,G4,V3,J10, °yet* N19, °yed V15
\app{\lem[wit={C6,J7,Jyo},alt={cibukaṃ dṛḍham}]{\skm{c }cibukaṃ dṛḍham}
	\rdg[wit={G4,P11,V3,Gr3a,V1,J10}]{dṛḍham icchayā}% +M1,J5 ##
...
\app{\lem[wit={C6,J7,V19,J10,Jyo},post=\texteng{(sirā \getsiglum{Jyo})}]{śirā}
	\rdg[wit={P11,V3,N23,K3,C7,N19,V15,V1}]{śiro}
	\rdg[wit={N3}]{śilā}}%
\app{\lem[wit={ceteri},alt={jālam}]{jāla\skp{m}}
	\rdg[wit={V3}]{jālāṃ}}}%
\pada{\app{\lem[wit={N3,P11,C6,J7,Gr3a,N19,V15,J10,Jyo},alt={adhogāmi}]{\skm{m }adhogāmi}
	\rdg[wit={N23}]{adhogāmī}
	\rdg[wit={V3}]{madhyegāmi}
	\rdg[wit={V1}]{nādhāyāti}}nabhojalam/}\\+}
\tl{
\pada{tato jālandharo bandhaḥ} % jālāṃ° N3; °dharā V15; baṃdha P11,V3, baṃdho C6
\pada{\app{\lem[wit={N3,GrB,J7,N19,V15,Jyo}]{kaṇṭha}
	\rdg[wit={N23,Gr3a,V1,J10}]{kaṇṭhe}}%
	duḥkhaughanāśanaḥ//}\\!} % nāśanaṃ V3
\end{tlg}
...
\pada{kaṇṭhasaṃkocalakṣaṇe/}\\+} % kaṃṭhaṃ P11; lakṣaṇaṃ G4
\tl{
\pada{na pīyūṣaṃ
\app{\lem[wit={ceteri},alt={pataty}]{pata\skp{ty}}
	\rdg[wit={V19}]{prayāty}
	\rdg[wit={N23}]{kṣaraty}}ty agnau}
\pada{na ca vāyuḥ % vāyu P11
\app{\lem[wit={N3,GrB,Gr2,N19,V15,J10}]{pradhāvati}
...
\pada{\app{\lem[wit={N3,J7,Gr3a,V15,J10,Jyo}]{dve nāḍyau}% ddhe J7ac, ddhau J7pc
...
\app{\lem[wit={N3,P11,C6,V15,V1,J10,Jyo},alt={stambhayed}]{stambhaye\skp{d}}% °bhaye N3,J10, °bhayod P11
...
\app{\lem[wit={N3,J5,V1,J10,Jyo},alt={dṛḍhaṃ}]{\skm{d }dṛḍhaṃ}
	...
	\rdg[wit={V3},alt={\gap}]{\skp{\gap}}}/}\\+}
\tl{
\pada{\app{\lem[wit={N3,P11,C6,J7,Gr3a,N19,V15,Jyo},alt={madhyacakram}]{madhyacakra\skp{m}}
...
\getsiglum{Gr3a} does not have it at all.} \anm{=\,\manuref{2.46}}\\!}
\end{alttlg}
\endaltrecension
...
\app{\lem[wit={ceteri}]{baddhvā}
	...
	\rdg[wit={J10},alt={\om}]{\skp{\om}}}}
\pada{vāhaye%t
\app{\lem[wit={G4,C6,Gr2,Gr3a,N19,V1},alt={paścimaṃ}]{\skm{t }paścimaṃ}
...
\newpage
\begin{ava}[hp03_074]
\app{\lem[wit={N3,GrB,N23,C7,N19,V15,V1,J10}]{atha}
...
\pada{\app{\lem[wit={GrB,J7,Gr3a,N19,Jyo}]{na tu}
	\rdg[wit={N23}]{rttu}
	\rdg[wit={N3,V15,V1,J10},alt={\om}]{\skp{\om}}}
śāstrārthakoṭibhiḥ//} \anm{=\,\manuref{4.8*6}} 
	\NotIn{N3,V15,V1,J10}\\!}
\end{alttlg}
\endaltrecension
...
\pada{\app{\lem[wit={ceteri},alt={ūrdhvaṃ nābhir}]{ūrdhvaṃ nābhi\skp{r}}
	...
	\rdg[wit={G4}]{+\,+\,nābher}}%
\app{\lem[wit={G4,GrB,V19,N19,V15,J10},alt={adhas tālur}]{\skm{r }adhas tālu\skp{r}}% adhaḥstālur V19, °tālūr G4,V15
...
\pada{\app{\lem[wit={N3,Gr2,C7,V1,Jyo}]{karaṇī viparītākhyā}% +C7
	\rdg[wit={G4,V3,V15}]{karaṇaṃ viparītākhyaṃ}% karaṇī °kṣaṃ J5
	\rdg[wit={P11,C6,V19,K3,N19,J10},alt={\om}]{\skp{\om}}}}
\pada{guruvākyena
\app{\lem[wit={N3,V3,N23,V15,V1,Jyo}]{labhyate}
	\rdg[wit={G4}]{lakṣayet}
	\rdg[wit={J7,C7}]{gamyate}
	\rdg[wit={P11,C6,V19,K3,N19,J10},alt={\om}]{\skp{\om}}}//} \lineom{cd}{P11,C6,V19,K3,N19,J10}\\!}
\end{tlg}
...
\pada{jaṭharāgni\app{\lem[wit={N3,P11,J7,N19,V15,V1}]{vivardhanī}
...
\tl{
\pada{\app{\lem[wit={N3,G4,GrB,V1,J10,Jyo}]{alpāhāro}
...
\app{\lem[wit={N3,V3,Gr2,Gr3a,N19,V1},alt={dahet}]{dahe\skp{t}} % dahe V3,N19
	\rdg[wit={G4,P11,V15}]{haret}
	\rdg[wit={C6}]{bhavet}
	\rdg[wit={Jyo}]{°ti tat}
	\rdg[wit={J10}]{vaśe}}%
\app{\lem[wit={ceteri},postwit=\texteng{(\getsiglum{J5,G4})},alt={kṣaṇāt}]{\skm{t }kṣaṇāt}
...
\app{\lem[wit={N3,G4,P11,C6,Gr2,Gr3a,V15,Jyo}]{pādaḥ}
	\rdg[wit={V3,N19}]{pāda}
...
\app{\lem[wit={N3,GrB,V15,V1,J10,Jyo}]{dṛśyate}% +M1,G5,6
...
\pada{\app{\lem[wit={N3,GrB,N23,V19,C7,N19,V15,Jyo},alt={ūrdhvākuñcanam}]{\skm{g }ūrdhvākuñcana\skp{m}} % ā cancelled in N4?
...
\pada{\app{\lem[wit={N3,GrB,N23,C7,N19,V15,J10,Jyo}]{vajrolī} % °li V15
...
\pada{\app{\lem[wit={N3,P11,V3,V19,N19,V15,Jyo}]{yatnataḥ} % yantrataḥ C7
	...
	\app{\lem[wit={N3,GrB,V19,C7}]{śaranālena}% sara° C6
...
\pada{\app{\lem[wit={P11,C6,Gr2,V19,C7,N19,V15}]{nāryā}
	...
	\app{\lem[wit={ceteri},alt={patad}]{pata\skp{d}} % patat V1
		\rdg[wit={J7}]{pated}
		\rdg[wit={N19}]{ca tad}}%
	\app{\lem[wit={N3,P11,C6,Gr2,V19,C7,N19,V15,Jyo},alt={bindum}]{\skm{d}bindu\skp{m}} % biṃduṃm N19
		\rdg[wit={V3}]{bindhuḥm}
...
\pada{\app{\lem[wit={ceteri}]{calitaṃ}
	...
	\app{\lem[wit={N3,J5}]{ca svakaṃ}% ca svayaṃ C2
		\rdg[wit={G4,P11,C6,Gr2,N19}]{tu svakaṃ}
		\rdg[wit={V3}]{tu sukaṃ}
		\rdg[wit={V15,Jyo}]{ca nijaṃ}
		\rdg[wit={V1}]{patitaṃ}
		\rdg[wit={J10}]{calitaṃ}
		\rdg[wit={V19,C7},alt={\om}]{\skp{\om}}} bindu}%m
\pada{\app{\lem[wit={ceteri},postwit=\texteng{(\getsiglum{G4})},alt={ūrdhvam ākṛṣya rakṣayet}]{\skm{m }ūrdhvam ākṛṣya rakṣayet}
...
\tl{
\pada{evaṃ
	\app{\lem[wit={J5,G4,GrB,Gr2,N19},alt={tu rakṣayed}]{tu rakṣaye\skm{d}}
		\rdg[wit={V19,C7,Jyo}]{saṃrakṣayed}
		\rdg[wit={V15}]{surakṣayed}
		\rdg[wit={V1,J10}]{rakṣati yo}}d
		binduṃ} % biṃdu G4,P11,V3,N4
...
\pada{\app{\lem[wit={J5,V3,C7,N19,V15,V1,J10}]{jīvitaṃ} % +N24
		\rdg[wit={P11}]{jīvituṃ}
...
\pada{\app{\lem[wit={J5,GrB,Gr2,V19,V15}]{sugandhi}% yugaṃndhi N23
	...
	\app{\lem[wit={J5,P11,V3}]{dehaṃ} % G4 illeg.
		...
		\rdg[wit={C7,V1,J10},alt={\om}]{\skp{\om}}}}
\pada{jāyate bindu\app{\lem[wit={P11,V3,N23,J7,V19,N19,Jyo}]{dhāraṇāt}
...
\pada{yāva\app{\lem[wit={N23,C7,J10,Jyo},alt={binduḥ}]{\skm{d }binduḥ}
		\rdg[wit={G4,GrB,J7,V19,N19,V15,V1}]{bindu}}
...
\begin{tlg}[hp03_087]
\tl{
\pada{\app{\lem[wit={GrB,Gr2,N19,V15,Jyo}]{ṛtumatyā} % rutu° N23,V3
		\rdg[wit={V19,C7,V1,J10}]{bindumadhye}}
	\app{rajo\lem[wit={C6,Gr2,V19,C7,N19,V15,V1,Jyo}]{'py evaṃ} % +J10pc; nijo P11
		\rdg[wit={V3}]{thevaṃ}
		\rdg[wit={J10}]{py eva}
		\rdg[wit={P11}]{strījaṃ}}}
...
\begin{tlg}[hp03_088]
\tl{
\pada{\app{\lem[wit={J5,C6,V19,C7,V1,J10}]{sahajolī}
...
\pada{mukta%
	...
	\app{\lem[wit={GrB,V19,C7,N19,V15,V1,J10}]{kṣaṇam}
...
\pada{\app{\lem[wit={P11,V3,J7,V15,J10}]{bhoge}
	...
	\NotIn{Gr1r,N23} \anm{cf. \ref{III101}cd}}\\!}  % M1 omits too, but M3 has it.
\end{alttlg}
\endaltnormal
...
\begin{tlg}[hp03_091]
\tl{
\pada{\app{\lem[wit={G4,P11,V3,V19,C7,V15,V1,Jyo},alt={pittolbaṇatvāt}]{pittolbaṇatvā\skp{t}} % °lvana° V19
	...
	\app{\lem[wit={C7,V1,Jyo},alt={prathamāmbu}]{\skm{t }prathamāmbu}
		\rdg[wit={P11,C6,N19,V15,J10}]{prathamāṃ ca}
...
\tl{
\pada{vihāya
	\app{\lem[wit={P11,V19,V15,V1,J10,Jyo}]{niḥsāratayāntya}% °vya P11
...
\pada{\app{\lem[wit={ceteri}]{niṣevyate}
	...
	śītalamadhya\app{\lem[wit={P11,V3,N19,V15,J10,Jyo}]{dhārā}
		\rdg[wit={C6,J7,C7,V1}]{dhārāṃ}
		\rdg[wit={V19}]{dhārāḥ}}}\\+}
\tl{
\pada{\app{\lem[wit={P11,V3,V19,C7,N19}]{kāpālikaiḥ}
...
\pada{\app{\lem[wit={J7,V19,C7,J10,Jyo}]{amarīṃ}
		\rdg[wit={P11,V3,N19,V15,V1}]{amarī}
		\rdg[wit={C6}]{amariṃ}}
	\app{\lem[wit={GrB,V19,C7,N19,V15,V1,Jyo}]{yaḥ} % + J10pc
		\rdg[wit={J7,J10}]{yo}}
...
\pada{\app{\lem[wit={P11,N23,V19,C7,N19,V15,J10,Jyo}]{puṃso}
	...
	\app{\lem[wit={ceteri}]{binduṃ}
		\rdg[wit={P11,V3,N19,V15,J10}]{bindu}} % bidu P11
...
\pada{dehasiddhiṃ % dehe C6
	...
	\app{\lem[wit={ceteri}]{labhate}
		\rdg[wit={C6}]{labhyeta}
		\rdg[wit={N23},alt={\om}]{\skp{\om}}}}
\pada{\app{\lem[wit={N24,J7,V19,C7,Jyo}]{vajrolyabhyāsa}
		\rdg[wit={GrB,N23,N19,V15,V1,J10}]{vajrolyābhyāsa}% +N4; ā N23pc
		}yogataḥ/ \lineom{ab}{J5}}\\+} % +N24, yogavit G4
\tl{
\pada{\app{\lem[wit={G4,N24}]{ayaṃ śubhakaro yogo}
...
\pada{\app{\lem[wit={GrB,Gr2,N19,V15,V1}]{ayaṃ yogaḥ}
		\rdg[wit={V19,C7}]{eṣa yogaḥ}
		\rdg[wit={J10}]{yogo'yaṃ}}
	\app{\lem[wit={GrB,Gr2,V19,C7,N19,V15,V1}]{prasidhyati}
...
%\newpage
\begin{ava}[hp03_095]
\app{\lem[wit={G4,GrB,N19,V1,J10,Jyo}]{atha}
\rdg[wit={Gr2,Gr3a,V15},alt={\om}]{\skp{\om}}}
\app{\lem[wit={G4,GrB,J7,Gr3a,N19,V1,Jyo}]{śakticālanam}
...
\app{\lem[wit={N23,C7,J10}]{taddvāraṃ}
	\rdg[wit={P11,V3,J7,N19,V15,V1,Jyo}]{tadvāraṃ}
...
\pada{\app{\lem[wit={P11,Gr2,N19,V15}]{kandordhvaṃ}
	...
	\rdg[wit={K3}]{kuṇḍovvo}} kuṇḍalī % kuṃḍilī P11
...
\pada{yas tāṃ vetti sa yogavit//} \NotIn{Gr1r}\\!} % vartti N23; taṃ P11,J10ac
\end{alttlg}
...
\app{\lem[wit={ceteri}]{kuṇḍalī tathā}
	...
	\rdg[wit={Gr1r,V1,Jyo},alt={\om}]{\skp{\om}}}//}
	\lineom{cd}{Gr1r,V1,Jyo} \anm{cf.\,\manuref{3.1}}\\!}
\end{alttlg}
...
\app{\lem[wit={P11,V3,Gr2,Gr3a,N19,Jyo}]{kuṭilākārā}
	\rdg[wit={V15}]{kuṃḍilākārā}
	\rdg[wit={V1}]{kuṃḍalākārā}
	\rdg[wit={J10}]{kuṭilākarī}}}
\pada{sarpavat parikīrtitā/}\\+}
\tl{
\pada{sā śaktiś cālitā yena} % cātītā P11; ye<<na>> J7
\pada{sa mukto nātra saṃśayaḥ//} \NotIn{Gr1r} \anm{=\,\manuref{4.59}}\\!}
\end{alttlg}
\endaltnormal
...
\app{\lem[wit={GrB,Gr2,Gr3a,N19,J10,Jyo}]{pragṛhya}
	\rdg[wit={V15}]{nigṛhya}
	\rdg[wit={V1}]{gṛhya}}
...
\app{\lem[wit={ceteri}]{ṛjvī}
	...
	\rdg[wit={G4,C6,V19}]{ṛjvīm}
	\rdg[wit={P11}]{rījvīm}
	\rdg[wit={V3}]{rujvīm}
	\rdg[wit={N19}]{rajvī}
	\rdg[wit={Jyo}]{śaktir}}}
\pada{\app{\lem[wit={ceteri},alt={ūrdhvam}]{ūrdhva\skp{m}}% urddhvam J7
...
\pada{\app{\lem[wit={P11,J7,N19}]{vistāre}
...
\pada{\app{\lem[wit={P11,V15,V1,J10}]{veṣṭanāmbara}% ceṣṭanā° P11
	...
	\anm{=\,\ref{III33-5}} \NotIn{Gr1r}\label{vitasti}\\!}
\end{alttlg}
\endaltnormal
...
\pada{\app{\lem[wit={ceteri}]{cālayitvā}
	\rdg[wit={P11}]{vārayitvā}}
\app{\lem[wit={GrB,Gr2,Gr3a,N19}]{tu}
	\rdg[wit={V15,J10,Jyo}]{ca}% +J5
	\rdg[wit={V1},alt={\om}]{\skp{\om}}} kuṇḍalīm/}\\+}% °lī N23,N19,GrB
\tl{
...
\app{\lem[wit={GrB,V1,J10,Jyo},alt={kuryād}]{kuryā\skp{d}}% +J5
...
\pada{kuṇḍalīṃ % kuṃḍalī Gr2,V15,N3,P11,V3, kuṇḍalīś K3;
...
\tl{
\pada{nāsā\app{\lem[wit={P11,V3,Gr2,N19,V15,J10,Jyo}]{dakṣiṇamārgavāhi} % nāśā N19
...
\app{\lem[wit={ceteri}]{vahni}% vadri? P11
	\rdg[wit={V15}]{pāśa}
	\rdg[wit={N23},alt={\om}]{\skp{\om}}}%
...
\app{\lem[wit={GrB,J7,V19,K3}]{jīrṇa}
...
\pada{\app{\lem[wit={Gr2,Gr3a}]{yamas tu}
	...
	\rdg[wit={P11,N19,V1}]{śamino}% +C6pc
...
\pada{\app{\lem[wit={Gr2,Gr3a}]{nirbharaṃ}
	\rdg[wit={N3,J5,GrB,V15}]{nirbhayaś}% +K1
	\rdg[wit={N19}]{nirbhayaṃś}
	\rdg[wit={V1,J10,Jyo}]{nirbhayaṃ}} % +M1,G7 ##? ṃ unsichtbar V1
\app{\lem[wit={N3,J5,C6,V3,Gr2,N19,V15,V1,Jyo}]{cālanād asau}
...
\pada{\app{\lem[wit={C6,Gr2,V15}]{suṣumṇāgatakuṇḍalī}
	\rdg[wit={J5,N19}]{suṣumnā kuṇḍalīgatā}% +M1,M3
...
\begin{tlg}[hp03_100]
\tl{
\pada{\app{\lem[wit={N3,G4,GrB,Gr2,N19,V15,J10,Jyo}]{tena kuṇḍalinī tasyāḥ} % kuṃḍalanī N3, kuṃḍilinī P11, kuṇḍalīnī N23; tasyāt G4, tasyā V3
	\rdg[wit={V1},alt={\om}]{\skp{\om}}}}
\pada{\app{\lem[wit={ceteri}]{suṣumṇāyāḥ}
	\rdg[wit={N3,G4,GrB}]{suṣumṇāyā}}
\app{\lem[wit={G4,V3,Gr2,N19,V15,V1,J10}]{samuddhṛtā} % tāḥ N19, samudhṛtā J5,G4
...
\app{\lem[wit={V15,V1,Jyo}]{svataḥ}
	...
	\rdg[wit={J5,C6,Gr2}]{svayam}% śvayaṃ J5
...
\app{\lem[wit={N3,J5,GrB,Jyo}]{saṃcālanenaiva}% sacāla° N3
	...
	\rdg[wit={V1}]{..\,..\,lanen.\,..}}}
\pada{yogī \app{\lem[wit={N3,J5,C6,J7,N19,V15,V1,Jyo},alt={rogaiḥ/rogair}]{rogaiḥ}% raugaiḥ C6
...
\begin{tlg}[hp03_102]
\tl{
\pada{yena \app{\lem[wit={G4,GrB,N23,V15,V1,J10,Jyo}]{saṃcālitā}
	\rdg[wit={N19}]{saṃcalitā}
	\rdg[wit={N3}]{saṃcalatā}
	\rdg[wit={J7}]{sa cālitā}} śaktiḥ} % śakti V3,G4
\pada{sa yogī \app{\lem[wit={N3,GrB,N19,V15,V1,J10,Jyo}]{siddhi}
	\rdg[wit={G4}]{siddha}
...
\app{\lem[wit={J7,C7,Jyo}]{hitamitāśinaḥ}% °śanaḥ C7ac
	...
	\rdg[wit={V1},alt={\illeg}]{\skp{\illeg}}}/}\\+}
\tl{
\pada{\app{\lem[wit={C6,J7,K3,C7,N19,V15,Jyo},alt={maṇḍalād}]{maṇḍalā\skp{d}}% written often maṇḍalāt*
...
\app{\lem[wit={N3,C6,N19,J10,Jyo}]{cāndrīṃ}
	...
	\rdg[wit={P11}]{cāṃdrāṃ}
	\rdg[wit={Gr2}]{candraṃ}}}
\pada{vibhūtyā saha % vibhūbhyā N23, bibhṛtyā P11
...
\app{\lem[wit={N3,G4,GrB,N19,V15,V1}]{dṛṣṭipradāyakam}% +J5
...
\pada{\app{\lem[wit={P11,C6,J7,K3,N19,V15,V1,J10}]{dvi}
	\rdg[wit={N23,V19,C7,Jyo}]{dvā}}saptatisahasrāṇāṃ} % sahasrānā V19
...
\begin{tlg}[hp03_106]
\tl{
\pada{\app{\lem[wit={ceteri}]{mārutasya vidhiṃ}% vidhi J7,P11
...
\tl{
\pada{itaratra na kartavyā} % italantra na N23; ityatatra C6; karttavyo P11, kartavyaṃ N23
\pada{manovṛtti%r % °vṛtti P11, manārvvartti N23
...
\begin{tlg}[hp03_107]
\tl{
\pada{\app{\lem[wit={N3,GrB,J7,Gr3a}]{khilāpi}
...
\app{\lem[wit={ceteri}]{nāḍī}
	\rdg[wit={V1}]{..\,ḍīṃ}
	\rdg[wit={P11}]{°ḍī ca}}}
\pada{dṛḍhābhyāsena % draḍhā° P11, driḍhā° J10
\app{\lem[wit={ceteri}]{yoginām}
	\rdg[wit={P11,C6}]{yoginā}
	\rdg[wit={V3}]{yoginaṃ}
	\rdg[wit={J10}]{yoginaḥ}}/}\\+}
\tl{
...
\pada{yo \app{\lem[wit={GrB,J7,Gr3a,N19,J10}]{dhatte}% dadyāt J7pc
	...
	\rdg[wit={N23}]{dartte}
	\rdg[wit={V1}]{..\,[tte]}}
\app{\lem[wit={P11,V3,Gr3a,V1,J10,Jyo}]{sāṃpradāyikam}% saṃ° P11
...
\pada{sa \app{\lem[wit={P11,J7,Gr3a,N19,V1}]{evāstu}
	...
	\rdg[wit={N23}]{evavāca}
	\rdg[wit={C6}]{vāstava}} guruḥ svāmī} % guru P11,N23,V1,J10, <gu>ruḥ V19
...
\app{\lem[wit={N3,GrB,J7,N19,V15}]{tṛtīyopadeśaḥ} % tṛtiyo V3
