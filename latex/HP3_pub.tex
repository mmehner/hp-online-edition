...
\pada{\app{\lem[nolem]{\skp{pāda b}}
	\rdg[wit={P15,N19,V15},alt={\om},post=\texteng{(\textit{jump to} śūnyapadavī \textit{in the next verse})}]{\skp{\om\ (jump to \textit{śūnyapadavī} in the next verse.)}}}%
...
\pada{\app{\lem[wit={ceteri}]{jāyate}% jayate P11
	...
	\app{\lem[wit={N3,J5,Gr3,G11,V1,J10,GrB,Jyo},alt={dvipuṭā°}]{dvipuṭā\skp{°}}
		\rdg[wit={N23}]{dvipūtā}
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={Gr2,G11,N19,V15,V1,J10,GrB,Jyo}]{\textapp{included as a substitute for 3.21 in}}}%
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={Gr2,Gr3,G11,N19,V15,V1,J10,GrB,Jyo}]{\textapp{included as a substitute for 3.22 in}}}%
%\texteng{[Alt] }%
\pada{ayaṃ
...
\pada{kedāraṃ
	...
	\myfn{\getsiglum{Jyo} has a different verse order: \ref{triveni}ab \textrightarrow\ \ref{kAlapAza} \textrightarrow\ \ref{triveni}cd.}\\!}  %3.23
\end{tlg}
\commcite\newpage
...
\tl{\app{\lem[alt=\mylem{34*1–2},nonum,nosep]{}
		\rdg[wit={Gr3,G11,N19,V15,GrB,Jyo}]{\textapp{included as a substitute for 3.34 in}}}%
\pada{kalāṃ
...
\pada{mṛtyuṃ jayati yogavit//\versenr}\\!}  %3.41
\end{tlg}
\commcite%\newpage
...
\begin{tlg}[hp03_045]
\tl{\app{\lem[nolem]{}
	\rdg[wit={V15,V1},alt={\om},postwit=\textapp{(pādas cd are added by a second hand in the margin \getsiglum{V1})}]{\skp{\om}}}%
...
\pada{\app{\lem[wit={N23,J7,G11,J10,V3,Jyo}]{candrāt sāraḥ}
	...
	\app{\lem[wit={ceteri},alt={vapuṣas}]{vapuṣa\skp{s}}
		...
		\rdg[wit={V15},alt={\om},post=\texteng{(\emph{jumps to \ref{Jaala1}a})}]{\skp{\om\ (jumps to 3.66a)}}}%
...
\pada{\app{\lem[wit={Gr3,G11,N19,V1,J10,C6,V3,Jyo},alt={aviśrāntaṃ}]{\skm{d }aviśrāntaṃ}
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={Gr3},alt={\om}]{\skp{\om}}
	\rdg[wit={Jyo},alt=\textapp{found after \ref{III74}}]{\skp{found after \manuref{3.72}}}}%
...
\tl{\app{\lem[nolem]{}
	\rdg{\texteng{=\,4.10}}
	\rdg[wit={G11}]{\textapp{included here in}}
...
\pada{\app{\lem[wit={G5}]{śeṣaṃ tu}
	...
	\app{\lem[resp=emend]{grantha}
		\rdg[wit={G11,C6}]{granthi}}vistāraṃ}
