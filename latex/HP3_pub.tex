...
\pada{\app{\lem[nolem]{\skp{pāda b}}
	\rdg[wit={P15,N19,V15}]{\om\ (eye-skip)}
	}%
\app{\lem[wit={N3,J5,Gr2,G11,G5,J10,V3,Jyo}]{tadā}
...
\pada{\app{\lem[nolem]{\skp{pāda c}}
	\rdg[wit={P15,N19,V15}]{\om}}%
\app{\lem[wit={N3,J5,J7,G11,G5,J10,P11,C6pc,V3,Jyo}]{tadā}
		\rdg[wit={N23}]{yadā}
...
\pada{\app{\lem[nolem]{\skp{pāda d}}
	\rdg[wit={P15,N19,V15}]{\om}}%
\app{\lem[wit={N3,J5,Gr2,G11,G5,J10,GrB,Jyo}]{tadā}
...
\app{\lem[wit={N3,Gr2,G11,P11,C6}]{śūnyapadavīti kim} % +K3,C7
		...
		\rdg[wit={V19,G5,P15,N19,V15,V1,V3,Jyo}]{\om}% +N24
...
\pada{\app{\lem[wit={ceteri}]{śmaśānaṃ}% sma° V3
	...
	\app{\lem[wit={Gr1,Gr2,Gr3,P15,V15,P11,Jyo}]{madhya}
		\rdg[wit={G11,G5,V1,J10,C6,V3}]{madhyaṃ}
		\rdg[wit={N19}]{madhye}
		}}%
...
\pada{\app{\lem[wit={Gr2,G11,G5,P15,V15,J10,Jyo},alt={prabodhayitum}]{prabodhayitu\skp{m}}
		\rdg[wit={N3}]{prabodhayītum}
		\rdg[wit={J5,N19,V1,C6,V3}]{prabodhayatum}
		\rdg[wit={Gr3}]{tāṃ bodhayituṃ}
		\rdg[wit={P11}]{prabodhayatām}
		}%
	\app{\lem[wit={N3,J7,E2,G11,G5,P15,V15,V1,J10,C6,Jyo},alt={īśvarīṃ}]{\skm{m }īśvarīm}
...
\pada{mudrā\app{\lem[wit={N3,P15,N19,V15,V1,J10,P11,V3,Jyo},alt={°bhyāsaṃ samācaret}]{\skp{°}bhyāsaṃ samācaret}% bhyāsa V3
		...
		\rdg[wit={Gr2,Gr3,C6}]{bhyāsena bodhayet}
...
\pada{\app{\lem[nolem]{\skp{pāda c}}
  ...
  \app{\lem[wit={C6},alt={mūlabandhas}]{mūlabandha\skp{s}}
		...
		\rdg[wit={G11,G5,P15,N19,V15,Jyo}]{mūlabandhaś ca}% +F
...
\pada{\app{\lem[wit={N3,J5,P15,V15,J10,GrB},alt={tato}]{\skm{s }tato}
		\rdg[wit={G4,J7,Gr3,G11,G5,N19,V1,Jyo}]{bandho}% +N24 & 3 testimonies
		\rdg[wit={N23}]{bandhā}
		}
...
\app{\lem[wit={N3,J5}]{idaṃ mudrādi}
		...
		\rdg[wit={G11,G5,Jyo}]{idaṃ hi mudrā}% +N24,N12,M1; evaṃ F,G7
...
\pada{\app{\lem[wit={ceteri}]{ādinātho}% nāthaṃ mahad G5
...
\pada{\app{\lem[wit={ceteri}]{kulastrīsurataṃ}
	...
	mataḥ \getsiglum{J10}\,] matāḥ \getsiglum{C6}, magaḥ \getsiglum{V3} ;
...
\begin{ava}[hp03_010a]
	\app{\lem[wit={J5,G11,G5,V1,J10,P11}]{tatra mahāmudrā}
		\rdg[wit={N3,G4,J7}]{\om}
...
\pada{\app{\lem[wit={ceteri}]{pādaṃ}
	...
	\app{\lem[wit={J7,E2,G11,V15,V1,J10}]{dhṛtvā}% +K3,C7
		\rdg[wit={N3,J5,N23,V19,G5,P15,N19,GrB,Jyo}]{kṛtvā}% +F
		}}
\pada{karābhyāṃ
	\app{\lem[wit={ceteri},alt={pūrayen}]{pūraye\skp{n}}% so in Amaraugha
		\rdg[wit={J10}]{dhārayen}
		\rdg[wit={Jyo}]{dhārayed}}%
	\app{\lem[wit={N3,J5,G11,G5,N19,P11,V3},alt={mukhe}]{\skm{n }mukhe}% so in Amaraugha
...
\pada{\app{\lem[wit={ceteri}]{kaṇṭhe}% +J8
		\rdg[wit={V19,G11,G5,N19,V3}]{kaṇṭha}}
	\app{\lem[wit={J5,G4,J7,V19,G5,P15,V15,J10,P11,Jyo}]{bandhaṃ}% baddhaṃ G5
		\rdg[wit={N3}]{budha}
...
\begin{tlg}[hp03_012]
\tl{
\pada{\app{\lem[wit={J7,Gr3,G11,G5,V15,V1,J10,P11,Jyo}]{ṛjvībhūtā}
...
\pada{\app{\lem[wit={ceteri}]{jāyate}% jayate P11
	...
	\app{\lem[wit={N3,J5,Gr3,G11,G5,V1,J10,GrB,Jyo},alt={dvipuṭā°}]{dvipuṭā\skp{°}}
	...
	\app{\lem[wit={N3,J5,N19,J10,P11,V3},alt={°śritā}]{\skp{°}śritā}
		...
		\rdg[wit={N23}]{śrayī}
		\rdg[wit={J7}]{śrayāṃ}
		\rdg[wit={V19,G11,G5,Jyo}]{śrayā}% +K3
		\rdg[wit={P15}]{smṛtā}
		\rdg[wit={V15}]{sanāṃ}
		\rdg[wit={V1}]{[śr]i\,..}
		\rdg[wit={C6}]{hi sā}
...
\pada{mahā\app{\lem[wit={ceteri}]{siddhaiḥ}% siddhai J5,P11,V19
	...
	\app{\lem[wit={J5,Jyo}]{pradarśitā}
		...
		\rdg[wit={N23,J7,V19,E2,G11,G5,V15,V1,J10,P11,C6,V3}]{praśasyate}% +G11,F,N24; prasaśyate V3
...
\pada{\app{\lem[wit={ceteri}]{mahā}% maha P11
	...
	\app{\lem[wit={N3,G4,V1,J10,C6,V3,Jyo}]{kleśādayo}
		...
		\rdg[wit={G11,G5}]{rogā mahā}% roga G5
	...
	\app{\lem[wit={ceteri}]{doṣā}
		\rdg[wit={J5}]{\om}
		\rdg[wit={J7}]{doṣa}
		\rdg[wit={G11,G5}]{kleśā}
		\rdg[wit={J10,Jyo}]{doṣāḥ}
		}}
\pada{\app{\lem[wit={G4,Gr2,Gr3,G11,G5,V1,P11,C6}]{jīryante}% +F,N24; jīryate N23
...
\pada{\app{\lem[nolem]{\skp{pāda c}}
	\rdg[wit={Gr3}]{\om}}%
mahā\app{\lem[wit={G11,G5,V15,J10,GrB,Jyo}]{mudrāṃ}% mahāṃ P11
		\rdg[wit={Gr1,Gr2,N19,V1}]{mudrā}% mudrāḥ? V1
%		\rdg[wit={Gr3},postwit=\texteng{(Pādas c--d omitted)}]{\om}
		}
...
\pada{\app{\lem[wit={ceteri}]{sūryāṅge}
	...
	\app{\lem[wit={N3,J5,Gr2,G11,G5,J10,GrB,Jyo}]{punar abhyaset}
...
\pada{\app{\lem[wit={ceteri},alt={pīyūṣam}]{pīyūṣa\skp{m}}% pi° G11
	...
	\app{\lem[wit={ceteri}]{jīryate}% jīrjate V19
		\rdg[wit={J5}]{jāyate}
		\rdg[wit={Gr2,G11,G5,Jyo}]{jīryati}% +F
		}//\versenr}
	\\!}
\end{tlg}
\commcite%\newpage
...
\pada{\app{\lem[wit={G4,G11,G5,N19,V15,V1,J10,V3,Jyo}]{mahāsiddhikarī nṛṇām}% +N24,M3; keep! ## nṛṇā V15,V1
...
\pada{pūrayitvā
	\app{\lem[wit={N3,J5,Gr2,Gr3,C6}]{mukhe}
		\rdg[wit={G11,G5,V1,J10,V3,Jyo}]{tato}
...
\pada{\app{\lem[wit={N3,V3}]{nibhṛtya} % = Amaraugha
		\rdg[wit={J5}]{nitya}
		\rdg[wit={Gr2,V19,G5,V1,Jyo},alt={niṣ-/niḥpīḍya}]{niṣpīḍya}% niḥ- Gr2,V19; +F,C7
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={Gr2,G11,G5,N19,V15,V1,J10,GrB,Jyo}]{\textapp{included as a substitute for 3.21 in}}}%
\pada{\app{\lem[wit={ceteri}]{dhārayitvā}
		\rdg[wit={N19}]{cālayitvā}}
	\app{\lem[wit={G11,G5,N19,V15,J10,P11,V3}]{yathāśaktyā}% +F
...
\pada{\app{\lem[wit={G11,G5,N19},alt={dakṣāṅge ca sam°}]{dakṣāṅge ca sama}% +G7,F
		\rdg[wit={N23}]{sam}
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={G4,Gr2,G11,G5,N19,V15,V1,J10,GrB,Jyo}]{\incl}}%
\pada{\app{\lem[wit={G4,Gr2,G11,G5,N19,V15,P11,C6,Jyo}]{matam atra}
...
\pada{\app{\lem[wit={ceteri}]{kaṇṭhabandhaṃ}% ṃ om. V3
	...
	\app{\lem[wit={G4,G11,G5,N19,V15,P11,V3}]{visarjayet}
		\rdg[wit={Gr2,C6}]{tu varjayet}
		\rdg[wit={V1,J10,Jyo}]{vivarjayet}
		}/}
		\label{matam}\\+}
\tl{\app{\lem[alt=\mylem{21*2cd},nosep]{\skp{pāda cd}}
	\rdg[wit={N19,V15}]{\textapp{found after \ref{somasurya}}}}%
\pada{\app{\lem[wit={G11,G5,C6}]{rājadantabilaṃ tatra}% +P7
...
\pada{\app{\lem[wit={G5,N19,V15,C6},alt={jihvayottambhayed}]{jihvayottambhaye\skp{d}}% stambha G5
	...
	\app{\lem[wit={Gr2,G11,G5,N19,V15,GrB,Jyo},alt={iti}]{\skm{d }iti}
		\rdg[wit={V1}]{dhi tat}
		\rdg[wit={J10}]{dhitaḥ}
		}//\versenr} 
	\\!} % not in K1
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={Gr2,Gr3,G11,G5,N19,V15,V1,J10,GrB,Jyo}]{\textapp{included as a substitute for 3.22 in}}}%
\pada{ayaṃ
...
\pada{\app{\lem[nolem]{\skp{pāda c}}
	\rdg[wit={V15}]{\om}}%
mahāmudrā%
	\app{\lem[wit={J7,Gr3,G11,G5,C6,Jyo}]{mahābandhau}
		\rdg[wit={N3,J5,N23,N19,J10,P11,V3}]{mahābandho}
		\rdg[wit={V1}]{mahābandha}
		}}
\pada{\app{\lem[nolem]{\skp{pāda d}}
	\rdg[wit={V15}]{\om}}%
\app{\lem[wit={J7,Gr3,G11,G5,J10,C6,Jyo}]{niṣphalau}% niḥ° J7,V19,J10
		\rdg[wit={N3}]{niṣkalā}
		\rdg[wit={J5}]{niṣkalaḥ}
	...
	\app{\lem[wit={Gr2,Gr3,G11,G5,C6,Jyo}]{vedhavarjitau} % vetha N23
...
\app{\lem[wit={V15,J10,V3,Jyo}]{atha mahāvedhaḥ}
		...
		\rdg[wit={Gr2}]{mahāvedhaḥ (before \ref{VuIII25})}
		\rdg[wit={G11,G5}]{atha vedhaḥ}
...
\begin{tlg}[hp03_025]
\tl{
\pada{\app{\lem[wit={Gr1,G11,G5,N19,V15,V1,Jyo}]{mahābandha}
...
\pada{kṛtvā pūraka%
	\app{\lem[wit={J7,G11,G5,V15,V1,J10,C6,Jyo},alt={ekadhīḥ}]{\skm{m }ekadhīḥ}
		\rdg[wit={N3}]{ekadhī}
...
\tl{
\pada{\app{\lem[wit={J7,Gr3,G11,G5,V15,P11,Jyo}]{vāyūnāṃ}
...
\pada{\app{\lem[wit={ceteri}]{samahasta}
	...
	\app{\lem[wit={N23,V19,G11,G5,J10,P11,V3,Jyo}]{yugo}
		\rdg[wit={N3,N19}]{yuge}
		\rdg[wit={J5}]{yuga}
	...
	\app{\lem[alt={\post bhūmau}]{\skp{\post bhūmau}}
		\rdg[wit={G11,G5}]{samapādayugas tataḥ |
...
\pada{\app{\lem[wit={J7,Gr3,V1,J10,C6,Jyo}]{vāyuḥ}
		\rdg[wit={N3,J5,N23,G11,G5,N19,V15,P11,V3}]{vāyu}}
...
\pada{somasūryāgni% some? N23
	\app{\lem[wit={N19,Jyo}]{saṃbandho}% +M1,F
		...
		\rdg[wit={Gr3,V15}]{saṃdhānaṃ}
		\rdg[wit={G5}]{sambandhaṃ}
		\rdg[wit={V1,V3}]{saṃbandhā}
		}}\marmas
\pada{jāyate % jāyata? V15
	\app{\lem[wit={Gr1,G11,G5,P11,Jyo}]{cāmṛtāya vai}% vau J5
...
\pada{mṛtāvasthā % °masthā N23, mṛdavasthā G5
	\app{\lem[wit={ceteri}]{samutpannā}
		...
		\rdg[wit={N23}]{\om}}}
\pada{tato 
	\app{\lem[wit={N3,J5,J7,Gr3,G11,G5,N19,GrB}]{mṛtyubhayaṃ kutaḥ}
		\rdg[wit={G4}]{vāyuṃ\,+\,+\,+\,+}
...
\pada{\app{\lem[wit={ceteri}]{mahāvedho}
	...
	\app{\lem[wit={N3,J5,J7,E2,J10,C6,V3,Jyo},alt={abhyāsān}]{\skm{m }abhyāsā\skp{n}} % V19 °vedhopamanabhyā°?
		...
		\rdg[wit={G11,G5,N19,V15}]{abhyasto}% +F
		\rdg[wit={V1}]{abhyāso}
		}}%
...
\pada{\app{\lem[wit={ceteri}]{valī}% vaḷī V15
	...
	\app{\lem[wit={Jyo}]{vepa}
		\rdg[wit={N3,Gr2,G11,G5,N19,V15,V1,GrB}]{vedha} % J7ac
		\rdg[wit={J5}]{vaidya}
...
\pada{\app{\lem[wit={ceteri}]{vahni}
	...
	\app{\lem[wit={N3,Gr2,G11,G5,C6}]{caiva}
...
\pada{samyak\app{\lem[wit={ceteri},alt={śikṣāvatām}]{śikṣāvatā\skp{m}} % sikṣī V19; °catām N23
	...
	\app{\lem[wit={J5,Gr2,Gr3,V15,P11},alt={eva}]{\skm{m }eva} % M3?
		\rdg[wit={N3,G11,G5,N19,V1,J10,V3,Jyo}]{evaṃ}
		\rdg[wit={C6}]{bhavyaṃ}
		}}
\pada{svalpaṃ % svaplaṃ V1; ṃ om. E2
	prathama\app{\lem[wit={J5,N23,Gr3,N19,V15,V1,P11,C6}]{sādhane}% pratyama N23; sādhana? J10ac
		\rdg[wit={N3}]{sādhanaiḥ}
		\rdg[wit={J7,G11,G5,J10,V3,Jyo}]{sādhanaṃ}
		}/}\\+}
\tl{
\pada{\app{\lem[nolem]{\skp{pāda c}}
...
m ādau varjana%
	\app{\lem[wit={N3,J5,N19,V15,V1,P11,C6},alt={ādiśet}]{\skm{m }ādiśet}
		\rdg[wit={Gr2,Gr3,G11,G5,J10}]{ācaret}% +M3,G7,F
		\rdg[wit={V3}]{ādṛśyet}
		}//\versenr}%
	\myfn{%
...
\begin{tlg}[hp03_032]
\tl{
\pada{\app{\lem[wit={J5,N23,Gr3,J6,G11,G5,V15,V1,P11,V3,Jyo}]{chedana}% chedata P11
		\rdg[wit={N3}]{\illeg}
		\rdg[wit={G4}]{bhedana}
		\rdg[wit={J7}]{rasanā}
		\rdg[wit={N19}]{vedana}
	...
	\app{\lem[wit={J7,Gr3,J6,G11,G5,V15,V1,P11,Jyo}]{cālanadohaiḥ}% dohai P11
		\rdg[wit={N3}]{\illeg}
...
\app{\lem[wit={J7,G11,G5,N19,V1,P11,C6,Jyo}]{kalāṃ}% kalā vardhayet kramaśaḥ G4
	...
	\app{\lem[wit={N3,G11,G5,N19,V1,J10,E4,GrB}]{krameṇa}
		\rdg[wit={J5}]{kramaṇa}
		\rdg[wit={G4,J6}]{\om}
		\rdg[wit={Gr2}]{tu}
		\rdg[wit={Gr3}]{vai}
	...
	\app{\lem[wit={J5,G11,G5,V15,V1,J10,P11},alt={pravardhayet}]{pravardhaye\skp{t}}
		\rdg[wit={N3,G4,Gr3,N19,E4,C6,V3,Jyo}]{vardhayet}
		\rdg[wit={Gr2,J6}]{saṃvardhayet}% °ye N23, °me P11
		}%
	\app{\lem[wit={J5,J7,Gr3,J6,G11,G5,N19,V15,P11,C6,Jyo},alt={tāvat}]{\skm{t }tāvat}
		\rdg[wit={N3,N23,V1,E4,V3}]{\om}
		\rdg[wit={G4}]{kramaśaḥ}
		\rdg[wit={J10}]{tā<<va>>t}
		}/}\\+}
\tl{
\pada{\app{\lem[wit={N3,J5,G11,G5,V15,V1,J10,P11,C6,Jyo},alt={sā yāvad}]{sā yāva\skp{d}}% mā yāvad P11; yāva N3, pāvad J10
		\rdg[wit={G4}]{yā}
...
\app{\lem[wit={Gr2,E2,J6,V15,J10,Jyo}]{tadā khecarīsiddhiḥ}% +K3,C7
		...
		\rdg[wit={G11,G5,N19}]{tadānīṃ hi khecarīsiddhiḥ}% khecarīṃ N19
...
\pada{bhruvo%r  % bhṛ° N3, bhu° P11, bhrū° V3, bhrūvaur N23
	...
	\app{\lem[wit={J7,V19,E2,G5,N19,V1,J10,C6,V3,Jyo},alt={dṛṣṭir}]{dṛṣṭi\skp{r}}
...
\tl{\app{\lem[alt=\mylem{34*1–2},nosep,nonum]{}
		\rdg[wit={Gr3,G11,G5,N19,V15,GrB,Jyo}]{\textapp{included as a substitute for 3.34 in}}}%
\pada{kalāṃ
	\app{\lem[wit={Gr3,G5,N19,V15,P11,Jyo}]{parāṅmukhīṃ}
...
\tl{
\pada{\app{\lem[wit={Gr3,G11,G5,N19,V15,P11,C6,Jyo}]{sā}
		\rdg[wit={N19}]{sāṃ}
		\rdg[wit={V3}]{sa}
		}
...
\pada{vyomacakraṃ 
	\app{\lem[wit={ceteri}]{tad ucyate}% Gr3,N19,V15,GrB,Jyo
		\rdg[wit={G11,G5}]{praśasyate}
		}//\versenr} 
		\sgwit{Gr3,G11,G5,N19,V15,GrB,Jyo}
...
\pada{kṣaṇārdhaṃ % ṃ om. P11,N23
	\app{\lem[wit={ceteri}]{yadi}% padi P11
		...
		tiṣṭhati/}\\+} % tiṣṭhatī P11
\tl{
\pada{\app{\lem[wit={G11,G5,N19,V15,V3}]{kṣaṇena}% +N24
...
\pada{\app{\lem[wit={ceteri}]{yo mudrāṃ vetti}% vitti J5, veti G11
		\rdg[wit={N3}]{\illeg}}
	\app{\lem[wit={G4,J7,Gr3,G11,G5,N19,V15,V1,J10,Jyo}]{khecarīm}
...
\begin{tlg}[hp03_036]
\tl{\app{\lem[nolem]{}
	\rdg[wit={Gr2,Gr3,N19,V15}]{\om}}%
\pada{\app{\lem[wit={N3,G4,G11,G5,P11,Jyo}]{pīḍyate}
		\rdg[wit={J5}]{piṃḍaṃte}
		\rdg[wit={V1}]{chādyate}
		\rdg[wit={J10,C6,V3}]{bādhyate}
		}
	na \app{\lem[wit={V1,J10,V3,Jyo}]{sa}% +N24
		\rdg[wit={Gr1,G11,G5,P11,C6}]{ca}% +F
		} rogeṇa} % rogena V3
\pada{\app{\lem[wit={J5,P11}]{na ca lipyati}
		\rdg[wit={N3}]{na ca lipyata}
		\rdg[wit={G4,Jyo}]{lipyate na ca}% +F; pīḍyate na ca N24
		\rdg[wit={G11,G5,V1,J10,C6,V3}]{lipyate na sa}
		} karmaṇā/}\\+}
\tl{
\pada{\app{\lem[wit={N3,G11,G5,V1,J10,P11,V3,Jyo}]{bādhyate}
		\rdg[wit={J5}]{badhyate}
		\rdg[wit={G4}]{bhidyate}
		\rdg[wit={C6}]{khādyate}}
	na \app{\lem[wit={Gr1,G5,P11}]{ca}
		\rdg[wit={G11,V1,J10,C6,V3,Jyo}]{sa}
		} kālena}
\pada{\app{\lem[wit={N3,J5,J10,GrB,Jyo}]{yo mudrāṃ vetti}% mudrā N3
		\rdg[wit={G11,G5,V1}]{yasya mudrāsti}% +F,N24
		}
	\app{\lem[wit={N3,J10,Jyo}]{khecarīm}
		\rdg[wit={J5,G11,G5,V1,GrB}]{khecarī}}//\versenr} % ṣecarī J5
	\\!}
\end{tlg}
\commcite\newpage
...
\pada{j jihvā carati % jihva J8; jihvā jihva V19 (ditt.); calati N3
	khe \app{\lem[wit={ceteri}]{gatā}% gatāḥ C8
		\rdg[wit={P11}]{yadā}}/}\\+} 
\tl{
\pada{\app{\lem[wit={N3,J5,G11,G5,V15,P11,Jyo}]{tenaiṣā}
		\rdg[wit={J7,Gr3,C6}]{teneyaṃ}
		\rdg[wit={N19,V1,J10,V3}]{tenaiva}
		} khecarī
	\app{\lem[wit={N3,J5,G11,G5,V15,P11,Jyo}]{nāma}
		\rdg[wit={ceteri}]{mudrā}}}
\pada{\app{\lem[wit={N3,J5,G11,G5,V15,P11,Jyo}]{mudrā}
		\rdg[wit={G4}]{\illeg}
...
\tl{
\pada{\app{\lem[wit={J5,G4,N23,G11,G5,N19,V15,V1,J10,GrB}]{tasya na}% naḥ V15
		\rdg[wit={N3}]{+\,[s]ya na}
...
\pada{\app{\lem[wit={ceteri}]{calito}
	...
	\app{\lem[wit={ceteri}]{yadā}
		\rdg[wit={J5,G11,G5}]{yathā}
		} binduḥ} % bindu P11, biṃḥ N19, sinduḥ G11
\pada{\app{\lem[wit={N3,E2,G11,G5,N19,V15,V1,P11,C6,Jyo}]{saṃprāpto}% +K3,C7
		\rdg[wit={J5}]{saṃprāpte}
		\rdg[wit={Gr2,V19,J10,V3}]{saṃprāptaś}
		}
	\app{\lem[wit={J5,G11,G5,V15,V1,Jyo}]{yonimaṇḍalam}% +G7? illeg. G4
...
%		\rdg[wit={N24}]{haṭhavyaktyā}
		...
		\rdg[wit={J7,G11,G5,N19,V15,V1,J10,GrB}]{haṭhāc chaktyā}% havāt N19
		\rdg[wit={V19}]{hi tadbhuktyā}
		\rdg[wit={E2}]{hi tacchaktyā}% +K3,C7
		\rdg[wit={Jyo}]{hṛtaḥ śaktyā}
		}}\marmas
\pada{\app{\lem[wit={J5,G4,G11,G5,N19,V15,P11,C6,Jyo}]{nibaddho}
		\rdg[wit={N3}]{\illeg}
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={Gr1,Gr2,G11,N19,V15,GrB}]{\incl}}% not in G5!
...
\pada{\app{\lem[wit={J5,G4,G11,V15,V3}]{kalā}
	...
	\app{\lem[wit={Gr1,G11,V15,GrB}]{sandhāna}
		\rdg[wit={Gr2}]{saṃhāra}
...
\pada{\app{\lem[wit={ceteri}]{ūrdhva}
	...
	\app{\lem[wit={J7,V19,Jyo}]{jihvaḥ}% +C7
		\rdg[wit={N3,J5,E2,G5,N19,V15,V1,J10,GrB}]{jihvā}
		\rdg[wit={N23,G11}]{jihva}
		}
	\app{\lem[wit={N3,J5,E2,G11,G5,J10,V3}]{sthito}
...
\pada{śarīraṃ yasya
	\app{\lem[wit={G4,Gr2,Gr3,N19,P11,C6,Jyo}]{yoginaḥ}
		\rdg[wit={G11,G5,V15,V1,J10}]{dehinaḥ}
		\rdg[wit={V3}]{yoginaṃ}
		}/}\\+}
\tl{
\pada{takṣakeṇāpi % tat*kṣa° N19; °nādi G4
	\app{\lem[wit={G4,J7,Gr3,G11,G5,V15,J10,C6,Jyo}]{daṣṭasya}
...
\pada{\app{\lem[wit={Gr3,V15,V3,Jyo},alt={tailavart(t)iṃ}]{\skm{s }tailavartiṃ}% varttiṃ V3,V19,V15
		...
		\rdg[wit={G11,G5}]{tailaṃ vart(t)iṃ}
...
\pada{\app{\lem[wit={N23,J7,V19,E2,N19,V1,J10,V3,Jyo}]{dehī dehaṃ}% dehāṃ V3
		...
		\rdg[wit={G11,G5,V15,C6}]{dehaṃ dehī}
...
\begin{tlg}[hp03_045]
\tl{\app{\lem[nolem]{}
	\rdg[wit={V15,V1}]{\om\ (pādas cd have been added by a second hand in the margin of \getsiglum{V1})}}%
...
\pada{\app{\lem[wit={J7,E2,N19,Jyo}]{vahninotpāditaḥ}% +P17,K3
	...
	\app{\lem[wit={J5,G4,Gr2,V19,G11,G5,N19,Jyo}]{khalu}% khaluḥ J5; =P17
		\rdg[wit={N3}]{\illeg}
		\rdg[wit={E2}]{kila}
...
\pada{\app{\lem[wit={ceteri},alt={nirdoṣaḥ sa}]{\skm{n }nirdoṣaḥ sa}% +G5
	...
	\app{\lem[wit={N3,G11,N19,V15,V1,P11,Jyo},alt={vapur}]{vapu\skp{r}}
		\rdg[wit={J5,Gr2,Gr3,G5,J10,C6,V3}]{tanur}}r % tanu N23; +N24
...
\tl{
\pada{\app{\lem[wit={J5,N23,J7,G5,V15,V1,C6,V3,Jyo}]{sakṣārā}
	...
	\app{\lem[wit={N3,J5,G11,G5,V1}]{sadṛśā}% = VM
		\rdg[wit={G4}]{sadṛśaṃ}
...
\pada{\app{\lem[wit={ceteri},alt={tasya syād}]{tasya syā\skp{d}}% syābd N19
	...
	a\app{\lem[wit={ceteri},alt={amaratvam}]{\skp{a}maratva\skp{m}}
		...
		\rdg[wit={Gr3}]{iha siddhir}
		\rdg[wit={V3}]{aramatvam}
		}m
	aṣṭa\app{\lem[wit={N3,J5,G11,G5,V1,P11},alt={guṇavat}]{guṇava\skp{t}} % guṇava J5
		\rdg[wit={Gr2,V19,N19,J10,C6,V3,Jyo}]{guṇitaṃ}
		\rdg[wit={E2}]{guṇitā}
		\rdg[wit={V15}]{guṇāvat}
		}% +K3,C7
	\app{\lem[wit={J5,E2,V1,G11,G5,N19,V15,J10,P11,C6,Jyo},alt={siddhāṅganā}]{\skm{t }siddhāṅganā}% +K3,C7
...
%		\rdg[wit={J11}]{pātāle yadvitaya}
	...
	meru\app{\lem[wit={G11,G5,N19,V15,P11}]{mūle tad asmin}% mūlai P11
...
\mydelim
Before this verse, \getsiglum{J10,V3,Jyo} have the same verse as \manuref{X4.45}. \getsiglum{J10} and \getsiglum{V3} have it also in chapter 4, while \getsiglum{Jyo} has it only here.}
\\!}
\end{alttlg}
...
\app{\lem[wit={C6,V3}]{'yam iṣyate}% +F
		...
		\rdg[wit={G4}]{\illeg}
		\rdg[wit={Gr2,Gr3,G11,G5,N19,V1,J10}]{'yam ucyate}% VM
...
\pada{\app{\lem[nolem]{\skp{pāda a}}
	\rdg[wit={J5}]{\om}}%
\app{\lem[wit={G11,G5,V1,GrB,Jyo},alt={adhogatim}]{adhogati\skp{m}} % better, =HR
		\rdg[wit={N3,Gr2,Gr3,N19,J10}]{adhogatam}}% lost J5,G4
\app{\lem[wit={Gr2,G11,G5,N19,J10,P11,C6,Jyo},alt={apānaṃ vai}]{\skm{m }apānaṃ vai}
...
\app{\lem[wit={N3,G11,G5,V1,J10,GrB,Jyo}]{balāt}% +J11
...
\app{\lem[wit={N3,G4,G11,G5,N19,V1,J10,V3,Jyo}]{hi}
		\rdg[wit={J5}]{di}
...
\pada{\app{\lem[wit={ceteri}]{gudaṃ}
		\rdg[wit={N19}]{gulpha}
		\rdg[wit={C6}]{pārṣṇi}}
\app{\lem[wit={N3,J5,Gr3,G11,G5,J10,P11,V3,Jyo}]{pārṣṇyā tu} % prob. V19, pāṣṇyā V3; nu P11
	...
	\app{\lem[wit={ceteri}]{saṃpīḍya} % pījya N23ac, °pīḍye V3
		\rdg[wit={C6}]{āpīḍya}}}
\pada{\app{\lem[wit={Gr1,Gr2,G11,G5,V1,J10,C6,V3,Jyo},alt={vāyum ā°}]{vāyum ā\skp{°}}
		\rdg[wit={Gr3}]{yonim ā}
		\rdg[wit={N19,P11}]{vāyunā}
		}kuñcayed balāt/}\\+} % °ṣed N23ac
\tl{
\pada{vāraṃ vāraṃ % 1st vāra V1; 2nd vāra V3,J10
\app{\lem[wit={N3,G11,G5,N19,V1,J10,GrB,Jyo}]{yathā}
...
\pada{prāṇāpānau % prāṇa° V1; pāno G5
	\app{\lem[wit={N23,J7,V19,E2,G5,V1,C6,Jyo}]{nādabindū}
...
\app{\lem[wit={N3,G4,J7,Gr3,G11,G5,V1,C6,V3,Jyo}]{saṃsiddhiṃ}
...
\pada{\app{\lem[wit={J5,V3,Jyo}]{yacchato}
		...
		\rdg[wit={J7}]{gacchate}
		\rdg[wit={V19,G11,G5,N19}]{gacchato} % gakṣato V19; +K3,C7
		\rdg[wit={E2}]{kurute}
...
\pada{\app{\lem[wit={Gr2,Gr3,G11,G5,N19,C6}]{saṃprāpte}% = GŚ keep
...
\app{\lem[wit={N3,J7,P11,V3,Jyo}]{vahnimaṇḍalam}% =J7ac
		\rdg[wit={J5,N23,Gr3,G11,G5,N19,V1,C6}]{vahnimaṇḍale} % +J7pc
...
\pada{\app{\lem[wit={N3,J5,Gr2,G11,G5,N19,P11,V3}]{vardhate vāyunāhatā}
...
\app{\lem[wit={J7,Gr3,G11,G5,V1,P11,Jyo}]{vahnyapānau}% °panau J7
...
\pada{prāṇa\app{\lem[wit={G4,J7,G11,G5,N19,GrB,Jyo},alt={°m uṣṇa}]{\skp{°}m uṣṇa}% praṇam P11
		\rdg[wit={N3,J5,V1,J10}]{mūla}
		\rdg[wit={N23}]{mura}
		\rdg[wit={Gr3}]{mukta}
		}%
...
\tl{
\pada{\app{\lem[wit={Gr2,Gr3,G11,G5,V1,P11,Jyo}]{tenātyanta}
...
\app{\lem[wit={N3,J5,Gr2,G5,J10,C6,Jyo}]{saṃprabudhyate}% ddhy J7, yudhyate N23; +G5
...
\app{\lem[wit={Gr1,J7,G11,G5,N19,V1,Jyo}]{praviṣṭeva}
...
\pada{\app{\lem[wit={N3,J7,V19,C6,V3,Jyo}]{baddho}% +K3
		\rdg[wit={J5,E2,G11,G5,N19,P11}]{bandho}% +C7
		\rdg[wit={N23}]{vidrā}
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={V15}]{\om}}%
\pada{\app{\lem[wit={N3,J7,G11,G5,P11}]{uḍyāṇaṃ}% +M1,VM(Ms T) ##
		\rdg[wit={J5}]{uḍyāṇāṃ}
...
\pada{\app{\lem[wit={Gr3,G11,G5,N19,V1,J10,C6,V3,Jyo},alt={aviśrāntaṃ}]{\skm{d }aviśrāntaṃ}
...
\app{\lem[wit={J5,J7,C6}]{vidhīyate}% +J11
		\rdg[wit={N3,Gr3,G11,G5,N19,V1,J10,P11,V3,Jyo}]{bhidhīyate} % bhi[dh]īyate V19
...
\app{\lem[alt={udare ... tāṇaṃ}]{\skp{udare ... tāṇaṃ}}
	\rdg[wit={G11,G5}]{paścimaṃ tāṇam udare}
	}%
...
\app{\lem[wit={N3,J5,G11,G5,N19,V1,J10,P11,V3}]{taruṇo bhavet}
...
\pada{\app{\lem[wit={G4,G11,G5,N19,V1,P11,V3}]{tāṇaṃ}
		\rdg[wit={N3}]{tāpyaṃ}
		\rdg[wit={J5}]{tāruṇaṃ}
...
\app{\lem[wit={N3,Gr2,J10,P11},alt={abhyasan}]{\skm{m }abhyasa\skp{n}}
		\rdg[wit={J5}]{vau mahā}
		\rdg[wit={G4,Gr3,G11,G5,N19,V1,V3,Jyo}]{abhyasen}% +F
...
\pada{\app{\lem[wit={ceteri}]{karābhyāṃ}% °bhyā om. V1
	...
	\app{\lem[wit={E2,G11,G5,N19,P11,C6,Jyo},alt={dhārayed}]{dhāraye\skp{d}}
...
\pada{gulpha\app{\lem[wit={ceteri}]{deśa}% desa V3
		\rdg[wit={N3}]{deśaṃ}
		\rdg[wit={J5,E2,G11,G5,N19}]{deśe}
		}%
\app{\lem[wit={N3,Gr2,G11,G5,V1,J10,GrB,Jyo}]{samīpe ca}
...
\app{\lem[wit={G4,Gr2,Gr3,G11,G5,N19,P11,C6,Jyo}]{prapīḍayet}% pīdayet N23
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={V15,Jyo}]{\om}}%
\pada{\app{\lem[wit={J5,G4,G11,G5,V1,P11},alt={paścimaṃ tāṇam}]{paścimaṃ tāṇa\skp{m}}% trāṇam G5
		\rdg[wit={N3,V3}]{paścimatāṇam}
		\rdg[wit={Gr2,Gr3,N19,J10,C6}]{paścimaṃ tānam}
		}%
\app{\lem[wit={ceteri},alt={udare}]{\skm{m }udare}% Gr1,J7,Gr3,G11,G5,GrB
		\rdg[wit={N23}]{udara}
		\rdg[wit={N19}]{udaraṃ}
...
\pada{\app{\lem[wit={ceteri},alt={kārayed}]{kāraye\skp{d}}
		\rdg[wit={G5}]{dhārayed}
		\rdg[wit={J10}]{pīḍayed}}%
\app{\lem[wit={Gr1,J7,G5,V1,J10,GrB},alt={dhṛdaye gale}]{\skm{d }dhṛdaye gale} % kāraye hṛdaye V3, kārayed-hṛ° V1; +F,J11
...
\app{\lem[wit={ceteri}]{śanair yathā} % śanai P11
		\rdg[wit={N23}]{\om}}
\app{\lem[wit={N3,J5,Gr3,G11,G5,V1,P11,V3},alt={prāṇas}]{prāṇa\skp{s}}
		\rdg[wit={G4}]{strāṇas}
		\rdg[wit={Gr2}]{prāṇās}% praṇos? J7pc
		\rdg[wit={N19,C6}]{prāṇaṃ}
		\rdg[wit={J10}]{prāṇo}}}% 
\pada{\app{\lem[wit={N3,J7,V19,G11,G5,N19,P11,C6},alt={tunda}]{\skm{s }tunda}% +K3
		\rdg[wit={J5}]{kaṃda}% misreading of °stuṃda as °skaṃda
		\rdg[wit={N23}]{taṃda}
		\rdg[wit={E2}]{tadā}% +C7
		\rdg[wit={V1,V3}]{tuda}
		\rdg[wit={J10}]{nāḍī}}%
\app{\lem[wit={N3,Gr2,Gr3,G11,G5,V1,P11}]{saṃdhiṃ}
...
\app{\lem[wit={N3,J5,G11,G5,N19,V1,P11,V3,Jyo}]{svābhāvikī}
...
\pada{\app{\lem[wit={ceteri},alt={sthāpayed/c}]{sthāpaye\skp{d/c}}
	\rdg[wit={N23}]{\om}}% °ye V19,Gr1,V3,J10, °yet* N19, °yed V15
\app{\lem[wit={J5,G4,Gr3,G5,V1,J10,P11,V3},alt={dṛḍham icchayā}]{\skm{d }dṛḍham icchayā}% +G7,M1,M3?
...
\begin{tlg}[hp03_067]
\tl{
\pada{\app{\lem[wit={N3,G5,N19,V15,V1,J10,GrB,Jyo}]{badhnāti hi} % baddhāti N19; +G5
		\rdg[wit={J5}]{badhnāti}
...
\pada{\app{\lem[wit={N3,J7,G11,G5,N19,V15,GrB,Jyo}]{kaṇṭha}
...
\app{\lem[wit={ceteri}]{pradhāvati}% N3,J5,Gr2,G11,G5,N19,V15,J10,GrB
...
\app{\lem[wit={N3,J5,G11,G5,V15,V1,J10,P11,C6,Jyo},alt={stambhayed}]{stambhaye\skp{d}}% °bhaye N3,J5,G5,J10, °bhayod P11
		\rdg[wit={Gr2,Gr3,N19}]{stambhite}
		\rdg[wit={V3}]{\lacuna}
		}%
\app{\lem[wit={N3,J5,V1,J10,Jyo},alt={dṛḍham}]{\skm{d }dṛḍham}% +N24
		\rdg[wit={Gr2,Gr3,G11,G5,N19,P11}]{dhruvam}% +N12
		\rdg[wit={V15}]{dhṛvaṃ}
		\rdg[wit={C6}]{dhuram}
		\rdg[wit={V3}]{\lacuna}
		}/}\\+}
...
\app{\lem[wit={N3,G4,Gr2,G11,G5,N19,GrB},alt={niṣevitam}]{\skm{r }niṣevitam}% niśe° N3
...
\app{\lem[wit={N3,J5,J7,GrB,Jyo}]{haṭha}% saṃkaṭatrā + G4
		\rdg[wit={N23,G11,G5,N19,V15,V1,J10}]{yoga} % yoma N19
		}tantrāṇāṃ}
...
\getsiglum{J5,Gr2,G11,G5,V1,J10} have it in both chapters 2 and 3 
(\getsiglum{J5} is not collated here because the verse can be regarded as a later interpolation. See p.\,\hpref{139}). \getsiglum{Gr3} omit it at both places.} 
\\!}
\end{alttlg}
\altcommcite\newpage
\endaltrecension
...
\pada{\app{\lem[nolem]{\skp{pāda a}}
	\rdg[wit={Gr3,J10}]{\om}}%
mūlasthānaṃ
\app{\lem[wit={N3,J5,G11,G5,V15,V1,GrB,Jyo}]{samākuñcya}
...
\pada{\app{\lem[nolem]{\skp{pāda c}}
	\rdg[wit={J10}]{\om}}%
\app{\lem[wit={G4,J7,Gr3,G11,G5,V15,P11,V3,Jyo}]{iḍāṃ ca piṅgalāṃ} % iḷāṃ G4; piṃgulāṃ V3
...
\pada{\app{\lem[wit={N3,J5,Gr3,GrB},alt={sevayet}]{sevaye\skp{t}}
		\rdg[wit={G4}]{śevayet}
		\rdg[wit={Gr2,G11,G5,V15,V1,J10,Jyo}]{prayāti}% +F,N24
		\rdg[wit={N19}]{vaśayet}
		}%
...
\pada{\app{\lem[wit={Gr2,E2,G11,G5,N19,V1,Jyo},alt={jarārogādikaṃ}]{\skm{r }jarārogādikaṃ}% N24
...
\pada{\app{\lem[wit={N3,J5,J7,V19,E2,N19,V15,V1,J10,V3},alt={ūrdhvaṃ nābhir}]{ūrdhvaṃ nābhi\skp{r}}
		...
		\rdg[wit={G11,G5,P11}]{ūrdhvanābhir}
		\rdg[wit={C6}]{ūrdhvaṃ nābher}
		\rdg[wit={Jyo}]{ūrdhvanābher}
		}%
\app{\lem[wit={J5,G4,V19,G11,G5,N19,V15,J10,GrB},alt={adhas tālur}]{\skm{r }adhas tālu\skp{r}}% adhaḥstālur V19, °tālūr G4,V15
...
\app{\lem[wit={N3,Gr2,E2,G11,G5,V1,Jyo}]{karaṇī viparītākhyā}% +C7
...
\pada{\app{\lem[nolem]{\skp{pāda b}}
	\rdg[wit={Jyo}]{\om}}%
sarvavyādhi\app{\lem[wit={N3,Gr2,Gr3,G11,G5,V15,V1,J10}]{vināśinī}
...
\pada{nityam abhyāsa\app{\lem[wit={ceteri}]{yuktasya}
		\rdg[wit={G11,G5}]{yogena}
		\rdg[wit={P11}]{saktasya}}}
\pada{jaṭharāgni\app{\lem[wit={N3,J7,G5,N19,V15,V1}]{vivardhanī}% °nīm G5
...
\tl{
\pada{\app{\lem[wit={Gr1,G11,G5,V1,J10,GrB,Jyo}]{alpāhāro}
		\rdg[wit={Gr2,Gr3,N19,V15}]{anāhāro}
		}
\app{\lem[wit={ceteri},alt={yadi bhaved}]{yadi bhave\skp{d}}
		\rdg[wit={J10}]{nirāhāraḥ}}}%
\pada{\app{\lem[wit={N3,G4,Gr3,G11,G5,V15,V3},alt={agnir dehaṃ}]{\skm{d }agnir dehaṃ}
...
\app{\lem[wit={N3,J5,Gr2,Gr3,G11,G5,N19,V1,V3},alt={dahet}]{dahe\skp{t}} % dahe J5,V3,G11,N19, daher N23
...
\pada{adhaḥ\app{\lem[wit={N3,G4,V19,G11,N19,V15,V1,J10,GrB},alt={śiraś}]{śira\skp{ś}}% +F
...
\begin{tlg}[hp03_077]
\tl{
\pada{\app{\lem[wit={N3,G11,G5,V1,GrB}]{valiś ca}
		\rdg[wit={J5}]{vali}
...
\marma\pada{\app{\lem[wit={Jyo}]{ṣaṇmāsordhvaṃ na}% +G7!,°sordhvaṃ tu F!!
		\rdg[wit={N3,G11,G5,V15,P11,C6}]{ṣaṇmāsārdhān na}% +M1,G5,6
...
\tl{\app{\lem[nolem]{}
	\rdg{\texteng{=\,4.10}}
	\rdg[wit={G11,G5}]{\textapp{included here in}}
	\rdg[wit={Gr2,Gr3,N19,GrB,Jyo}]{\textapp{included before 3.73 in}}
	}%
\pada{yat kiṃci%t
\app{\lem[wit={J7,Gr3,G11,G5,N19,C6,V3,Jyo},alt={sravate}]{\skm{t }sravate} % śravate N19
		\rdg[wit={N23}]{sravanaṃ}
		\rdg[wit={P11}]{sevate}
		}
\app{\lem[wit={J7,Gr3,G11,G5,P11,C6,Jyo},alt={candrād}]{candrā\skp{d}}
		\rdg[wit={N23}]{ced<<am>>}
...
\app{\lem[wit={C6,Jyo}]{divyarūpiṇaḥ}% =N3
		...
		\rdg[wit={G11,G5,N19}]{divyarūpiṇaṃ}
...
\app{\lem[wit={ceteri},alt={sūryas}]{sūrya\skp{s}}
		\rdg[wit={N19}]{roho}}}%
\pada{s tena 
\app{\lem[wit={J7,Gr3,G5,N19,C6,V3}]{piṇḍaṃ}
		\rdg[wit={N23}]{piḍaṃ}
		\rdg[wit={G11,P11}]{piṇḍa}
		\rdg[wit={Jyo}]{piṇḍo}}
\app{\lem[wit={G11,G5,GrB}]{jarāyutam}% = N3
...
\pada{\app{\lem[wit={G4,J7,V19,G5,V1,J10,GrB,Jyo},alt={yogoktair}]{yogoktai\skp{r}}% °ktai P11
		\rdg[wit={N3}]{yogoktaṃ}
		\rdg[wit={J5,G11,G5,N19,V15}]{yogokta}% ## = DYŚ
...
\tl{
\pada{\app{\lem[wit={V19,V15,V1,J10,C6,Jyo}]{vajrolīṃ yo}% yo (l.br.) yo J10
...
\pada{\app{\lem[nolem]{\skp{pāda c}}
	...
	\app{yāva\lem[wit={N23,C7,J10,Jyo},alt={binduḥ}]{\skm{d }binduḥ}% +C6pc; yāva N23
		\rdg[wit={J5,G4,J7,V19,G5,N19,V15,V1,GrB}]{bindu}
		}
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={J5,G4}]{\excl}
	\rdg[wit={N3}]{\unavbl}
	\rdg[wit={V15}]{\textapp{pādas b and d are transposed}}
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={N3}]{\unavbl}}%
\pada{\app{\lem[nolem]{\skp{pāda a}}
		\rdg[wit={J5,G4,N23,GrB}]{\om}}%
	\app{\lem[wit={J7,V19,N19,V15,V1,J10},alt={jaleṣu bhasma}]{jaleṣu\marmas bhasma}% +F,E5(δ),P6
...
\tl{
\pada{\app{\lem[wit={J5,J7,V19,C7,G11,V1,J10,P11},alt={sahajolīr}]{sahajolī\skp{r}}% sahayolīr V19; +r G4
		\rdg[wit={N23,G5,N19,V15,V3,Jyo}]{sahajolir}
		\rdg[wit={C6}]{sahajolī}
		}r iyaṃ proktā} % iva J5
\pada{\app{\lem[wit={G11,P11,V3,Jyo}]{śraddheyā}% = DYŚ
		\rdg[wit={J5,G4,V19,C7,G5,V1,C6}]{śraddhayā}% +M1,M3,G7,F ##
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={N3}]{\unavbl}
	\rdg[wit={N23,G11,G5}]{\om}
	}%
	\app{\lem[alt={\ante pittolbaṇa°}]{\skp{\ante pittolbaṇa°}}
		\rdg[wit={J7,J10,Jyo}]{atha amarolī \add}
		\rdg[wit={V19,C7}]{tatrāmarolī \add}
		\rdg[wit={V15}]{āthamāroḷi \add}
		}%
\pada{\app{\lem[wit={J5,G4,V19,C7,V15,V1,P11,V3,Jyo},alt={pittolbaṇatvāt}]{pittolbaṇatvā\skp{t}} % °lvana° V19; °tvān J5
...
\pada{\app{\lem[wit={G11,G5,N19,V15,V1,J10,GrB}]{vajrolyā}
		\rdg[wit={J7,V19,C7,Jyo}]{vajrolya}% +F
...
\pada{\app{\lem[wit={G5}]{śeṣaṃ tu}
	...
	\app{\lem[resp=emend]{grantha}
		\rdg[wit={G11,G5}]{granthi}}vistāraṃ}
...
\tl{
\pada{balātkāreṇa gṛhṇīyā}%t % gṛhnī° C6,Gr2,V19,N19, grahṇī° G11; °yā V15
...
\app{\lem[wit={J5,Gr2,Gr3,N19,J10,GrB,Jyo}]{pragṛhya}% praguhya J5
		...
		\rdg[wit={V1}]{gṛhya}}
\app{\lem[wit={J7,Gr3,G11,G5,V15,C6,Jyo}]{bhujagīṃ}
...
\pada{t kuṇḍalīṃ % kuṃḍalī Gr2,V15,N3(+ ḍalī),P11,V3
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={Gr1}]{\excl}
	\rdg[wit={Jyo}]{\textapp{found after \ref{VuIII121} without commentary}}}%
...
\app{\lem[wit={ceteri},alt={nāḍīgaṇān/ṃs}]{nāḍīgaṇān\skp{/ṃs}} % gaṇān* C6,V3,J7,G11,V1,N19,V15,P23; gaṇāṃs Gr3
		\rdg[wit={N23}]{nā\,\_\,n}
...
\tl{\app{\lem[nolem]{}
	\rdg[wit={Gr1}]{\excl}
	\rdg[wit={Jyo}]{\textapp{found after \ref{VuIII121} with the previous verse}}}%
...
\pada{\app{\lem[nolem]{\skp{pāda d}}
	\rdg[wit={Gr3}]{\om}}%
\app{\lem[wit={J5,G11,G5,N19},alt={suṣumṇā kuṇḍalīgatā}]{\skm{t }suṣumṇā kuṇḍalīgatā}% +M1,M3; °kṛtā F
