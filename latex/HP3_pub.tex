...
\app{\lem[wit={Gr2,E2,J6,V15,J10,Jyo}]{tadā khecarīsiddhiḥ}% +K3,C7
		...
		}//\versenr}\myfn{The \textomega\ group manuscripts have verse 1.43 before this verse and 19 verses on \emph{khecary\teimute{\-}abhyāsakrama} (see Appendix B) after this verse. The first three of the 19 verses are also included in \getsiglum{V15} and \getsiglum{Jyo}.}
...
(\getsiglum{J5} is not collated here because it is regarded to be a later insertion. See p.\,\hpref{137}). \getsiglum{Gr3} omit it at both places.} 
\\!}
\end{alttlg}
\altcommcite\newpage
\endaltrecension
...
\app{\lem[wit={N23,Gr3,N19,J10,C6},alt={ghaṇṭikāyās tathā}]{\skm{g }ghaṇṭikāyās tathā}
		...
		\rdg[wit={V1}]{..\,..\,kāyā\,..\,..}}/}\\+}
\tl{
\pada{\app{\lem[resp=emend,alt={siñcan},postwit=\texteng{(cf.~\emph{Ama\teimute{\-}rau\teimute{\-}gha\teimute{\-}śāsana})}]{siñca\skp{n}}% 
