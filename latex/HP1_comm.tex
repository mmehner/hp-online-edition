...
Knowers of yoga know that the tortoise pose (\emph{kūrmāsana}) arises by carefully blocking the anus with the ankles crossed.%??Tweak note to reflect change to crossed. 
\end{translation}
...
[The yogi] correctly assumes lotus pose, inserts the hands between the knees and thighs, places [the hands] on the ground, and remains in the air. This is the wild cock pose (\emph{kukkuṭāsana}).
\end{translation}
...
%?? retain variants for athaikam āsyahṛdaye dhṛtvā samaṃ vigraham
\end{versinnote}
...
%?? Rewrite the note to reflect the adopted reading ekahṛdayo 

The adopted reading \emph{ekahṛdayo} is  supported by two manuscripts of the \emph{Haṭhapradīpikā} (\getsiglum{J2,M1}) and is close to the \textalpha\ reading \emph{ekahṛdaye}, which is also attested by the six-chapter \emph{Viveka\-mārtaṇḍa} and the \emph{Yoga\-cintāmaṇi}, ..
...
%?? Variants not really needed as HP text is solid.
\end{versinnote}
...
%?? Variants for uttabhya cibukaṃ vakṣasy āsthāpya pavanaṃ śanaiḥ ?
\end{versinnote}
...
%?? Retain variants for dhyānaṃś ca tac cetasi, muñcan and proccālayan
\end{versinnote}
...
% ?? Mention that the mudrās practised with the breathing techniques are the bandhas (2.44-45) 
...
\tl{āśrayaṃ pavanādīnāṃ caturtham avaśeṣayet ||\\!}% ??translate citations
\end{versinnote} 
...
%?? variants on yoge sarvo 'py atandritaḥ?
\end{versinnote}
