...
It is possible that \emph{pūjyapāda} could be a respectful affix to the name Kāṇerī. The variant \emph{dhvaninātha} may have resulted from a transposition of the first two syllables of \emph{nityanātha}. \lb 
...
Allamaprabhudeva, Ghoḍācolī, Ṭiṇṭiṇi, Bhāluki and Nāgabodha and Khaṇḍakāpālika.
\end{translation}
...
Manuscripts of several groups, namely \textbeta, \textepsilon\ and \texteta, have \emph{°bādhojjitaṃ}, whereas \textgamma, \textdelta\ and the \emph{Yogacintāmaṇi} have the more easily understood reading of \emph{°jantūjjhitaṃ} (‘free from creatures’). The \textalpha\ group is split on this, with \alphaThree\ (\emph{bodhojhitaṃ}) closer to \emph{°bādhojjhitaṃ} and \alphaOne\ (\emph{jyaṃtyūpsitaṃ} and \alphaTwo\ (\emph{jaṃtūṣṇitaṃ}) closer to \emph{°jantūjjhitaṃ}. We have adopted the more unusual reading of \emph{°bādhojjhitaṃ}  with the support of a similar description of a hut in \emph{Suśrutasaṃhitā} 6.17.67 (\emph{gṛhe nirābādhe}). 
...
It should also be noted that the word \emph{tattva} could have a more specific meaning in the \emph{Haṭhapradīpikā} (4.32–33) as Svātmārāma states that it is a synonym of \emph{samādhi}. In other yoga texts, it can sometimes refer to the practices of yoga (e.g. \emph{tritattva} in \emph{Amṛtasiddhi} 13.12, 14.2--3) or, more generally, to the highest reality or truth (e.g. \emph{Amanaska} 1.2, 1.20–21, 2.17, etc.).  
\end{philcomm}
...
\tl{\var{mayūram ] cett., māyūram P, T, t1}\\!}
\end{versinnote}
...
From among the eighty-four postures, it is \emph{siddhāsana} that one should always prefer; in the same way that from among the 72,000 channels [one should prefer] Suṣumṇā.
\end{translation}
...
%
Others have tried to make sense of this by changing \emph{suṣumnām iva nāḍiṣu} to \emph{nāḍīnāṃ malaśodhanam}, which occurs in the \emph{Jyotsnā} (1.39). The reading \emph{nāḍīnāṃ malaśodhanam/e} is probably a patch as no other texts say that \emph{siddhāsana} clears the channels. It could have been borrowed from verse 3.103*1ab, which has the same hemistich and was added to the section on \textit{śakticālana}.
...
% MD: the same half verse with nāḍīnāṃ malaśodhanam/e appears as 3.103*1ab. Better to mention?
...
%(MD 2024-5-14): It is remarkable that α2 and β1 have osthāpyot and ζ3 otthāpya. Perhaps o = ava as in the Middle Indic? avasthāpya would make the perfect sense.
...
The yogi in \emph{padmāsana} who fills [himself] up through the openings of the channels and stabilises the breath is sure to be liberated.
\end{translation}
...
It is not unusual to read \emph{pūrayet} with the locative as seen in this verse (cf. \emph{pūrayen mukhe} in \emph{Amaraugha} 21d).\lb 
...
In the third verse quarter, \alphaOne\ and \alphaThree\ read \emph{mārutaṃ mriyate yas tu}, which does not make sense, but if one accepts \emph{pūrayet} in the second verse quarter, one could emend their reading to \emph{māruto mriyate yasya}, which makes good sense: `the yogi whose breath dies (i.e. becomes still) is undoubtedly liberated'. In the same vein, \alphaTwo\ also has the plausible reading \emph{mārutaṃ mārayed yas tu}. \lb
%but J5 is contaminated (so the Gr3 reading dhārayet is more reliable).
% some  mss from the full collation do have yasya ??: JM rewrite note, we are adopting pūrayet | māruto mriyate yasya... also check tr.
...
Spreading the fingers and keeping the mouth wide open mimic a lion, and this is depicted in some iconography of Yoganarasiṃha (for example, Yoga Narasimha, Vishnu's Man-Lion Incarnation, Samuel Eilenberg Collection, Bequest of Samuel Eilenberg, 1998, Accession Number: 2000.284.4. https://www.metmuseum.org/art/collection/search/39251).\lb
...
\begin{versinnote}
\tl{haṭhapradīpikāyām--\\+}
\tl{śrutipratītiḥ svagurupratītiḥ svātmapratītir manaso nirodhaḥ |\\+}
...
This verse was omitted from \etaOne, the oldest dated manuscript. The omission is probably deliberate as that manuscript does not have chapter four, which teaches \emph{nādānusandhāna}. The numbering in \etaOne\ suggests that its exemplar had this verse.\lb
...
When very unctuous and sweet food is eaten for love of Śiva, leaving a quarter [of the stomach] empty (\emph{caturthāṃśavivarjitaḥ}), that is called a restricted diet (\emph{mitāhāra}).
\end{translation}
...
so this reading was probably not original. Moreover, only \emph{ājādimāṃsa}° makes good sense. Diwakar Acharya believes that the prohibition of goat flesh and fish in this verse suggests it derives from the North East of India.\lb
...
According to Sharma (1982: 69), \emph{piṇyāka} is, ‘The remnant paste of oily seeds after pressing out the oil content is called \emph{piṇyāka}.’ Diwakar says it is an oil cake that has a strong flavour, which may account for its inclusion in this list of unwholesome foods.\lb
...
We have not found any conclusive evidence for the meaning of \emph{tilapiṇḍa}. Brahmānanda glosses it as \emph{piṇyāka} (on the meaning of which see the notes for the previous verse).\lb
...
Manuscripts \alphaOne\alphaThree\betaOne\zetaOne\ have the reading \emph{durjanaprāntaṃ} (1.61a), which is the lectio difficilior in relation to \emph{durjanaprītiṃ} (`the friendship of wicked people'). We have understood \emph{durjanaprānta} in line with Brahmānanda's gloss in \emph{Jyotsnā} 1.64, `dwelling near bad people' (\emph{durjanasamīpavāsa}).  
\end{philcomm}
...
Thw term \emph{paṭola} can refer to at least two different gourds. Meulenbeld (1974: 569) compiled a list of six possibilities, including \textsc{Trichosanthes dioica} \textsc{Roxb}. (`pointed gourd'), \textsc{Trichosanthes cucumerina} \textsc{Linn} (`snake gourd').\lb
...
\end{enumerate}
Sharma (1982: 156) adds that \emph{paṭola} is a synonym of \emph{kulaka} and is well known as \textsc{Trichosanthas dioica Roxb.} Brahmānanda glosses \emph{paṭola} as \emph{kośātakī}, which is \textsc{Luffa acutangula Roxb} (Meulenbeld 1974: 586), suggesting that he thought it was some sort of luffa. He also mentions the vernacular term \emph{paravara} for \emph{paṭola}.\lb
