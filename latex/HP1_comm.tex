...
\end{versinnote}
\teimute{\addtocounter{poemline}{-2}}
...
The main problem in Brahmānanda's interpretation is his choice of \emph{-rājayogaṃ} over \emph{-rāja\teimute{\-}sau\teimute{\-}dhaṃ}, which he explains as follows:

\begin{versinnote}
\tl{rājayogaś ca sarvavṛttinirodhalakṣaṇo'saṃprajñātayogaḥ. tam icchor mumukṣor adhirohiṇīva adhi\teimute{\-}ruhyate'nayety adhi\skx{-}{}rohiṇī niḥśreṇīva vibhrājate viśeṣeṇa bhrājate śobhate. yathā pronnatasaudham āroḍhum icchor adhirohiṇy anāyāsena saudha\teimute{\-}prāpi\teimute{\-}kā bhavati evaṃ haṭhapradīpikāpi pronnatarājayogam āroḍhum icchor anā\teimute{\-}yāsena rājayogaprāpikā bhavatīti upamālaṅkāraḥ.  indravajrākhyaṃ vṛttam.\\!}
\end{versinnote}
\closer
\begin{quote}
...
As Brahmānanda notes, the compound \emph{kṛpākaraḥ} can be understood as one who is compassionate (\emph{kṛpā} + \emph{kara}) or one who is a mine (i.e.~a rich source) of compassion (\emph{kṛpā} + \emph{ākara}). In the Devanāgarī transmission, the \emph{kṣamā} of \emph{kṣamākaraḥ} probably arose as a mistake for \emph{kṛpā}.       
\end{philcomm}
%</cm3>
...
In Śaiva texts which predate the Haṭha corpus, Mīnanātha and Matsyendra are one and the same, but they are differentiated in later Tibetan and Indian lists of siddhas (\textsc{Mallinson} 2019: 273 n.\,35). \lb

Two manuscripts of the \textalpha\ and \textdelta\ groups have the variant reading \emph{virūpākṣaḥ savālikaḥ} (\getsiglum{J5,V19}) for \emph{virūpākṣabileśayāḥ}. In another \textalpha\ manuscript, \getsiglum{N3}, the original reading was \emph{savālmikaḥ}, which may reflect an attempt at some stage to change \emph{savālikaḥ} to a name similar to Vālmīki, the celebrated author of the \textit{Rāmāyaṇa}.
\end{philcomm}
%</cm5>
...
It is possible that \emph{pūjyapāda} is a respectful affix to the name Kaṇerī. The variant \emph{dhvaninātha} may have resulted from a transposition of the first two syllables of \emph{nityanātha}. \lb 
...
Allamaprabhudeva, Ghoḍācolī, Ṭiṇṭiṇi, Bhāluki and Nāgabodha and Khaṇḍa\teimute{\-}kāpālika.
\end{translation}
%</tr8>
...
The name Allamaprabhudeva (sometimes Allama Prabhu Deva or Allama Prabhudeva in secondary literature) is frequently transmitted as \emph{allamaḥ prabhu\teimute{\-}devaḥ} (cf.~\alphaTwo), as though it were two names. However, manuscripts \alphaOne, \alphaThree\ and \piOne\ do not have the \emph{visarga} and write it as one name (i.e.~\emph{allamaprabhudevaś ca}). This is also the case in some manuscripts of the \emph{Haṭharatnāvalī} (P,T,t1 in \textsc{Gharote et al.} 2009: 35 n.\,8). \lb

The names Nāgabodha, Nāgabodhi, and Nāgadeva are all possible in 1.8c. The adopted reading \emph{nāgabodhaś ca} is attested across several primary groups of manuscripts. We consider the readings of \alphaOne\ (\emph{namioḍḍīśa}) and \alphaTwo\ (\emph{nāma tuṃḍīśa}) to be corrupt.\lb

The \alphaOne\ and \alphaTwo\ reading of \emph{siddhaḥ kāpālikas} is an exception among the manuscripts and seems too vague to be referring to someone within a lineage. Khaṇḍa\teimute{\-}kāpālika is well attested by the remaining manuscripts (including \alphaThree) and this name appears in other texts, e.g.~Vajrapāṇi’s \emph{Laghutantraṭīkā}, p.\,45, where Khaṇḍakāpālika is the first of the 24 Vīras (\emph{vīrāḥ khaṇḍakāpālikādayaś caturviṃśatiḥ}). It is likely to refer to an ascetic who carries a broken skull. \emph{Matsye\teimute{\-}ndra\teimute{\-}saṃhitā} 33.2 mentions a practice for which one needs a \emph{khaṇḍakapāla} and in the \emph{Saṃ\teimute{\-}vara\teimute{\-}maṇḍala} of the \emph{Niṣpannayogāvalī}, p.\,26, Vajravārāhī is \emph{kapālakhaṇḍakṛtakaṭibhūṣaṇā}. The compound \emph{khaṇḍakāpālika} is found at \emph{Kathāsaritsāgara} 18.2.6, but there \sl{khaṇḍa} is being used in a derogatory sense (18.2.15 refers to the same character as a \sl{duṣṭakāpālika}).
...
\begin{variants}
  ...
  haṭhayogaprabhāvataḥ~] haṭhayogaprasādataḥ HRĀ, rasabhogaprasādataḥ MA, sanakādyā maha\teimute{\-}r\teimute{\-}ṣayaḥ HTK\sep
...
The \textalpha\ group omits the second line of this verse, but this was probably the result of eyeskip caused by the repetition of \emph{maṭho haṭhaḥ}. The reading \emph{jagatāṃ} makes good sense with  \emph{ādhārakamaṭhah} in light of the cosmological notion that the worlds are supported by a tortoise. However, it appears not to have been understood by some and was changed in other witnesses to \emph{yuktānām} (e.g., \textpi\ in the collated group), which was later adopted by Brahmānanda in \emph{Jyotsnā} 1.10.       
\end{philcomm}
%</cm10>
...
The term \emph{maṭhikā} occurs in narrative literature and yoga texts in the sense of a small hut. For example, in the \textit{Kathāsaritsāgara} (12.9.14, 29–30), \emph{maṭhikā} refers to the small hut built in a cremation ground by a young Brahmin who makes as his bed the ashes of the dead girl he had hoped to marry. In several other stories (\textit{Kathāsaritsāgara} 6.6.132, 10.5.89, 12.25.35), \emph{maṭhikā} is the term used for the hut of an ascetic. In an elaborate description of the huts (\emph{maṭhikā}) used for Haṭhayoga, the author of the \emph{Haṭhābhyāsapaddhati} states that the dimensions of the hut are four “\emph{hasta}s” high and wide (there are various definitions of the term: 18 inches according to the Larger Petrograd Dictionary and \textsc{Monier-Williams} (1899), 48 inches according to the Smaller Petrograd Dictionary; the NWS lists even more variations, but the stipulation that the hut is the length of a bow found in the \emph{Gorakṣaśataka} (on which see below) suggests that 18 inches was meant). The hut can be made of various materials, such as red earth, ashes, plaster and so on (\textsc{Birch and Singleton} 2019: 17–18).\lb

In the \emph{Jyotsnā} and printed editions of the \emph{Haṭhapradīpikā}, including one by \textsc{Digambara and Kokaje} (1970: 6), this verse has the additional line, \emph{dhanuḥ\teimute{\-}pramāṇa\teimute{\-}paryantaṃ śilāgnijalavarjite}. This line derives from the \emph{Gorakṣaśataka} (32cd), which has \emph{paryante} instead of \emph{paryantaṃ}. It stipulates that the hut should be built in a place measuring up to a bow length and free from rocks, fire and water. None of the early manuscripts has this line, which suggests that it was added at a later time. Nonetheless, it appears in over a dozen manuscripts that were consulted for this edition. These manuscripts are not close to an early hyp\teimute{\-}archetype of the text.
\end{philcomm}
%</cm12>
...
It should also be noted that the word \emph{tattva} could have a more specific meaning in the \emph{Haṭhapradīpikā} (4.32–33) as Svātmā\teimute{\-}rāma states that it is a synonym of \emph{samādhi}. In other yoga texts, it can sometimes refer to the practices of yoga (e.g. \emph{tritattva} in \emph{Amṛtasiddhi} 13.12, 14.2–3) or, more generally, to the highest reality or truth (e.g. \emph{Amanaska} 1.2, 1.20–21, 2.17 etc.).  
\end{philcomm}
%</cm16>
...
On the historical implications of these two traditions of postural practice in early Haṭhayoga, see \textsc{Mallinson} 2016: 119–122 and \textsc{Birch} 2018a: 45–46.
\end{philcomm}
%</cm18>
...
One might wonder how the soles of the feet could be placed between the knees and thighs. Brahmānanda explains that the region of the shank near the knee should be understood by the word ‘knee’ in this verse (\emph{atra jānuśabdena jānusaṃnihito jaṅghāpradeśo grāhyaḥ jānusaṃnihito jaṅghāpradeśaḥ}). This is consistent with the earliest known description of \emph{svastikāsana}, found in the \emph{Pātañjala\teimute{\-}yoga\teimute{\-}śāstra\teimute{\-}vivaraṇa} (2.46), which states that the big toe of one foot is tucked in between the shank and thigh of the other so it is not seen (\emph{dakṣiṇaṃ pādāṅguṣṭhaṃ savyenorujaṅghena parigṛhyādṛśyaṃ kṛtvā tathā savyaṃ pādāṅguṣṭhaṃ dakṣiṇenorujaṅghenādṛśyaṃ parigṛhya yathā ca pārṣṇibhyāṃ vṛṣaṇayor apīḍaṇaṃ tathā yenāste tat svastikam āsanam}). For a discussion of \emph{svastikāsana} in the Pātañjalayoga tradition, see \textsc{Maas} 2018: 68–69. The descriptions of \emph{svastikāsana} in early Śaiva Tantras do not mention the inserting of the toes between the knees and thighs (see \textsc{Goodall} 2004: 348–350, fn.\,371).
\end{philcomm}
%</cm19>
...
Different versions of \emph{vīrāsana} are found in earlier tantric and yogic works, such as the \emph{Kiraṇatantra}, Hemacandra’s \emph{Yogaśāstra} and commentaries on the \emph{Pātañjalayogaśāstra}. For a discussion of some of these, see \textsc{Maas} 2018: 66–68.
\end{philcomm}
%</cm21>
...
\begin{variants}
  niṣpīḍya~] nipīḍya ABS, nirudhya VS\sep
  kūrmāsanaṃ bhaved etad VS~] etat kūrmāsanaṃ proktaṃ ABS\sep
...
Here we understand \emph{jaṭhara}, which usually refers to the stomach, to mean “tough” or “persistent” (cf.~\emph{Amarakośa} 3.3.189: \emph{jaṭharaḥ kaṭhine'pi syād adhastād api cādharaḥ}).\lb
...
[The yogi] should stretch out the legs on the ground [as straight] as a stick, hold the toes of both feet with the hands, and remain with the forehead placed on the knees. They call this the back-stretch (\emph{paścimatāṇam}).
\end{translation}
%</tr28>
...
\begin{philcomm}[hp01_029]
 The use of the word \emph{paścima} to mean the central channel is found at \emph{Yogabīja} 95 (\emph{paścima\teimute{\-}mārgataḥ}), 108 (\emph{paścime pathi}), 117 (\emph{paścimadvāramārgeṇa}) and 121 (\emph{paścimaṃ}). Cf.~the usages of \emph{paścima\teimute{\-}mārga} in \sl{Dattātreyayogaśāstra} 140 and \emph{Śivasaṃhitā} 3.110 (from which this verse is likely to be derived). Brahmānanda understands \emph{paścima} as referring to the Suṣumṇā (\emph{Jyotsnā} 1.29): \emph{paścimavāhinaṃ paścimena paścimamārgeṇa suṣumṇāmārgeṇa vahatīti paścimavāhī}.
\end{philcomm}
%</cm29>
...
There is no direct source of this verse, but it has the same elements as two verses in the \emph{Vasiṣṭhasaṃhitā} (1.76–77), which are themselves derived from earlier Vaiṣṇava sources (see \textsc{Mallinson} 2014: 227 n.\,9). The compound \emph{uccāsanaḥ} in the third verse quarter seems to approximate in a somewhat vague way the \emph{Vasiṣṭhasaṃhitā}’s reading \emph{samunnataśiraḥpādaḥ}. \lb
 
In the second verse quarter, the pronoun in \emph{tatkūrpara°} refers to the two hands. This is stated more explicitly (i.e.~\emph{hastayoḥ kūrparau}) in \emph{Vasiṣṭhasaṃhitā} 1.76c and \emph{Yogayājñavalkya} 3.15c.
\end{philcomm}
%</cm30>
...
The glorious peacock posture quickly cures all illnesses, beginning with bloating and abdominal diseases, and overcomes humoral imbalances. It reduces to ash food which is bad or has been eaten to excess, kindles the digestive fire and causes strong poison to be digested.
\end{translation}
...
Lying on the ground like a corpse with its face up is the corpse posture. It removes fatigue [caused by practising] any \emph{āsana} and calms the mind.
\end{translation}
...
\begin{sources}[hp01_035]
  ...
  \begin{variants}
    athaikam ekahṛdayo VM~] athaikadeśahṛdayo VM\vl, athaikam eva niyataṃ VM\vl, athaikam eva hṛdayaṃ VM\vl, athaikam ekahṛdayaḥ VM\vl\sep
...
Some call this the adept's pose (\emph{siddhāsana}), others know it as the thunderbolt pose (\emph{vajrāsana}), a few say it is the pose of the liberated (\emph{muktāsana}) and others still call it the secret pose (\emph{guptāsana}).
\end{translation}
%</tr37>
...
The last two references are taken from \textsc{Reddy} 1982: 41–42.
...
%
Others have tried to make sense of this by changing \emph{suṣumnām iva nāḍiṣu} to \emph{nāḍīnāṃ malaśodhanam}, which occurs in the \emph{Jyotsnā} (1.39), \emph{Kumbhakapaddhati} (120), and \emph{Haṭhayoga} (quoted in the \emph{Yogacintāmaṇi}, f.\,79r). This variant reading is probably a patch as no other texts say that \emph{siddhāsana} clears the channels. It could have been borrowed from verse 3.102*1ab, which has the same half-verse and was added to the section on \textit{śakticālana}.
...
bandhatrayam YCM~] granthitrayam YSS\sep
evopajāyate YCM~] evopabhidyate YSS
...
\begin{sources}[hp01_044]
  ...
  \begin{variants}
    vighātakāri yamināṃ~] vikārahāri yamināṃ VM, vighātahāri yamināṃ VM\vl, vikāra\teimute{\-}nāśanakaraṃ VM\vl, vikārakaṃdadamanaṇ VM\vl, vināśakāri yamināṃ VM\vl
  \end{variants}
...
\end{versinnote}
\begin{appinnote}
\tl{vakṣasy DYŚ~] vakṣe ŚS DYŚ\vl, vakṣaḥ DYŚ\vl, vakṣya DYŚ\vl \\+}
\tl{āsthāpya DYŚ~] saṃsthāpya ŚS DYŚ\vl, āsthāya DYŚ\vl, sthāpayet DYŚ\vl, vakṣastha DYŚ\vl \\!}
\end{appinnote}
...
\begin{sources}[hp01_048]
  ...
  \begin{variants}
    ...
    proccālayan VM~] proccālayet VM\vl, proccārayet VM\vl, prollāsayet VM\vl, proccārayan VM\vl\sep % prodvārayaṃ VM\vl, 
    muñcan prāṇam upaiti bodham atulaṃ śaktiprabhāvān naraḥ VM~] prāṇaṃ muṃcati bodham eti śanakaiḥ proktaprabhāvād ataḥ VM\vl, pāṇaṃ muṃcati bodham eti śanakaiḥ śaktiḥ prabhāvād ataḥ VM\vl, prāṇaṃ muṃcati yāti bodham amalaṃ śaktipradhānoditaḥ VM\vl, muṃcan prāṇam upaiti bodham atulaṃ śaktiprabhāvād ataḥ VM\vl, muñcan prāṇam upaiti bodham atulaṃ śaktiprabodhān naraḥ VM\vl, prāṇaṃ muñcati bodham eti śanakaiḥ śaktiprabodhān naraḥ VM\vl, muñcan prāṇam upaiti bodham akhilāṃ śaktiṃ prabhāvād ataḥ VM\vl
    \end{variants}
...
\begin{testimonia}[hp01_048]
  ...
  \begin{variants}
     ...
     muñcan prāṇam upaiti bodham atulaṃ~] muñcat prāṇam upaiti bodham atulaṃ HRĀ, prāṇaṃ muñcati bodham eti niyataṃ YCM\sep
     śaktiprabhāvān naraḥ~] śakteḥ prabhāvān naraḥ HRĀ, śaktiprabodhodayāt YCM
    \end{variants}
...
It is not unusual to read forms from \emph{pṝ} with the locative as seen in this verse (cf.\,\emph{pūrayen mukhe} in \emph{Amaraugha} 21d) but it is not clear what is meant here. \emph{Siddha\teimute{\-}siddhānta\teimute{\-}paddhati} 1.66 identifies the ten \emph{dvāra}s at which the ten principle channels terminate, and adds that all other channels terminate at the pores of the skin. Perhaps the primary \emph{nāḍīdvāra}s are intended here, and the yogi is to fill himself up with air through each of them. Alternatively, the meaning could be that by filling the \emph{dvāra}s with air, the yogi is blocking them, thus enabling the stilling of the breath as described in some secondary readings in the second half of the verse. This appears to be how this verse is understood at \emph{Haṭhatattvakaumudī} 17.30 (cf.~\emph{Yogatattvopaniṣad} 141–142).\lb
...
\emph{Vasiṣṭhasaṃhitā} 1.73–1.75ab (50–52ab only), \emph{Yogayājñavalkya} 3.9–3.11ab (50–52ab only), \emph{Sūta\teimute{\-}saṃhitā} 15.7–8 (50–51 only)
...
\begin{testimonia}[hp01_052]
  ...
  \begin{variants}
    ...
    bandhatritayasaṃdhānaṃ kurute cāsanottamam~] bandhatritayasaṃsthānaṃ kurute cāsanottamam HRĀ, \emph{om.}~YCM
    \end{variants}
...
Manuscripts of two early groups, \textgamma\ and \textpi, as well as the \emph{Jyotsnā} (1.53), include an additional line specifying that the left ankle is placed on the left side and the right ankle on the right (\emph{savya\teimute{\-}gulphaṃ tathā savye dakṣagulphaṃ tu dakṣiṇe}). This line appears to have been added to make it clear that the ankles are not crossed in \emph{bhadrāsana}, unlike the previous pose, \emph{siṃhāsana}.
...
\begin{variants}
  ...
  athābhyasen nāḍiśuddhiṃ HSC~] abhyasen nāḍiśuddhiṃ ca YCM\sep
...
\begin{sources}[hp01_055_2]
  ...
  \begin{variants}
    yogasiddhiḥ~] kācit siddhiḥ DYŚ\sep
...
This verse was omitted from \etaOne, the oldest dated manuscript. The omission is probably deliberate as that manuscript does not have chapter four, which teaches \emph{nādānusan\teimute{\-}dhāna} and the numbering in \etaOne\ indicates that its exemplar included the verse.\lb
...
\begin{testimonia}[hp01_058]
  ...
  \begin{variants}
    saṃprītyai YBhD~] saṃprītyā YCU\sep
...
And, as noted by Brahmānanda in \emph{Jyotsnā} 1.58, this idea also occurs in the \emph{Aṣṭāṅgahṛda\teimute{\-}ya\teimute{\-}saṃhitā} (\emph{Sūtrasthāna} 8.46cd–47ab): 
...
Cf.~\emph{Dattātreyayogaśāstra} 70ab
\begin{versinnote}
...
\begin{testimonia}[hp01_059]
  \emph{Haṭharatnāvalī} 1.72, \emph{Yogacintāmaṇi} f.\,54v (\attr HP), \emph{Yuktabhavadeva} 4.18 (\attr HP), \emph{Haṭhatattvakaumudī} 4.28

  \begin{variants}
    tīkṣṇa HRĀ YCM HTK~] tikta YBhD\sep
    harītaśāka YCM~] harītaśākaṃ HRĀ, haritaśāka HTK YBhD\sep
    matsyamadyam HRĀ YCM HTK~] madyamatsyāḥ YBhD\sep
    ājādimāṃsa~] ajādimāṃsa HRĀ YCM, ajāvimāṃsa YBhD HTK\sep
...
On the meaning of \emph{uṣṇa} (1.59a) in relation to food,  \textsc{Meulenbeld} (1974: 254 fn.\,13) writes:
\begin{quote}
Cakra mentions as a variant: \emph{kaṭvamlalavaṇakṣāra} (pungent, acid, saline and caustic). Cakra remarks that the term ‘hot’ (\emph{uṣṇa}) denotes hot on touch when it occurs the first time, and hot with regard to potency when it occurs for the second time.
\end{quote}
...
The term \emph{sauvīra} (1.59b) probably means sour gruel. Brahmānanda glosses  \emph{sauvīra} as \emph{kāñjika}, which is ‘fermented rice water.’ On \emph{sauvīra}, \textsc{Meulenbeld} (1974: 516–517) says ‘\emph{sauvīra} is sour gruel made from barley and wheat.’ The process of making it is described in the \emph{Suśrutasaṃhitā} (1.44.35–40ab) as follows:
...
Our translation of \emph{madya} takes into account the following remarks of \textsc{McHugh} (2021: 8):
...
In the same vein there is a saying by Gorakṣa:
\end{translation}
%</tr61a>
...
\begin{variants}
  ...
  divyam HRĀ YBhD~] cālpam YCM\sep
...
In 1.62b, \emph{maṇḍa}, which is supported by \alphaOne, \alphaTwo, and manuscripts of other important groups, is more likely than \emph{khaṇḍa} (‘candied sugar’), which is also well-attested (\alphaThree, etc.), because the other elements of this compound are dairy products. The term \emph{navanīta} is discussed in \emph{Suśrutasaṃhitā, sūtrasthāna,} 45.92. %as follows:%JM:do we need this quote? navanīta is very common
% \begin{quote}
...
The word \emph{sitā} is one of many words for ground sugar. \textsc{Meulenbeld} (1974: 507) comments that \emph{sitā} is ‘very white and looks like gravel.’\lb

The term \emph{paṭola} can refer to at least two different gourds. \textsc{Meulenbeld} (1974: 569) compiled a list of six possibilities, including \emph{Trichosanthes dioica} \textsc{Roxb}. (‘pointed gourd’) and \emph{Trichosanthes cucumerina} \textsc{Linn.} (‘snake gourd’).\lb
...
\textsc{Singh and Chunekar} (1999: 232) identify \emph{paṭola} as \emph{Trichosanthas dioica} \textsc{Roxb.}, more commonly known as the pointed gourd, and they give its Hindi names as \emph{paravala} and \emph{parorāparorā}. It is very common in North India and is a popular vegetable in ascetic communities. Brahmānanda, however, glosses \emph{paṭola} as \emph{kośātakī}, which \textsc{Meulenbeld} (1974: 586) identifies as \emph{Luffa acutangula} \textsc{Roxb}, suggesting that Brahmānanda thought \emph{paṭola} was some sort of luffa.\lb 
%
...
\emph{Haṭharatnāvalī} 1.23, \emph{Yogacintāmaṇi} f.\,15r (\attr HP)
