...
The name Allamaprabhudeva (sometimes Allama Prabhu Deva or Allama Prabhudeva in secondary literature) is frequently transmitted as \emph{allamaḥ prabhu\-devaḥ} (cf.~\alphaTwo), as though it were two names. However, manuscripts \alphaOne, \alphaThree\ and \piOne\ do not have the \emph{visarga} and write it as one name (i.e.~\emph{allamaprabhudevaś ca}). This is also the case in some manuscripts of the \emph{Haṭharatnāvalī} (P,T,t1 in \textsc{Gharote et al.} 2009: 35 n.\,8). \lb
...
\begin{variants}
  ...
  haṭhayogaprabhāvataḥ\,] haṭhayogaprasādataḥ HRĀ, rasabhogaprasādataḥ MA, sanakādyā maha\-r\-ṣayaḥ HTK\sep
...
The \textalpha\ group omits the second line of this verse, but this was probably the result of eyeskip caused by the repetition of \emph{maṭho haṭhaḥ}. The reading \emph{jagatāṃ} makes good sense with  \emph{ādhā\-ra\-kamaṭhah} in light of the cosmological notion that the worlds are supported by a tortoise. However, it appears not to have been understood by some and was changed in other witnesses to \emph{yuktānām} (e.g., \textpi\ in the collated group), which was later adopted by Brahmānanda in \emph{Jyotsnā} 1.10.       
\end{philcomm}
%</cm10>
...
%?? MD: Pāda a: Read niścayād in place of sāhasād?; Pāda b: G2 reads tatvajñānātmadarśanāt and G1/D1/D3 tatvajñānātmadarśanaṃ (also the other components are in the nominative case in the latter mss). Perhaps the two terms tattvajñāna and ātmadarśana were compounded for metrical reasons and that has caused the confusion. It's just one letter different: tma -> cca/rtha
...
%?? MD: Shall we adopt the ε reading nipīḍya? The prefix ni- fits better than nis- and one of the source texts, Ahirbudhnyasaṃhitā, has nipīḍya too.
...
\begin{quote}
Pushing against both roots of the front teeth on the left and right with the tongue [\dots] — this fixation of the tongue has to be understood from the mouth of the teacher.
\end{quote}
...
\emph{Vasiṣṭhasaṃhitā} 1.73–1.75ab (50–52ab only), \emph{Yogayājñavalkya} 3.9–3.11ab (50–52ab only), \emph{Sūta\-saṃhitā} 15.7–8 (50–51 only)
...
And, as noted by Brahmānanda in \emph{Jyotsnā} 1.58, this idea also occurs in the \emph{Aṣṭāṅgahṛda\-ya\-saṃhitā} (\emph{Sūtrasthāna} 8.46cd–47ab): 
