...
Homage to the glorious Ādinātha who taught the system of Haṭhayoga, which shines forth like a stairway for one desirous of climbing to the lofty terrace of the royal palace.%??JM: would much prefer "science" to "system" (vidyā doesn't really mean system either). I changed "ladder" to "stairway" (a bit more poetic). I'd also prefer "which is like a glorious stairway for one..."
\end{translation}
...
Two manuscripts of the alpha and delta groups have the variant reading \emph{°virūpākṣaḥ savālikaḥ} (\getsiglum{N3,J5,V19}) for \emph{°virūpākṣabileśayāḥ}. In \getsiglum{N3}, \emph{savālikaḥ} was corrected to \emph{savālmikaḥ}, perhaps in an effort to restore a name similar to Vālmīki, the celebrated author of the \textit{Rāmāyaṇa}.
\end{philcomm}
...
\tl{kūrmāsanaṃ bhavedetaditi yogavido viduḥ || iti kūrmāsanam ||\\!}
\end{versinnote}
...
\begin{versinnote}
\tl{padmāsanaṃ tu saṃyojya jānūrvor antare karau |\\+}
\tl{niveśya bhūmau saṃsthāpya vyomasthaṃ kukkuṭāsanam || iti kukkuṭāsanam ||\\!}
\end{versinnote}
...
\tl{pragṛhya tiṣṭhet partivartitāṅgaḥ śrīmatsyanāthoditam āsanaṃ syāt~||\\+}
...
Śiva taught eighty-four \emph{āsana}s. I shall take the four best and teach them.
\end{translation}
...
\tl{guptāsanaṃ vadantyeke prāhur vajrāsanaṃ pare |\\+}
...
\tl{muktāsanaṃ vadanty eke prāhur guptāsanaṃ par ||\\!}
\end{versinnote}
...
\tl{manobhilaṣitaṃ yogyaṃ yogī bhojanam ācaret || iti ||\\!}
\end{versinnote}
...
\tl{mano'bhilaṣitaṃ yogyaṃ yogī bhojanamācaret ||\\!}
\end{versinnote}
