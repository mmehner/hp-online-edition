...
The Vedas, Shastras and Puranas are like common prostitutes. \emph{Śām\teimute{\-}bhavī mudrā} is unique and guarded like a woman of a good family.
\end{translation}
%</tr5>
...
The focus is internal, the gaze external, unblinking: this is the \emph{śām\teimute{\-}bhavī mudrā} concealed in all the Tantras.%
...
\emph{Haṭharatnāvalī} 4.30, \emph{Yogacintāmaṇi} f.\,75r (\attr HP), \emph{Yuktabhavadeva} 7.220 (\attr Gorakṣa\teimute{\-}nātha), \emph{Haṭha\teimute{\-}tattva\teimute{\-}kaumudī} 14.26 (\attr HP)
% \begin{versinnote}
...
On the position of these verses (4.9–11) in the various recensions of the text, see the introduction p.\,\hpref{75}.\lb
...
Seated in the pose of the liberated ones, the yogi should adopt \emph{śāṃ\teimute{\-}bhavī mudrā} and, with his mind one-pointed, listen to the inner sound in his right ear.
\end{translation}
%</tr13>
...
We have translated \emph{kāhala} as ‘trumpet’ on the basis of e.g.~\emph{Viśvalocanakośa}, \emph{lāntavarga} 161 (\emph{dhvaninālā tu vīṇāyāṃ veṇukāhalayor api}), but it can also mean a type of drum (see e.g.~\emph{Śabda\teimute{\-}kalpadruma} s.v. \emph{kāhala}, where it is said to be a \emph{bṛhaḍḍhakkā}, a big drum).%whose mouth looks like a datura flower. NWS: "a musical instrument; a trumpet. EI 24 (Index) (Sircar 1966: 138)".
...
On \emph{pakṣaccheda} in alchemical processes of immobilizing mercury and for references in Rasa\teimute{\-}śāstra, see \textsc{Hellwig} 2009: 276–278.
...
\emph{Yogacintāmaṇi} f.\,26v (\attr HP), \emph{Haṭhasaṅketacandrikā} 123v–124r (\attr HP), \emph{Saubhāgya\teimute{\-}lakṣmyupaniṣad} 4
\begin{variants}
    śravaṇamukhanayananāsānirodhanaṃ naiva kartavyaṃ~] śravaṇapuṭanayananāsāpuṭarodhanaṃ kāryam YCM, śravaṇapuṭanayanayugalanāsāmukharodham eva kartavyaṃ HSC,  śravaṇa\teimute{\-}mu\teimute{\-}kha\teimute{\-}nayananāsānirodhanenaiva SLU\sep
...
\begin{variants}
    vātaprabaddhaḥ~] vātaprabandhaḥ CA, ghātaprabuddhaḥ CA\vl, vāyuḥ prabuddhaḥ CA\vl, vāta\teimute{\-}prabuddhaḥ CA\vl\sep
...
\emph{Haṭhasaṅketacandrikā} f.\,108r (\attr HP), \emph{Yoga\teimute{\-}śikho\teimute{\-}paniṣat} 6.17cd–18ab
\begin{variants}
...
\begin{variants}
adhvastayoś cendriyavargabuddhir~]  adhvastayoḥ svendriyavargavṛddhir YCM, adhvastayor indri\teimute{\-}ya\teimute{\-}vargavṛttir HTK
\end{variants}
...
\emph{Yuktabhavadeva} 11.30 (\attr Gorakṣanātha), \emph{Haṭhasaṅketacandrikā} f.\,117v (\attr Viśva\teimute{\-}rūpā\teimute{\-}cārya)
\begin{variants}
