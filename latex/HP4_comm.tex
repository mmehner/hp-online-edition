...
Who indeed truly knows the majesty of Rājayoga? From knowledge, liberation †arises† [and] power (\emph{siddhi}) is obtained by means of the guru's teaching.
\end{translation}
...
%?? JB. Rather than emend to muktiḥ sthitā, I think we should consider muktisthitiḥ (etaTwo and deltaOne), which is similar to jīvanmuktasthitiṃ in the Mokṣopāya, LYV, MSS, etc. We could translate it as Sternbach below ('state of liberation'). JM: I also don't think we should emend. muktisthitiḥ is possible (but MU parallel not great because of mukti vs mukta). We could also consider muktiḥ sthitiḥ “liberation [and] stability”
% Mokṣopāya
% jīvanmuktasthitiṃ brahman kṛtvā rāghavam āditaḥ|\\
% kramāt kathaya me nityaṃ bhaviṣyāmi sukhī yathā||\,1||
%  "jīvanmuktasthitiṃ" jīvanmuktamaryādāṃ
% Yogavāsiṣṭha
% vicārajā nijā jīvanmuktasthitir ihoditā |
% muninābhyāsahīnasya vyādhasya tvanavasthitiḥ || VII. 
% MSS_9744-1 
% kāryākārye kim api satataṃ naiva kartṛtvam asti  
% jīvanmuktasthitir avagato dagdhavastrāvabhāsaḥ /<BR>
% There is not always an agent in every action, good or bad ; for, the state of a jivanmukta [one who is released from bondage while living in the world] is considered to be similar to that of the splendour of a burnt cloth [which can neither be clean nor dirty]. (Sternbach's translation)
\end{philcomm}
...
%It appears that this verse, which is in manuscripts of the \textbeta\ and \textepsilon\ groups, has become corrupt in manuscripts of \textgamma\, perhaps because of eye-skip (i.e., \emph{amano nirmanāḥ śūnyaṃ jagad etac carācaram}).
%?? JB should we include this note on gamma's omission? Is it necessary? JM: no, I've percented it
...
\end{translation}
% ?? JB: we didnt translate this verse in the workshop. I've adapted my translation from a similar verse in the Amaraugha. JM: equanimity is tautologous with mind, “When equanimity has been obtained"? Also I've changed tr. to reflect tadā.
...
%\end{philcomm}
%?? MD: adopt prayāti (beta) in Pāda C?
...
\end{translation}
%?? JB: Both \alphaOne and \alphaTwo have atha samādhiḥ as a heading before this verse. Shouldnt we include this in our edition or at least note it in the apparatus? We've added atha headings elsewhere from alpha. There's also the issue of where to place atha samādhi in relation to the greyscale verses.
...
\end{translation}
%?? JB: 'in another doctrine' for matāntare?
%?? JB: extraordinary bliss (kaścid?)
...
% ?? MD: comment on the variant reading "manaḥprāṇalayānando mayi kaścit pravartate"?
% JB: maybe this is the lectio difficilor and the first person pronoun was later written out. 

%%%%%%%%%%
\subsection*{4.2}
\begin{translation}[hp04_002]
A motionless and unchanging dissolution [of mind], in which inhalation and exhalation have disappeared [and] perception of sense objects has ceased, is supreme for yogis.%??JM: or "The yogis’ motionless and unchanging dissolution... is the best."
\end{translation}
% on the translation of jayati as an intransitive verb, see Alexis' footnote on jayati in his forthcoming book on the Tantrāloka āhnika 1 
...
pranaṣṭo śvāsa°ḥ Pc,
prāṇastho śvāsa° Pb,
pranaṣṭe svāsa° K}\\!} % retained because we've read against alpha.??jM: simplify? It's only the ucch that's different. JB: done.
...
%layo jayati yoginām Cc}\\!} %retained to show that jayati was in the South Indian transmissin of the Amanaska.??JM: but it's in almost all HP witnesses too so perhaps variants not needed here, just mention it in comm? Or simplify? JB done
\end{versinnote}
\end{sources}
...
May an extraordinary absorption prevail, in which all volition has been cut off and all activity ceased, intelligible [only] by means of itself and ineffable.%??JM: which is intelligible > intelligible, and other tweaks. Prevail not great but can't think of anything else. 
...
Dissolution, which is eternal in the elements and senses, takes place where the gaze is. The gaze that has dissolved into the focus becomes the power of living beings.%%??JM: changed meditative focal point to focus (as tr. in v.6)
%JB 'occurs' for 'takes place'
\end{translation}
...
% ?? Consult Shaman's critical edition.
\end{versinnote}
\end{sources}
...
The focus internal, the gaze external, unblinking: this is the \emph{śāmbhavī mudrā} concealed in all the Tantras.%??JM: tr. tweaked
% JB my preference would be: The focus is internal [yet] the gaze is external and free from blinking.  
\end{translation}
...
%\tl{\var{unmanīkārakaḥ kṣaṇāt ] Bb Tha W Vd Pe: unmunikārakakṣaṇāt Uc: unmanīkāraṇaṃ kṣaṇāt Cc: unmanākāśakaḥ kṣaṇāt Ad Ca: unmanākāśakakarṣaṇāt Cb}\\!}%?? variants needed? JB I've deleted the variants for the last pāda but we need those on unnamayed (see below) 
\end{versinnote}
\end{sources}
...
%MD: Better to adopt unnamayed and kārakaḥ kṣaṇāt?
% ?? JB Since unnamayed in the beta witnesses and source, and makes better sense, I think we should adopt. The dictionary states that uc-cal means 'to go or move away from; to free or loosen one's self from', which is not so good here.
...
Some are confused by a multitude of [tantric] texts, some by a mass of vedic texts and some by reasoning. They do not know what causes one to cross over.%??JM: put Tāraka and explain in note? Tārakayoga is mentioned in the previous note.
% JB in the source 
\end{translation}
% Maybe grey scale
...
% ??JB we should adopt nigama in pāda b because it is attested by several manuscript groups and the source.
\end{philcomm}

%%%%%%%%%%
\subsection*{4.8*3}
\begin{translation}[hp04_008_3]
...
\begin{sources}[hp04_008_3]
\emph{Candrāvalokana} 3
\begin{versinnote}
\tl{ardhotghāṭitalocana[ḥ] sthiramanā nāsāgradattekṣaṇaś\\+}
...
\end{philcomm}
% ?? MD: I have changed the verse order according to the epsilon group. Please adjust the commentary. JB Done
...
% \begin{versinnote}
% \tl{pātāle yad viyati śikhare merumūle tad asti\\+}
% \tl{tattvaṃ caitat pravadati sudhīs sammukhe nimnagānām |\\+}
% \tl{candrāt sāraṃ sravati vapuṣas tena mṛtyur narāṇāṃ\\+}
% \tl{taṃ badhnīyāt svakaraṇamṛdā nānyathā kāyasiddhiḥ ||\\!}
% \end{versinnote}
...
% \tl{badhnīyāttat sukaraṇam atho nānyathā kāyasiddhiḥ ||\\!}
% \end{versinnote}

% \emph{Haṭhatattvakaumudī} 14.26 (attr.~to the \emph{Haṭhapradīpikā})
% \begin{versinnote}
% \tl{pātāle yadvitatasuṣiraṃ merumūle tad asmin\\+}
% \tl{tadvac caitat pravadati sudhīs tanmukhaṃ nimnagānām |\\+}
...
%?? JM: nirodhataḥ reading much better. Early corruption?
% JB I think we should note nirodhataḥ as the better reading in the comments but adopt divārātrau (or divārātraṃ) na pūjayet (he should not worship at day and night (i.e., when prāṇa is moving in the sun and mmoon channels)). 
%\end{philcomm}
...
\end{translation}
% ?? compound khecarīmudrā in 4.8*8c and 4.8*9c?

%\begin{sources}[hp04_008_8]
%\end{sources}
...
% %\emph{Skandapurāṇa} 4.41.45%??JM: is it worth putting this in? Verse is prob found all over the place and this isn't the old SP. Just YCM will do.
% %\begin{versinnote}
...
%\begin{sources}[hp04_008_13]
%\end{sources}

\begin{testimonia}[hp04_008_13]
\emph{Yogasārasaṅgraha} p. 61 (attrib. Praṇavacintāmaṇi)
\begin{versinnote}
\tl{sā mayā viditā yā māyā sākṣācchivavallabhā |\\+}
\tl{pūrayen mārutaṃ divyaṃ suṣumnā paścime mukhe ||\\!}
\end{versinnote}
\end{testimonia}

\begin{philcomm}[hp04_008_13]
The referent of \emph{mayā} is unspecified and no source text has been identified. It most probably refers to a goddess.%to understand here because the referent of \emph{mayā} is not known. If it refers to a yogi, then it might mean that \emph{suṣumnā} has been pierced. Otherwise, if \emph{udbheditā} means `brought forth', one would assume the speaker to be a god or goddess. 
\end{philcomm}
...
\end{translation}
%?? JB: pada here means place/site (level sounds strange)
% abode of Śiva ... that place should be known

%\begin{sources}[hp04_008_16]
%\end{sources}
...
%?? Write a note about epsilon 3 vyomacakram vyavasthitaṃ: Cf.~the greyscale verse in 3.35.
\end{philcomm}

%%%%%%%%%%
\subsection*{4.8*18}
\begin{translation}[hp04_008_18]
...
%\begin{testimonia}[hp04_008_18]
%\end{testimonia}

%\begin{philcomm}[hp04_008_18]
%\end{philcomm}
...
%\textit{Maitrī Upaniṣad} 6.1-2 might provide a clue to the meaning of \emph{sūryāṅga}. This Upaniṣad explains that the \textit{ātman} manifests itself in two ways: as \textit{prāṇa} internally and as the sun externally. \textit{Prāṇa} is identified as the inner aspect of the \textit{ātman}. It is associated with breath, etc. The sun is depicted as the external manifestation of the \textit{ātman}. It symbolizes the cosmic source of energy, etc. The text emphasizes that the movements of \textit{prāṇa} and the sun are synchronized and states that the golden \textit{puruṣa}, who dwells in the sun, also resides in the heart as \textit{prāṇa}. If one is willing to accept a connection between this verse and the concept mentioned in the \textit{Maitrī Upaniṣad}, then \textit{sūryāṅge} possibly has even two layers of meaning. On the microcosmic level, \textit{prāṇa} would return home to the heart. Moreover, on the macrocosmic level, the \textit{ātman} would return to its macrocosmic home - the sun.
% ?? Does sūryāṅge occur in the Maitrī Upaniṣad? If not, the connection with this Upaniṣad seems tenuous. 
\end{philcomm}

%?? MD: yadā (epsilon) or yathā (beta)?
% JB separate yadā līnaḥ in the edition (yadā seems easier to understand than yathā)
...
\end{versinnote}
\end{testimonia}
%??JM: I can't find these HSC refs
...
%%%%%%%%%%
\subsection*{4.8*21}
\begin{translation}[hp04_008_21]
[The yogi] should flood the body with nectar from the soles of the feet to the head. He is sure to become perfected, with a great body and great strength and valour.\\Thus ends \emph{khecarī}.
\end{translation}

%\begin{sources}[hp04_008_21]
%\end{sources}
...
\emph{Uttaragītā} 1.9%??JM: bibliog for texts cited — where?
\begin{versinnote}
...
%\begin{philcomm}[hp04_008_23]
%?? Pāda c: sarvaṃ or ātmānaṃ?
%\end{philcomm}
% J up to here! 11 March

%%%%%%%%%%
\subsection*{4.8*24}
\begin{translation}[hp04_008_24]
Like an empty pot in air, [the yogī] is empty on the inside and empty on the outside. Like a full pot in the ocean, [the yogi] is full on the inside and full on the outside.%??JM: I changed the sky to air. Not sure, but I don't think we are meant to think of a pot floating in space.
\end{translation}
...
%\begin{testimonia}[hp04_008_26]
%\end{testimonia}

%\begin{philcomm}[hp04_008_26]
%\end{philcomm}
...
%\begin{philcomm}[hp04_008_27]
%?? pāda c: hi better. Not in HP sources only HR. Adopt?
%\end{philcomm}
...
%\begin{sources}[hp04_008_32]
%\end{sources}

%\begin{testimonia}[hp04_008_32]
%\end{testimonia}

%\begin{philcomm}[hp04_008_32]
%\end{philcomm}
...
Homage to Suṣumṇā, to Kuṇḍalinī, to the nectar arising from the moon, to the mind beyond mind state, to you whose nature is consciousness, the great Śakti.%?? or whose nature is the consciousness of the great Śakti? JM: I have forgotten how we are writing nāḍīs etc. I like how we have everything here.
\end{translation}

%\begin{sources}[hp04_008_33]
%\end{sources}

%\begin{testimonia}[hp04_008_33]
%\end{testimonia}

%\begin{philcomm}[hp04_008_33]
%\end{philcomm}
...
%\begin{sources}[hp04_008_34]
%\end{sources}

%\begin{testimonia}[hp04_008_34]
%\end{testimonia}

%\begin{philcomm}[hp04_008_34]
%\end{philcomm}
...
The twelve and a half million methods of dissolution taught by  glorious Śiva are victorious. We think only the singular concentration on the inner sound is the most venerable of [all] the dissolutions.%??JM: How about "Glory to..." instead of "are victorious"? And then ""We consider one of the dissolutions in particular to be especially worthy of honour, concentration on the inner sound."
\end{translation}
...
Having become intent on indifference through regular practice, the ascetic should immediately concentrate on nothing but the inner sound, which brings about the [state] beyond mind.%??JM: sadyas is odd. Apparently it has an archaic meaning of "daily". Consider? Immediately doesn't make sense. Or take it with unmanīkaraṇam. And sadābhyāsena could go with avadhārayet.
\end{translation}
...
\begin{versinnote}
\tl{audāsīnyaparo bhūtvā sadābhyāsena saṃyamī |\\+}
\tl{unmanīkārakaṃ sadyo nādam eva sadābhyaset ||\\!}
\end{versinnote}
...
\begin{versinnote}
\tl{audāsīnyaparo bhūtvā sadābhyāsena samyamī |\\+}
...
\emph{Amaraugha} 34
\begin{versinnote}
\tl{ārambhaś ca ghaṭaś caiva paricayaḥ prakīrtitaḥ |\\+}
\tl{niṣpattiḥ sarvayogeṣu cetasas tasya bhūmikāḥ ||\\+}
\tl{\var{paricaryaḥ prakīrtitaḥ Ga :
tathā paricaya samṛtaḥ Ae (\textit{unmetr.}) :
pracayaś ca tritīyakaḥ Ad Gb :
pracayaś ca tṛtīryakaḥ  Ba :
pracayaṃ ca tritīyakaṃ  Ta}\\+}
\tl{\var{cetasas tasya bhūmikāḥ ] $\beta$ : yogāvasthā caturvidhā $\theta$}\\!}%?? variants necessary?
\end{versinnote}
...
\end{translation}
%?? MD: better to adopt "tatra ārambhaḥ"? The first component is often introduced with "tatra" after the enumeration in the important mss.
...
\tl{\var{°granthes tathā ] Ga : °granthes tato Ae : °granther bhaved Ba Gb Ta : °granthir bhaved Ad}\\+}
\tl{\var{bhedād ] Ga : bhedāt Ae : vedhād Ba Gb Ta : vedhā Ad}\\!}%?? variants needed?
\end{versinnote}
\end{sources}
...
In the beginning [stage], which is [the first phase of] voidness and in which the heart is full [of bliss], one becomes a yogi with a divine body, splendour, a divine smell and freedom from disease.%?? space after śūnye in edition. ?? JM:  With a divine body, radiant, smelling heavenly, free from disease [and] his heart full [of bliss], in the void in the beginning [stage] the practitioner attains yoga.
\end{translation}
...
Then, as a result of the piercing of the knot of Viṣṇu there is a hint of supreme bliss in total emptiness (\emph{atiśūnye}), and then the pounding sound of a \textit{bherī} drum occurs.%?? in ed join śabdas and tadā
\end{translation}
...
In the third [stage], having pierced [the knot of Viṣṇu], the sound of a \textit{mardala} drum arises in the sky. Then [the yogi] reaches the great void, the abode of all supernatural powers.%?? vihāyas = sky, not void so I've changed tr.
\end{translation}
%
...
%?? MD: Pāda c - tathā (Gr2) to be changed to tato (Gr3) or tadā (alpha*,V3,Jyo)? JM: tadā is good and tr. already translates that way
\end{philcomm}
...
\tl{\var{sarva° ] Ae : sarvaṃ Ga : sattva° $\theta$}\\+}
...
The reading we have adopted for the fourth \emph{pāda}, \emph{kvaṇadvīṇākvaṇo}, Birch’s conjecture in his edition of the \emph{Amaraugha} is supported by several testimonia and \emph{Amṛtasiddhi} 31.2, where it is said that the sound of a \emph{vīṇā} arises in the fourth stage.
...
Then the mind having become one [with the sound??] is called Rājayoga. That yogi becomes a creator and destroyer, an equal to god.%??see note
\end{translation}
...
%??SS: Then the mind becomes one. This is called Rājayoga. JM: looks best to me

%??JM: yogīśvarasamo = equal to a yogi sovereign? Odd to take asau with yogī.
\end{philcomm}

%%%%%%%%%%
\subsection*{4.24*1}
%\begin{translation}[hp04_024_1]
%\end{translation}

%\begin{sources}[hp04_024_1]
%\end{sources}

%\begin{testimonia}[hp04_024_1]
%\end{testimonia}
...
I consider those who are ignorant of Rājayoga and engage in only Haṭha to be labourers who get no reward for their efforts.%??JM: farm labourers? ploughmen? It would be good to get the agricultural meaning in.
\end{translation}
...
The reading \emph{smṛtam} is also possible and well-attested (groups 2 and 3).%??JM: not in apparatus.
...
Rājayoga, samādhi, unmanī, manonmanī, amaraugha, advaita, nirālamba, nirañjana...%?? format. Italic? Capitals?
\end{translation}
...
\tl{tatvaṃ paramasākhyaṃ vā nādopāsanam eva vā  ||\\!}
\end{versinnote}
\end{testimonia}
...
\begin{sources}[hp04_032_1]
\emph{Tantrāloka} 32.64
\begin{versinnote}
...
\tl{kāṣṭhavajjñāyate deha unmanyāvasthayā dhruvam |\\!}
\end{versinnote}
\end{testimonia}
...
\tl{mṛtavattiṣṭhate yogī sa mukto nātra saṃśayaḥ ||\\!}
\end{versinnote}
\end{testimonia}

%\begin{philcomm}[hp04_032_3]
...
%\begin{testimonia}[hp04_032_4]
%\end{testimonia}

%\begin{philcomm}[hp04_032_4]
%\end{philcomm}
...
\begin{versinnote}
\tl{cittaṃ na suptaṃ no jāgrat smṛtiman na ca nānyathā |\\+}
\tl{nāstam eti na codeti yasyāsau mukta eva sa ||\\!}
\end{versinnote}
\end{sources}
...
\tl{niśvāsocchvāsahīnaśca niścitaṃ mukta eva saḥ || 11 ||\\!}
\end{versinnote}

\emph{Yuktabhavadeva} 1.64
\begin{versinnote}
\tl{svapnajāgradavasthāyāṃ suptavat yo 'vatiṣṭhate |\\+}
\tl{niśvāsocchvāsahīnaś ca niścitaṃ mukta eva saḥ ||64||\\!}
\end{versinnote}

\emph{Haṭhatattvakaumudī} 55.24
\begin{versinnote}
\tl{sadā jāgradavasthāyāṃ suptavad yo ‘vatiṣṭhate |\\+}
...
\tl{niḥśvāsocchāsahīnaśca niścitaṃ mukta eva saḥ|\\!}
\end{versinnote}
\end{testimonia}

%\begin{philcomm}[hp04_032_8]
%\end{philcomm}

%%%%%%%%%%
\subsection*{4.33}
\begin{translation}[hp04_033]
Only the glorious guru lord knows the unique ineffable bliss that has arisen in the hearts of yogi lords who experience \textit{samādhi} by concentrating on the inner sound.
\end{translation}
...
%adopt sthirīkuryād [MD: Done.]%??JM: remove space after sthirī  in ed.
...
%aṅguṣṭābhyām ubhe śrotre tarjanībhyāṃ vilocane
%nāsārandhre ca madhyābhyām anāmābhyāṃ mukhaṃ dṛḍham 5.36
...
%etadabhyāsayogena jitvā samyag guṇān bahūn
...
Or, the mind should filter out the gross sound for the subtle, or the subtle for the gross, or, abandoning both, be [focused] on [a sound in] the middle, [and the] should not move it elsewhere.%??JM: here gross and subtle do seem to make more sense
\end{translation}
...
\tl{manaḥ pākam avāpnoti nirālambākhyaghoṭanam ||\\!}
\end{versinnote}

\emph{Haṭhatattvakaumudī} 54.42
\begin{versinnote}
\tl{baddhaṃ viyuktaṃ cāpalyaṃ nādagandhakajāraṇāt |\\+}
\tl{manaḥ pāradam āpnoti nirālambākhyakheṭakam ||\\!}
\end{versinnote}
\end{testimonia}
...
\tl{sa pātrastho 'gnisaṃtapto na gacchati kathañcana ||16.52||\\+}
...
%V15 antaraṅgaturaṅgasya nādo vyādhāyate pi ca
...
%B - dhvaner antargataṃ jñeyaṃ jñeyasyāntargataṃ manaḥ (N3?,Jyo) JM: the second I think
\end{philcomm}
...
\emph{Haṭhasaṅketacandrikā} f.~235r–235v
\begin{versinnote}
...
Blocking of the ears, mouth, eyes, and nose should not be performed [when] a clear inner sound is heard distinctly in the purified Suṣumṇā channel.%?? negative in first line? Adopt naiva?
\end{translation}
...
%??V15 reading for the third pāda is better than N19.
%\end{philcomm}
...
%There are thousands of Crores of resonances and thousands of crores of sonic matter (bindu). All dissolve into where the spotless god exists.
%?? tr. the spotless god, Nirañjana. ? and in previous
\end{translation}

%\begin{sources}[hp04_052_4]
%\end{sources}
...
\tl{sarve tatra layaṃ yānti yatra devo nirañjana iti ||\\!}
\end{versinnote}
...
%%%%%%%%%%
\subsection*{4.52*5}
%\begin{translation}[hp04_052_5]
%\end{translation}

%\begin{sources}[hp04_052_5]
%\end{sources}

%\begin{testimonia}[hp04_052_5]
%\end{testimonia}
...
\tl{tāvat sarvaṃ vadati yad idaṃ dambhamithyāpralāpa iti\\!}
\end{versinnote}
...
\emph{Upāsanāsārasaṅgraha} p.~31 (attributed to the \emph{Candrāvalokana})
\begin{versinnote}
...
\emph{Haṭhasaṅketacandrikā} f.~107v–108r
\begin{versinnote}
\tl{jñātvā suṣumnāsadbhedaṃ kṛtvā vāyuṃ ca madhyagam |\\+}
...
%??ghrāṇarandhra is too well supported to ignore, but the meaning is difficult to construe. JM: it's in alpha etc., why not adopt it? vāyum is object in pādas bcd.
%\end{philcomm}
...
\emph{Yogayājñavalkya} 4.32cd–33
\begin{versinnote}
\tl{iḍāyāṃ piṅgalāyāṃ ca carataś candrabhāskarau ||\\+}
...
%??JM: rajasic and tamasic not in Eng dictionary, "associated with the \emph{rajas guṇa}" ?
%\end{philcomm}
...
\emph{Yogacintāmaṇi}
\begin{versinnote}
\tl{tāv eva dhattas sakalaṃ kālaṃ rātriṃ divātmakam |\\+}
\tl{bhoktrī suṣumṇā kālasya guhyam etad udāhṛtam ||\\!}
\end{versinnote}

\emph{Haṭhasaṅketacandrikā} (check in ms. no. 2244)
\begin{versinnote}
\tl{tathā coktaṃ haṭhapradīkāyāṃ–\\+}
\tl{sūryācandramasau dhattaḥ lagnaḥ kāla rātridinātmakaṃ ||\\+}
...
\begin{versinnote}
\tl{sūryā[c]andram asau kṛtvā viditvā karapaṃjare [|] \\+}
...
%Consider °nāḍīnāṃ dehapañjare ??JM: probably a patch?
\end{philcomm}
...
\tl{bodhayitvā suṣumnāyāṃ praviśed avirodhataḥ ||\\!}
\end{versinnote}
\end{sources}
...
The mind has two impulses: past impression (\emph{vāsanā}) and the breath. When one of those two disappears, both soon disappear.%??JM: tr. vāsanā as plural? Any better ideas?
\end{translation}
...
%JM?? do we need this note? I think it's about something other than samādhi.
...
%Brahmānanda understands this verse as referring to specific locations into which the breath and mind dissolve, rather tha"when... then...".
%HI: tatra = tāvat.
\end{philcomm}
...
\emph{Yogacintāmaṇi} (attributed to the \emph{Rājayoga})
\begin{versinnote}
...
\emph{Haṭhatattvakaumudī} 16
\begin{versinnote}
\tl{dṛṣṭiḥ sthirā yasya vinaiva dṛśyād\\+}
\tl{vāyuḥ sthiro yasya vinā prayatnāt |\\+}
\tl{cittaṃ sthiraṃ yasya vinā'valambāt \\+}
\tl{sa eva yogī sa guruḥ sa sevyaḥ ||\\!}
\end{versinnote}
\end{testimonia}
...
\begin{versinnote}
\tl{sarve layahaṭhābhyāsā rājayogasya siddhaye |\\+}
...
%\begin{sources}[hp04_074_1]
%\end{sources}

%\begin{testimonia}[hp04_074_1]
%\end{testimonia}

%\begin{philcomm}[hp04_074_1]
%\end{philcomm}
...
%\begin{sources}[hp04_074_2]
%\end{sources}

%\begin{testimonia}[hp04_074_2]
%\end{testimonia}

%\begin{philcomm}[hp04_074_2]
%\end{philcomm}
