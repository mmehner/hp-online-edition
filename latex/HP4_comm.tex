...
Who indeed truly knows the majesty of Rājayoga? From knowledge, liberation is established [and] power (\emph{siddhi}) is obtained by means of the guru's teaching.
\end{translation}
...
%%%%%%%%%%
% \subsection*{4.8*21 ending}
% iti khecarī/
% \begin{translation}[hp04_008_21p]
% \end{translation}

% \begin{philcomm}[hp04_008_21p]
% \end{philcomm}
...
%%%%%%%%%%
% \subsection*{4.33_8 heading}
% atha viśrāntiḥ/
% \begin{translation}[hp04_033_8a]
% \end{translation}

% \begin{philcomm}[hp04_033_8a]
% \end{philcomm}
...
\end{translation}
% JB: Perhaps a note is needed on yogīśvara (here or 4.24). Brahmānanda takes yogīśvarāḥ as yogiṣu yogayukteṣu īśvarāḥ samarthāḥ. i.e., 'lords among yogis' or perhaps 'adepts among yogis'?
...
\end{translation}
% ?? JB: we have not translated antaraṅga° in pāda a. Change to 'trapping the inner deer that is the mind'?
...
\emph{Uttaragītā} 41cd–42 %(source) JB: I think we can say that the UG is the source of 4.49*1 (but not 4.49)
\begin{versinnote}
...
%B - dhvaner antargataṃ jñeyaṃ jñeyasyāntargataṃ manaḥ (N3?,Jyo) JM: the second I think the second. J
...
% N3 (α1)
% anāhatasya śabdasya tasya śabdasya ca dhvaniḥ |
% dhvaner aṃtargataṃ jñeyaṃ yasyāṃ tv aṃtargataṃ manaḥ |
% tan mano vilayaṃ yāṃti tadviṣṇo paramaṃ padaṃ |
...
%V15 reading for the third pāda is better than N19. JB: If we adopt the epsilon 3 (V15) for the third pāda, then we have to adopt tad unmany eva śiṣyate in the fourth (otherwise 4th pāda is unmetrical with evāvaśiṣyate). 
%\end{philcomm}
...
Complementing his understanding of the previous verse, Brahmānanda has \emph{yato\dots tatra} in 4.67cd, taking it to mean \emph{yatra\dots tatra} and to be referring to cakras.
\end{philcomm}
