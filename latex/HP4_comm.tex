...
%MD??: It seems to be better to adopt the plural reading "yānti ... parāyaṇāḥ", as most of the ε and π mss support this.
...
The greyscale verses at the beginning of chapter four are found in all collated manuscripts except those of the \textalpha\ group. These verses appear to have been added at an early stage in the transmission of the \emph{Haṭhapradīpikā} in order to create a new opening for this chapter. The revised beginning opens with a \emph{maṅgala} verse of the kind typically found at the start of a text. The second verse, which is from the \emph{Gorakṣaśataka}, introduces the topic of \emph{samādhi}. In this expanded version, two verses listing the synonyms of \emph{rājayoga} then follow. In the \textalpha\ group, however, these verses are placed at 4.32–33, and some manuscripts, such as \piTwo, place them at both locations. Although the remaining additional verses relate to various themes within chapter four, when they are read together they constitute a a loosely organised collection on \emph{samādhi}, \emph{rājayoga}, the importance of the guru, the dissolution of the breath, Suṣumṇā, and related topics.\lb 

In contrast to this revised opening, the \textalpha\ group begins with a cohesive discusson on absorption (4.1–3) that transitions to the gaze (4.4) and a brief discussion of \emph{śāmbhavī} and \emph{khecarī mudrā}s (4.5–4.8). The main topic of the chapter, which is meditating on the internal sound (\emph{nādānusandhāna}), begins at 4.12 in the \textalpha\ group (whereas in other groups it begins after fifty or so verses). The emphasis on \emph{nādānusandhāna} in the fourth chapter of the \textalpha\ group is consistent with the statement in verse 1.56 that \emph{nādānusandhāna} is the fourth component of Haṭhayoga.\lb
...
\begin{variants}
  ko vā\,] ko hi YCM\sep
  jñānān muktiḥ sthirā siddhir\,] tajjñānī vasate yatra YCM
  guruvākyena labhyate\,] sadeśaḥ puṇyabhājanam YCM %?? MD: sa deśaḥ?
\end{variants}
\end{testimonia}
%</ts0-5>
...
The \emph{Rasārṇava} is the likely source of this verse given the vocative, \emph{bhairavi}. Similar verses are found in other yoga texts (see \textsc{Mallinson and Szántó} 2021: 57).\lb
...
\begin{variants}
  ...
  jīvabhūtānāṃ\,] sarvabhūtānāṃ CA, jīvabhūtā hi KJN (\emph{conj.} Hatley), jīvabhūtāni KJN\vl
\end{variants}
\end{sources}
%</sc4>
...
See \textsc{Birch} 2013: 286 for more parallel verses.
\end{philcomm}
%</cm5>
...
As seen in the witnesses of the \emph{Amanaska}, which is the source of this verse, the spellings \emph{lakṣya} and \emph{lakṣa} occur randomly across the manuscripts. See \textsc{Birch} 2013: 287 for more parallel verses.
\end{philcomm}
%</cm6>
...
% MD: abhedataḥ "Because there is no difference ..."
...
On the position of these verses (4.9–11) in the various recensions of the text, see the introduction p.\,\hpref{77}.\lb
...
\end{versinnote}
With the help of other manuscripts (in particular K\textsubscript{1} of the \textgamma\ group), the above can be emended and understood as follows:
\begin{versinnote}
\tl{yat prāleyaṃ pihitasuṣiraṃ merumūrdhny asti tathyaṃ/ \\+}
\tl{tasmiṃs tattvaṃ pravadati sudhīs tan mukhaṃ nimnagānām//\\!}
\end{versinnote}
\begin{appinnote}
\tl{suṣiraṃ K\textsubscript{1}\,] sukhire \alphaTwo\ \ \textbullet\ \ %
mūrdhny P\textsubscript{8}\,] mūle \alphaTwo\ \ \textbullet\ \ %
asti tathyaṃ K\textsubscript{1}\,] yad astī \alphaTwo \\!}
\end{appinnote}
\begin{quote}
...
% MD: divārātrau ca varjayet G3,G7
\end{philcomm}
%</cm11-4>
...
The \emph{mudrā} situated in the \emph{cakra} of the void (\emph{vyomacakra}) in the middle of the moon and sun on an unsupported surface is [the \emph{mudrā}] called \emph{khecarī}.
\end{translation}
%</tr11-9>
...
% \end{versinnote}
\begin{variants}
  somasūryadvayor USS\,] sūryacandramasor GSS\sep
...
The \emph{vyomacakra} (‘the \emph{cakra} of the void’) is also mentioned in a verse added to some later recensions of the \emph{Haṭhapradīpikā} (see 3.34*1), which states that \emph{vyomacakra} is another name for \emph{khecarīmudrā}. This verse derives from a passage in the \emph{Jñānasāra} (2.1–5) that discusses \emph{khecarī}, as well as contracting the throat (cf. the \emph{jālandhara} lock), in relation to three \emph{cakra}s; \emph{vyomacakra}, \emph{madhyacakra}, and \emph{mūlacakra}. For further discussion, see the commentary on 3.69.\lb

In \emph{Jyotsnā} 4.45, Brahmānanda states that the \emph{vyomacakra} is associated with all the voids in the middle of the brow (\emph{bhrūmadhye sarvakhānāṃ samanvayāt}) and, in the \emph{Haṭhasaṅketacandrikā} (f.\,129v), Sundaradeva says that it is called the Brahmarandhra, which is between Iḍā and Piṅgalā (\emph{iḍāpiṅgalāntargataṃ brahmarandhrākhyaṃ vyomacakraṃ tat khecarīmudrāṃ śaktiṃ kuryād ...}). %See above, \pageref{vyomacakra}.
% ??JB: please check
...
%<*cm11-14>
\begin{philcomm}[hp04_011_14]
On the \emph{vyomacakra}, see X4.49.
\end{philcomm}
%</cm11-14>
...
\dummy[The yogi] should [put] the mind in Śakti and Śakti in the mind, observe the mind with the mind, and meditate on it as the supreme state.
\end{translation}
%</tr11-19>
...
% \end{versinnote}
\begin{variants}
manaso hy unmanī\,] manasas tūnmanī YCM
...
The cultivation of the inner sound taught by Gorakṣanātha [and] approved even for foolish people unable to understand the highest reality is [now] taught.
\end{translation} %
%</tr11-31>
...
Seated in the pose of the liberated ones, the yogi should adopt \emph{śāmbhavī mudrā} and, with his mind one-pointed, listen to the inner sound in his right ear.
\end{translation}
%</tr13>
...
On \emph{caupaṭī} in the first \emph{pāda}, \textsc{McGregor} (1994: s.v.) and \textsc{Callewaert} (2009: s.v.) in their dictionaries of modern and old Hindi both give the meaning “open all around” for \emph{caupaṭ}. McGregor derives it from Sanskrit \emph{catuṣpaṭṭa}. Molesworth (1857: s.v.) in his Marathi dictionary gives “A quadrangular expanse or space, esp.~as open and extended: also a broad and level tract” for \emph{caupaṭṭā}.\lb
...
On these four stages, see \textsc{Birch} 2019: 968–969; \textsc{Mallinson and Szántó} 2021: 19–20.
\end{philcomm}
%</cm19>
...
In \emph{Jyotsnā} 4.70, Brahmānanda understands the voids associated with each stage to be places in the body. However, in the \emph{Amṛtasiddhi} and \emph{Amaraugha}, the source text of this verse, the series of voids (along with their respective blisses and sounds) derives from a tetrad of meditative voids in Vajrayāna traditions (\textsc{Mallinson and Szántó} 2021: 18; \textsc{Birch} 2019: 968). 
\end{philcomm}
%</cm20>
...
The name of the second stage, \emph{ghaṭa} (and the related form \emph{ghaṭīkṛtya} found in the first \emph{pāda} of this verse) can be understood in at least three ways, as union, activation or pot (the latter with an alchemical connotation, on which see 3.12 and \textsc{Mallinson and Szanto} 2021: 20–23). In the \emph{Dattātreyayogaśāstra} (verse 90) its primary meaning is union and the united pairs are \emph{prāṇa} and \emph{apāna}, \emph{jīvātman} and \emph{paramātman}, and \emph{nāda} and \emph{bindu}.
\end{philcomm}
%</cm22>
...
Now, concentration on the internal sounds:
\end{translation}
%</tr27-1a>
...
\emph{Haṭharatnāvalī} 1.19, \emph{Yogacintāmaṇi} f.\,21r (\attr HP), \emph{Yuktabhavadeva} 7.127 (\attr HP), \emph{Haṭhatattvakaumudī} 55.1
% \begin{versinnote}
% \tl{haṭhaṃ vinā rājayogo rājayogaṃ vinā haṭhaḥ/\\+}
...
%%%%%%%%%%
\subsection*{4.32–33 = X4.3–4}
%<*tr33>
\begin{translation}[hp04_033]
The sovereign yoga (\emph{rājayoga}), meditative absorption (\emph{samādhi}), the beyond mind state (\emph{unmanī}), transmental state (\textit{manonmanī}), [the sovereign yoga of] the lineage of immortals (\emph{amaraugha}), non-duality (\emph{advaita}), without support (\emph{nirālamba}), pure (\emph{nirañjana}), %
no-mind (\emph{amanaska}), dissolution [of mind] (\emph{laya}), the [ultimate] reality (\emph{tattva}), void and not void (\textit{śūnyāśūnya}), the highest state (\emph{para pada}), liberation in life (\emph{jīvanmukti}), innate (\emph{sahaja}) and the fourth [state] (\emph{turya}) are synonyms.
\end{translation}
%</tr33>
...
\begin{variants}
    ca YCM\,] cāpy USS\sep
    amaraugho 'pi cādvaitaṃ USS\,] amaraughaughacāndrīva YCM\sep
...
%%%%%%%%%%
\subsection*{4.34–35 = X4.121–122}
%<*tr35>
\begin{translation}[hp04_035]
Two paths for the quick attainment of the beyond-mind state are approved by me: [cultivating] the ultimate reality (\emph{tattva}) or supreme pleasure. And focusing on the inner sound is approved even for foolish people whose minds are intent upon pleasure. The dissolution which arises from the inner sound instantly bestows bliss.
\end{translation}
%</tr35>
...
\end{translation}
%</tr35-8>
%MD??: pāda c: Adopt hīnas tu instead of hīnaś ca?
...
%Schmidt, Nachträge: "eine Art Trommel (\emph{kāhalāsu dhattūrapuṣpākāramukhabherīṣu}), \emph{Yaśastilakam}  (nach dem Ko.) = asphuṭaśabda" [\dots]. 
\end{philcomm}
%</cm41>
...
See \textsc{Hellwig} 2009: 204–206 on \emph{khoṭa}, “lame”, which in alchemy is a technical term used to describe mercury that has been processed many times using the \emph{māraṇa} technique and no longer moves.
\end{philcomm}
%</cm47>
...
On \emph{pakṣaccheda} in alchemical processes of immobilizing mercury and for references in Rasa\-śāstra, see \textsc{Hellwig} 2009: 276–278.
...
% MD??: The correct reading of the second half is probably: antaraṅgaturaṅgasya rodhe valgāyate 'pi ca (so in G8 and D4)
% valgāyate is denominative of valgā ("a bridle, rein"), matches better with the use of parighāyate and vāgurāyate. 
...
There are six \emph{cakra}s, sixteen supports, three focal points and three \emph{guṇa}s. Everything else is [just] the prolixity of texts. Trikūṭa is the supreme place.%JM scriptural verbiage? JB: we think prolixity of texts is okay.
\end{translation}
%</tr61>
...
Complementing his understanding of the previous verse, Brahmānanda (and \etaTwo) has \emph{yato\,\dots\,tatra} in 4.70cd, taking it to mean \emph{yatra\,\dots\,tatra} and to be referring to \emph{cakra}s.
\end{philcomm}
%</cm70>
...
% Pi-version: All the methods of Haṭha and Laya [should be practised] until the attainment of the state of Rājayoga. Having attained the state of Rājayoga, [the yogi] becomes untainted.
\end{translation}
%</tr77>
